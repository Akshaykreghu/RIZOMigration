        ...
        if (isset($model) && $model != '') {
            ...
            switch ($model) {
                ...
                case 'EmployeeDetails':
                    $fields = 'emp_pkey,status,EmployeeProfessionalDetails.emp_company_id,CONCAT(first_name,"  ",ifnull(last_name," ")," - ",emp_id) as name,EmployeeProfessionalDetails.designation,EmployeeProfessionalDetails.joining_date,mobile_no';
                    $joins = array(
                        array(
                            'table' => 'emp_proff',
        ...
        switch ($mode) {
            ...
            case 'excel' :
                ...
                foreach ($arr_leavepolicydetails_for_template as $value) {
                    ...
                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((3), ($rowcount), 'Date Of joining');
                    ...
                    if (count($arr_data) >= 0) {
                        ...
                        foreach ($arr_data as $key => $val) {
                            ...
                            $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex($columnindex + 6) . $rowcount, $des);
...
//       if($arr_form_data['select-criteria1']!='Units')
        ...
        if (isset($arr_leavepolicygroupids) && !empty($arr_leavepolicygroupids)) {
            foreach ($arr_leavepolicygroupids as $leavepolicygroupid) {
                ...
                $fields = 'AttendanceRegister.*,termination.last_approved_working_date,EmployeeDetails.status,Branch.branch_name,Info.*,user_credentials.user_id';
...
//                        debug($leaves);
            ...
            switch ($mode) {
                ...
                case 'excel' :
                    ...
                    $str_company_code = $this->Session->read('company_code');
                    $file_name = isset($str_company_code) ? $str_company_code . "_AttendaneRegisterReport".$report_month.".xlsx" : "AttendanceA" . strtotime() . ".xlsx";
                    ...
                    $worksheet->setCellValueByColumnAndRow(0, 1, "Summary Attendance Report - ".$report_month."");
                    $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow(0, 1)->getFont()->setBold(true);
                    ...
                    foreach ($arr_leavepolicydetails_for_template as $value) {
                        ...
                        if (count($arr_data) >= 0) {
                            ...
                            foreach ($arr_data as $key => $val) {
                                ...
                                $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex($columnindex) . $rowcount, $k);
                                $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex($columnindex + 1) . $rowcount, $id);
                                $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex($columnindex + 2) . $rowcount, $userid);
                                ...
                                $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex($columnindex + 6) . $rowcount, $termin);
           ...
           // debug($arr_leavepolicy_details);
            ...
            switch ($mode) {
                ...
                case 'excel' :
                    ...
                    $str_company_code = $this->Session->read('company_code');
                    $file_name = isset($str_company_code) ? $str_company_code . "_VerifiedAttendanceReport".$report_month.".xlsx" : "AttendanceA" . strtotime() . ".xlsx";
                    ...
                    $worksheet->setCellValueByColumnAndRow(0, 1, "Verified Attendance  Report - ".$report_month."");
                    $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow(0, 1)->getFont()->setBold(true);
                    $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow(0, 1)->getFont()->setSize(16);
                    $worksheet->mergeCells('A1:F1');
                    $worksheet->getStyle('A1')->getAlignment()->applyFromArray(
...
//                     .$str_conditions)
                ...
                if ($arr_form_data['select-criteria1'] == 'EmployeeDetails') {
                    $arr_leavepolicy_details = $this->DeviceAttendance->query("SELECT `DeviceAttendance`.LOGDATE,`DeviceAttendance`.C1,"
                            . "`DeviceAttendance`.C2,`DeviceAttendance`.C3,`EmployeeDetails`.first_name,`EmployeeDetails`.last_name,`EmployeeDetails`.status,`info`.*,`termination`.last_approved_working_date,`user_credentials`.user_id,"
                            ...
                            . "LEFT JOIN `termination` AS `termination` ON (`termination`.`emp_fkey` = `EmployeeDetails`.`emp_pkey`)"
                            . "LEFT JOIN `user_credentials` AS `user_credentials` ON (`user_credentials`.`emp_fkey` = `EmployeeDetails`.`emp_pkey`)"
                    ...
                    $arr_leavepolicy_details = $this->DeviceAttendance->query("SELECT `DeviceAttendance`.LOGDATE,`DeviceAttendance`.C1,`DeviceAttendance`.C2,`termination`.last_approved_working_date,`user_credentials`.user_id,"
                            . "`DeviceAttendance`.C3,`EmployeeDetails`.first_name,`EmployeeDetails`.last_name,`EmployeeDetails`.status,`branches`.branch_name,`info`.*"
        ...
        switch ($mode) {
            ...
            case 'excel' :
                $str_company_code = $this->Session->read('company_code');
                $file_name = isset($str_company_code) ? $str_company_code . "_DetailedAttendanceReport".$fd.".xlsx" : "ShiftPolicy" . strtotime() . ".xlsx";
                ...
                $worksheet->setCellValueByColumnAndRow(0, 1, "Employees Detailed Attendance  Report - ".$fd."");
                $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow(0, 1)->getFont()->setBold(true);
                $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow(0, 1)->getFont()->setSize(18);
                for ($col = 'A'; $col !== 'G'; $col++) {
                    $objPHPExcel->getActiveSheet()
...
PHPExcel_Style_Border::BORDER_THICK,'color' => array('argb' => '766f6e'),)));
                ...
                foreach ($arr_dates as $branch=> $employees) {
                    ...
                    $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex(0) . ($rowcount), 'Employee NAME :'.$info['0']['info']['EmpName'].$status);
                    $objPHPExcel->getActiveSheet()->getStyle(PHPExcel_Cell::stringFromColumnIndex(0))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_TEXT);
                    ...
                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((1), ($rowcount+1), 'User ID :'.$info['0']['user_credentials']['user_id']);
                    $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow((1), ($rowcount+1))->getFont()->setBold(true);
                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((2), ($rowcount+1), 'Joining Date :'.$info['0']['info']['joining_date']);
                    $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow((2), ($rowcount+1))->getFont()->setBold(true);
                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((3), ($rowcount+1), 'Termination Date :'.$termin);
                    $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow((3), ($rowcount+1))->getFont()->setBold(true);
                    for ($i = 0; $i <= 8; $i++) {
                        $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($i, ($rowcount))->getFont()->setBold(true);
                    }
...
//                     .$str_conditions)
                ...
                $arr_leavepolicy_details = $this->DeviceAttendance->query("SELECT `OTMASTER`.*,"
                        . "`EmployeeDetails`.first_name,`EmployeeDetails`.last_name,`EmployeeDetails`.status,`Info`.*,`termination`.last_approved_working_date,`user_credentials`.user_id"
...
//debug($arr_leavepolicy_details);
        ...
        switch ($mode) {
            ...
            case 'excel' :
                $str_company_code = $this->Session->read('company_code');
                $file_name = isset($str_company_code) ? $str_company_code . "_OverTimeattendance".$fd.".xlsx" : "ShiftPolicy" . strtotime() . ".xlsx";
                App::import('Vendor', 'PHPExcel', array('file' => 'PHPExcel.php'));
                $objPHPExcel = new PHPExcel();
                $objPHPExcel->getProperties()->setCreator("Administrator");
                $objPHPExcel->getProperties()->setLastModifiedBy("Administrator");
                ...
                $objPHPExcel->setActiveSheetIndex(0);
                $worksheet = $objPHPExcel->getActiveSheet();
                $worksheet->setCellValueByColumnAndRow(0, 1, "Over Time  Report - ".$fd."");
                $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow(0, 1)->getFont()->setBold(true);
                $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow(0, 1)->getFont()->setSize(18);
                for ($col = 'A'; $col !== 'G'; $col++) {
                    $objPHPExcel->getActiveSheet()
...
//set width
                        ...
                        $objPHPExcel->getActiveSheet()->getStyle(PHPExcel_Cell::stringFromColumnIndex(1))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_TEXT);
                        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((2), ($rowcount), 'Employee ID');
                        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((3), ($rowcount), 'User ID');
                        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((4), ($rowcount), 'Branch');
                        ...
                        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((7), ($rowcount), 'Joining Date');
                        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((8), ($rowcount), 'Termination Date');
                        $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex(9) . ($rowcount), 'Total Duration(In Hrs)');
                        $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex(10) . ($rowcount), 'Verified Duration(In Hrs)');
                        $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex(11) . ($rowcount), 'Approved');
                        $objPHPExcel->getActiveSheet()->SetCellValue(PHPExcel_Cell::stringFromColumnIndex(12) . ($rowcount), 'Remarks');
//set bond text size
                        for ($i = 0; $i <= 12; $i++) {
                            $objPHPExcel->getActiveSheet()->getStyleByColumnAndRow($i, ($rowcount))->getFont()->setBold(true);
                        }
                        ...
                        foreach ($arr_data as $val) {
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((3), ($rowcount), $userid);
                            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((4), ($rowcount), $branch);
                            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((5), ($rowcount), $designation);
                            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((6), ($rowcount), $department);
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow((12), ($rowcount), $remarks);
                            $rowcount++;
                            $k++;
                        }
                    }
...
//        
        $enddate = date("Y-m-d",strtotime($end_month));
//        debug($enddate);
        $attendance_date = isset($arr_db_config[0]['attendance_date']) ? $arr_db_config[0]['attendance_date'] : 0;
        $att_enddate = date('d', strtotime('-' . $attendance_date . ' day', strtotime(date('Y-m-t', strtotime($month)))));
        $att_startdate = date('d', strtotime('+1 day', strtotime(date('Y-m-d', strtotime('-' . $attendance_date . ' day', strtotime(date('Y-m-t', strtotime('-1 months', strtotime($month)))))))));
        ...
        if (isset($arr_leavepolicygroupids) && !empty($arr_leavepolicygroupids)) {
            ...
            if(isset($arr_form_data['resigned']) && $arr_form_data['resigned'] =='1'){
                    ...
                    $today_cond[] = "EmployeeDetails.status in('1','2')";  
                 }
                 else{
                     $today_cond[] = "EmployeeDetails.status = '1' ";  
                 }
            ...
            $today_join[] = array(
                ...
                'type' => 'LEFT',
                'foreignKey' => false,
                'conditions' => array('termination.emp_fkey = EmployeeDetails.emp_pkey')
            );
...
//            }
            ...
            $today_join[] = array(
                ...
                'type' => 'LEFT',
                'foreignKey' => false,
                'conditions' => array('user_credentials.emp_fkey = EmployeeDetails.emp_pkey')
            );
             $today_join[] = array(
                'table' => 'employee_info',
                'alias' => 'employee_info',
                'type' => 'LEFT',
                'foreignKey' => false,
                'conditions' => array('employee_info.emp_pkey = EmployeeDetails.emp_pkey')
            );
            $this->DeviceAttendance->useDbConfig = $this->Session->read('ds');
            $today_att = $this->DeviceAttendance->find("all", array(
                ...
                'joins' => $today_join,
                "fields" => "Branch.branch_name,concat(EmployeeDetails.first_name,' ',ifnull(EmployeeDetails.middile_name,''),' ',ifnull(EmployeeDetails.last_name,'')) AS EmpName,EmployeeDetails.status,employee_info.*,termination.last_approved_working_date,user_credentials.user_id,DeviceAttendance.C1,DeviceAttendance.LOGDATE,
...
//debug($today_att);
            ...
            foreach ($today_att as $key => $att) {
                $arr_resp['data'][$i][]/* ['EmpName 0  '] */ = isset($att[0]['EmpName']) ? $att[0]['EmpName'] : '';
                $arr_resp['data'][$i][]/* ['Branch'] 1*/ = isset($att["Branch"]['branch_name']) ? $att["Branch"]['branch_name'] : '';
                $arr_resp['data'][$i][]/* ['LOGDATE'] 2*/ = isset($att["DeviceAttendance"]['LOGDATE']) ? date("d-m-Y", strtotime($att["DeviceAttendance"]['LOGDATE'])) : '';
                $arr_resp['data'][$i][]/* ['LOGTIME'] 3*/ = isset($att["DeviceAttendance"]['LOGDATE']) ? date("H:i", strtotime($att["DeviceAttendance"]['LOGDATE'])) : '';
                $arr_resp['data'][$i][]/* ['C1'] 4*/ = isset($att["DeviceAttendance"]['C1']) ? $att["DeviceAttendance"]['C1'] : '';
                $arr_resp['data'][$i][]/* ['Locati5on'] */ = isset($att[0]['Location']) ? $att[0]['Location'] : '';
                $arr_resp['data'][$i][]/* ['Location']6 */ = isset($att['EmployeeDetails']['status']) && $att['EmployeeDetails']['status'] =="2" ? '(Resigned)' : '';
                $arr_resp['data'][$i][]/* ['Location'] 7*/ = isset($att['employee_info']['designation']) ? $att['employee_info']['designation'] : '';
                $arr_resp['data'][$i][]/* ['Location'] 8*/ = isset($att['employee_info']['department']) ? $att['employee_info']['department'] : '';
                $arr_resp['data'][$i][]/* ['Location']9 */ = isset($att['employee_info']['joining_date']) ? $att['employee_info']['joining_date'] : '';
                $arr_resp['data'][$i][]/* ['Location'] 10*/ = isset($att['termination']['last_approved_working_date']) ? $att['termination']['last_approved_working_date'] : '';
                $arr_resp['data'][$i][]/* ['Location'] 11*/ = isset($att['user_credentials']['user_id']) ? $att['user_credentials']['user_id'] : '';
                $arr_resp['data'][$i][]/* ['Location'] 12*/ = isset($att['employee_info']['employee_id']) ? $att['employee_info']['employee_id'] : '';
                $arr_resp['data'][$i][]/* ['Location'] 13*/ = isset($att[0]['Location']) ? $att[0]['Location'] : '';
                $i++;
            }
         ...
         //  debug($arr_resp);
            ...
            switch ($mode) {
                ...
                case 'excel' :
                    ...
                    $str_company_code = $this->Session->read('company_code');
                    $file_name = isset($str_company_code) ? $str_company_code . "_EmployeeCheckInCheckOutLogs .xlsx" : "AttendanceA" . strtotime() . ".xlsx";
