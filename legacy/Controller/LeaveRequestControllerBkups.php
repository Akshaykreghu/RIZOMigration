...
class LeaveRequestController extends AppController {
     ...
     * @var array
     */
    public $uses = array('AppModel', 'LeaveRequests', 'SalaryHeadItems', 'EmployeeDetails', 'EmployeeLeaveTransaction', 'LeavePolicy', 'EmployeeInfo');
...
//debug($arr_request_data);
        ...
        if ($leaveentryId) {
            ...
            if ($this->checkIfLeaveRequestEditable($leaveentryId)) {
                ...
                $arr_leave_details = $this->LeaveRequests->find("first", array(
                    'fields' => 'EmployeeInformation.*,TODATE,ISAutherized,ISAPPROVED,ISAutherizedby,APPROVEDBY,salary_head_item_fkey,EMP_fkey,LEAVESTATUS',
               ...
               // debug($arr_leave_details);
                ...
                $arr_leave_policy = $this->LeavePolicy->find("all", array(
                    'fields' => array('ALLOW_NEGETIVE','REMARKS'),
                    'conditions' => array(
    ...
    public function loadLeaveDetails($leaveentryId = 0) {
        ...
        if (isset($leaveentryId) && $leaveentryId != 0 && $leaveentryId != '') {
            ...
            $arr_leave = $this->LeaveRequests->query("select item from salary_head_items where salary_head_item_pkey = $leave");
    ...
    public function saveLeaveEntry($leaveentryId = 0) {
        ...
        $data['FROMHALF'] = isset($arr_form_data['FROMHALF'])?$arr_form_data['FROMHALF']:'';
        $data['TODATE'] = isset($arr_form_data['TODATE'])?$arr_form_data['TODATE']:'';
        $data['TOHALF'] = isset($arr_form_data['TOHALF'])?$arr_form_data['TOHALF']:'';
        $data['ISAutherizedby'] = isset($arr_form_data['ISAutherizedby'])?$arr_form_data['ISAutherizedby']:'';
        $data['APPROVEDBY'] = isset($arr_form_data['APPROVEDBY'])?$arr_form_data['APPROVEDBY']:'';
        $data['Reason'] = isset($arr_form_data['Reason'])?$arr_form_data['Reason']:'';
        $data['contact_No'] = isset($arr_form_data['contact_No'])?$arr_form_data['contact_No']:'';
        $data['contact_person'] = isset($arr_form_data['contact_person'])?$arr_form_data['contact_person']:'';
        $data['leave_days'] = isset($arr_form_data['leave_days'])?$arr_form_data['leave_days']:'';
...
//            if(isset($arr_approved_emp['0']['emp_details']['email'])){
            $apprvd_email = isset($arr_approved_emp['0']['emp_details']['email'])?$arr_approved_emp['0']['emp_details']['email']:'info@mypayrollmaster.in';
            $applied_emps = $outputParameter1['EMP_fkey'];
            $applied_emp = $this->LeaveRequests->query("select first_name,email from emp_details where emp_pkey = '$applied_emps'");
...
//            }
    ...
    public function GetLeaveBalance($leavebalance = "", $end_date = "") {
        ...
        $months = date('Y-m-01', strtotime($end_date));
...
//        debug($arr_leave_count_takens);
                            	...
                            	<tr>
                                    <td colspan="3" height="80" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor="#eeeeee" style="padding:0;margin:0;font-size:0;line-height:0">
                                        ...
                                        <tbody>
                                        	<tr>
                                            	<td width="30"></td>
                                                <td align="left" valign="middle" style="padding:0;margin:0;font-size:0;line-height:0"><a href="http://mypayrollmaster.com/" target="_blank"><img style="height: 62px;" src="https://login.mypayrollmaster.com/files/mpm.png" alt="Mypayrollmaster" ></a></td>
                                                <td width="30"></td>
                                            </tr>
                                       	</tbody>
                                        </table>
    ...
    height: 140px;"><td width="25"></td>
                                            ...
                                            <tr>
                                            	<td colspan="3" height="40"></td></tr><tr><td colspan="5" align="center" style="padding: 0px 149px 0px 149px;">
                                                    <p style="color:#404040;font-size:16px;line-height:24px;font-weight:lighter;padding:0;margin:0">Mypayrollmaster.com is a highly advanced and comprehensive time, attendance and payroll processing online software from Forsight Technologies Pvt ltd .</p><br>
                            ...
                            <tr bgcolor="#ffffff">
                                ...
                                <td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/employee.png" alt="Employee Name" width="120" height="120"></td>
                                            <td width="30"></td>
                    ...
                    '</div>
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/Days.png" alt="Leave Days" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/clock.png" alt="Leave Session" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/calendar.png" alt="Applied Date" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/email.png" alt="Message" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            	<td width="360" valign="top">
                                                	<div style="color:#a3a3a3;font-size:12px;line-height:12px;padding:0;margin:0">&copy; 2018 mypayrollmaster. All rights reserved.</div>
                                                	<div style="line-height:5px;padding:0;margin:0">&nbsp;</div>
    ...
    height: 140px;"><td width="25"></td>
                                                <td align="center">
                                                    <h1 style="font-family:HelveticaNeue-Light,arial,sans-serif;font-size:48px;color:#fff;line-height:48px;font-weight:bold;margin:0;padding:0">Congratulations ! <font style="color:#fff;"> your Leave ' . $action_msg . '</font> </h1>
                                                </td>
                                                <td width="25"></td>
                                            </tr>
                                            <tr>
                            ...
                            <tr bgcolor="#ffffff">
                                ...
                                <td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/employee.png" alt="Name" width="120" height="120"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                                <h3 style="color:#404040;font-size:18px;line-height:24px;font-weight:bold;padding:0;margin:0">Employee Name</h3>
                                                <div style="line-height:5px;padding:0;margin:0">&nbsp;</div>
                    ...
                    '</div>
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/Days.png" alt="creditibility" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                            	<h3 style="color:#404040;font-size:18px;line-height:24px;font-weight:bold;padding:0;margin:0">Leave Days</h3>
                                              	<div style="line-height:5px;padding:0;margin:0">&nbsp;</div>
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/clock.png" alt="creditibility" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                            	<h3 style="color:#404040;font-size:18px;line-height:24px;font-weight:bold;padding:0;margin:0">Leave Session</h3>
                                              	<div style="line-height:5px;padding:0;margin:0">&nbsp;</div>
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/calendar.png" alt="creditibility" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                            	<h3 style="color:#404040;font-size:18px;line-height:24px;font-weight:bold;padding:0;margin:0">Applied Date</h3>
                                              	<div style="line-height:5px;padding:0;margin:0">&nbsp;</div>
                                        ...
                                        <tr>
                                        	<td width="120" align="right" valign="top"><img src="https://login.mypayrollmaster.com/img/email.png" alt="creditibility" width="120" height="120" class="CToWUd"></td>
                                            <td width="30"></td>
                                            <td align="left" valign="middle">
                                            	<h3 style="color:#404040;font-size:18px;line-height:24px;font-weight:bold;padding:0;margin:0">Message</h3>
                                              	<div style="line-height:5px;padding:0;margin:0">&nbsp;</div>
