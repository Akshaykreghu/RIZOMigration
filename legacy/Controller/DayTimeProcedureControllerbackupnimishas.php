 ...
 */
    ...
    public function saveDayTimeProcedure()
   {
		...
		$data['Saturday']      = (isset($arr_form_data['Saturday']))?"Y":"N";
                $data['strict_monitorings'] 	   = (isset($arr_form_data['someSwitchOption001']))?"Y":"N";
		...
		$data['day_time_proc_active'] = "Y";
                ...
                $data['is_multiple_days'] = isset($arr_form_data['enablemutishift'])?$arr_form_data['enablemutishift']:"";
