 ...
 */
class PaymentApprovalsController extends AppController {
    ...
    public function index(){
       ...
       public function getPaymentFeatures()
{
  ...
  $allFeatures = $this->Features->find('all', [
    'conditions' => [
        'Features.feature_key' => 'payment approvals',
