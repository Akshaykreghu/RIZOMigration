...
<button class="btn btn-success pull-right" style="margin-right: 37px; " onclick="add_site();" ><li class="fa fa-plus"></li></button>
...
<!--        <div class="box box-header">
            Employee Default List
        </div>-->
            <div class="col-md-4 ">
                <?php if(isset($arrResponse['first_att'])) {  ?>
                <?php foreach ($arrResponse['first_att'] as $val) {  
                    ?>
           ...
           <!-- //end out time next day 1-->
                <div class="col-md-12"><div class="col-md-12 box box-primary" style="border: white;"> 
<!--                    <div class="col-md-3">
                        <img src="" style="height: 60px;alignment-adjust: ">   
                    </div>-->
                        <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="pfa ">
                            <span class="pull-left"><li class="fa fa-calendar" style=" padding-right: 8px; "></li> 
                                <b style="color : #210ec6;">Date : </b><?php echo $val['0']['att_date']; ?></span><br/>
                            <span class="pull-left" style="text-align:left; "><li class="fa fa-clock-o" style="    padding-right: 8px; "></li> 
                                <b style="color : #210ec6;">Check In : </b><input type="text" class="datePicker" value="<?php echo isset($val['wd']['on_dutty1'])?$val['wd']['on_dutty1']:'00:00:00'; ?>" style="width: 45px;"> </span><br>
                        </div>
                    </div>
        ...
        <div class="col-md-4 ">
           ...
           <!-- //end out time next day 1-->
            ...
            <div class="col-md-12"><div class="col-md-12 activation box box-primary" style="border: white;" > 
            <!-- <div class="col-md-3">
                        <img src="" style="height: 60px;alignment-adjust: ">   
                    </div>-->
                    <div class="col-md-12">
                    ...
                    <div class="col-md-9 ">
                        ...
                        <span class="pull-left"><li class="fa fa-calendar" style="padding-right: 8px; "></li>  <b style="color : #210ec6;">Date : </b><?php echo $val['sa']['att_date']; ?></span><br/>
                        ...
                        <span class="pull-left"><li class="fa fa-clock-o" style="padding-right: 8px; "></li> <b style="color : #210ec6;">Check In : </b><?php echo $val['sa']['in_time']; ?></span>
                        <input type="hidden" value="<?php echo $val['sa']['site_attendance_pkey']; ?>"  class="site_pkey" >
                        <span class="pull-left"> <li class="fa fa-clock-o" style="padding-right: 8px; "></li>  <b style="color : #210ec6;">Check Out : </b><?php if($val['sa']['out_time'] == '') { ?><input type="text" class="datePicker" value="<?php echo isset($val['wd']['off_dutty1'])?$val['wd']['off_dutty1']:'00:00:00'; ?>" style="width: 45px;"> <?php } else { ?> <?php echo isset($val['sa']['out_time'])?$val['sa']['out_time']:'00:00:00'; } ?></span>
                        </div>
                    </div>
            <!-- Activate / Deactivate button for Punch transactions start -->
                    <div class="col-md-3">
                        <?php if($val['sa']['out_time'] == ''){ ?><button style=" height: 40px;margin-top: 20px;margin-bottom: 20px;  " class="btn btn-warning" type="button" onclick="out_punch(this,<?php echo $val['sa']['emp_fkey']; ?>);">OUT</button> <?php }?>
...
<!--                <div class="" >No data Found</div>-->
        ...
        <div class="col-md-4 ">
            ...
            <?php if(($val['sa']['active'] == 1 || $val['sa']['active'] == 0) && $val['sa']['out_time'] != ''){
             ...
             $minutes += $interval->i;
             ?>
            <div class=""><div class="col-md-12 activation box box-primary" style="border: white;" > 
            <!-- <div class="col-md-3">
                        <img src="" style="height: 60px;alignment-adjust: ">   
                    </div>-->
                    <div class="col-md-12">
...
<!--                            <b style="color //echo isset($val['wd']['working_time1'])?$val['wd']['working_time1']:0; ?> min <?php //} ?></span><br/>-->
            ...
            <!-- Activate / Deactivate button for Punch transactions start -->
                  ...
                  <!--      <?php //if($val['sa']['active'] == 0){ ?><button style=" height: 40px;margin-top: 10px; " class="btn btn-success" type="button" onclick="activate(this,<?php echo $val['sa']['emp_fkey']; ?>);">Activate</button> <?php// } ?> -->
                    </div>
            <!-- Activate / Deactivate button for Punch transactions end -->   
                </div></div>
            <?php }} ?>
...
<script>
    function out_punch(s,emp_fkey){
        ...
        $.ajax({
                    ...
                    data:{site:site,site_attendance_pkey:site_attendance_pkey,site_fkey:site_fkey,day_time_seq_fkey:day_time_seq_fkey,
                        designation_id:designation_id,out_time:out_time,att_date:att_date,out_date:att_date1,checkout_time:checkout_time},
    ...
    function in_punch(s,emp_fkey){
        ...
        $.ajax({
                    ...
                    method:'POST',
                    data:{site:site,site_attendance_pkey:site_attendance_pkey,site_fkey:site_fkey,day_time_seq_fkey:day_time_seq_fkey,
                        designation_id:designation_id,out_time:out_time,att_date:att_date,in_date:att_date1,checkin_time:checkin_time},
                    success: function (resp) {
                        var response = JSON.parse(resp);
                        alert(response.message);
                        if(response.success == 0){
...
//        alert(out_time);
        ...
        $.ajax({
                    ...
                    data:{site:site,site_attendance_pkey:site_attendance_pkey,site_fkey:site_fkey,day_time_seq_fkey:day_time_seq_fkey,designation_id:designation_id,out_time:out_time,att_date:att_date,out_date:att_date1,checkout_time:checkout_time},
                    success: function (resp) {
                        var response = JSON.parse(resp);
                        alert(response.message);
                        if(response.success == 0){
     ...
     function deactivate(s,emp_fkey){
        ...
        var att_date = $('#filterby_date').val();
        $.ajax({
                    url: livesite + 'SiteAttendance/mark_activestatus/' + emp_fkey,
                    method:'POST',
                    data:{site:site,site_attendance_pkey:site_attendance_pkey,site_fkey:site_fkey,day_time_seq_fkey:day_time_seq_fkey,designation_id:designation_id,out_time:out_time,att_date:att_date},
                    success: function (resp) {
                        var response = JSON.parse(resp);
                        //alert(response.message);
                        if(response.success == 0){
     ...
     function activate(s,emp_fkey){
        ...
        var att_date = $('#filterby_date').val();
        $.ajax({
                    url: livesite + 'SiteAttendance/mark_deactivestatus/' + emp_fkey,
                    method:'POST',
                    data:{site:site,site_attendance_pkey:site_attendance_pkey,site_fkey:site_fkey,day_time_seq_fkey:day_time_seq_fkey,designation_id:designation_id,out_time:out_time,att_date:att_date},
                    success: function (resp) {
                        var response = JSON.parse(resp);
