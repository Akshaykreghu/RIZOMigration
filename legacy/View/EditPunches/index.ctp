...
<div class="tab-content" style="margin-top:15px;">
    <div class="tab-pane  active" id="tab1" role="tabpanel">
        ...
        <section class="content-header">
            ...
            <!-- end -->
           <!-- Keep this OUTSIDE col-md-12, at the bottom of the page body -->
...
<div class="col-md-12" align="right">
    <button title="..." class="btn btn-primary pull-right" type="button" onclick="updatemem();">Refresh</button>

    <button id="bulkSyncBtn"
        class="btn btn-primary pull-right"
        type="button"
        title="Resyncing this month attendance"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#editpunches').datagrid({
            ...
            height: '600px',
            url: livesite + "EditPunches/listpunches",
            pagination: true,
            singleSelect: true,
            iconCls: 'icon-edit',
            pageSize: 32,
        ...
        if (scheduledbreakoffdates.getSelectedRowId()) {
            ...
            $('#sendAjaxBtn').off('click').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response) {
                            $.notify("Employee Added To Selected Date", {
                                type: 'success',
                                allow_dismiss: false
                            });
                        } else {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: "POST",
            url: livesite + "EditPunches/SyncAttendance",
            data: {
                emp: emp,
                month: mnth
            },
