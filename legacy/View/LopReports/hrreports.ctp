...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18"> LOP Report </h1>
     <!-- /* edited by bindu 20-11-2025 */ -->
            ...
            <div class="box ">
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="float: right;margin-right: 500px;margin-top: -5px;">
...
//    $('#filterby_reporttype').select2();
    ...
    $('#div-reportcriterias').load(livesite+'lopReports/changereporttype/'+reporttype);
});
