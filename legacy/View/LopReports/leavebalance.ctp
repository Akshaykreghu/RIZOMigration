<?php if ($mode == '') { ?>
    <div class="modal-body" style="overflow-y: auto;">
        <legend style="text-align: center; font-weight: bold;">Leave Balance Statement - <?php echo $mname1 . " " .$y1; ?></legend>
            ...
            <div class="col-md-12">
                <div class="box ">
                    ...
                    foreach ($arr_leavepolicydetails_for_template as $value) {
                        ...
                        <td><?php echo isset($val['termination']['last_approved_working_date']) ? $val['termination']['last_approved_working_date'] : '';?></td>   
