...
<!--                //edited by amal on 08/08/2019 hide pdf-->
              <?php  if ($type != "AttendanceLocation" && $type != "Client" && $type !="Customer") { ?>
    ...
    <script>
         function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'lopReports/loadcriteriaitems/' + index + '/' + criteria);
        }
    ...
    //        return false;
            ...
            if (criteria) {
                $('#form-showreport').attr('action', livesite + 'lopReports/generatereport/' + type + '/' + mode);
...
$('#reporstfrom').datepicker({
    ...
    //        return false;
            ...
            var url = livesite + 'lopReports/generatereport/' + type;
...
//            });
        ...
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'lopReports/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
