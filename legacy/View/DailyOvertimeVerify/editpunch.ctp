                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <?php if ($att_date != "" && $emp_pkey != "" && $emp_id != "") { ?>
                                <div id="tb" style="padding:5px;height:auto">
                                    <div>
                                        ...
                                        <!--$shownebutonbutton condition added by nimisha on 30-05-2019--> 
                                ...
                                <input type="hidden" id="hid_emppkey" value="<?php echo $emp_pkey; ?>" />
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#editpunchesbydate').datagrid({
                ...
                width: '550px',
                //height: '600px',
                url: livesite + "DailyOvertimeVerify/listpunchesbydate",
                pagination: true,
                singleSelect: true,
                iconCls: 'icon-edit',
                pageSize: 20,
        ...
        function deleterow(target) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: livesite + "DailyOvertimeVerify/remove",
                    data: {
        ...
        function saverow(target, row, value) {
            ...
            $.ajax({
                type: "POST",
                url: livesite + "DailyOvertimeVerify/savepunch/" + empid,
                data: {
                    C1: row.C1,
    ...
    $('#dailyovertimediv').datagrid({
        ...
        function insert() {
            ...
            if (emp) {
                $('#empid').val(emp);
                //Add form
                showSmallModalForm(livesite + 'DailyOvertimeVerify/form/' + emp + '/' + att_date + '/' + site_trans_fkey);
            } else {
