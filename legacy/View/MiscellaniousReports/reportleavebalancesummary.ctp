...
<div class="modal-body" style="overflow-y: auto;">
    <legend>Employees Leave Summary Report</legend>
    <div class="row">
        <div class="col-md-12">
            <div class="box ">
                ...
                <div class="box-body">
                    ...
                    <?php  
                     ...
                     if($cr == 'Departments')
                        ...
                        {
                        echo isset($value['summary'][0]['LeaveType']['leave_type'])?$value['summary'][0]['LeaveType']['leave_type']:''; 
                            ...
                            <tbody>
                                ...
                                <?php if(count($arr_data)>0){ ?>
                                        ...
                                        <tr> 
                                            ...
                                            ?>
                                            <td><?php echo $arr_data['0']['0']['emp_name']; ?></td>
                                            <td><?php echo $arr_data['0']['info']['employee_id']; ?></td>
                                            <td><?php echo $arr_data['0']['info']['designation']; ?></td>
                                             <td><?php echo $arr_data['0']['info']['joining_date']; ?></td>
                                            <td><?php echo $arr_data['0']['info']['department']; ?></td>
                                            <td><?php echo $arr_data['0']['info']['branch']; ?></td>
                                            <?php 
                                            $leavetaken = 0;
                                            $alloted_leave_forthe_year = 0;
                                            $leavebalances = 0;
                                            foreach($arr_data as $val){ ?>
                                            <?php
                                            
                                            $leavetaken += $val['lp']['alloted_leave_forthe_year'] - $val['0']['leavebalance'];
                                            $alloted_leave_forthe_year +=$val['lp']['alloted_leave_forthe_year']; 
                                            $leavebalances += $val['0']['leavebalance'];
                                            ?>
                                            <?php } ?>
                                ...
                                <?php }else{ ?>
                                        <tr>
                                            <td colspan="10">No Records Found Under This Criteria</td>
                                        </tr>  
                                <?php } ?>
                            </tbody>
                        </table>
...
?>
			    ...
			    <table>
                            ...
                            <tbody>
                                ...
                                <?php }else{ ?>
                                        <tr>
                                            <td colspan="10">No employees found under this Branches</td>
                                        </tr>  
                                <?php } ?>
                            </tbody>
                        </table>
