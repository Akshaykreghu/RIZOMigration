<div class="modal-body">
    <legend>Resignation Letter</legend>
...
<!--                <p>It has been a pleasure working with you and your team over these days. One of 
                    the highlights of my career was collaborating with you to automate <?php echo $company['CompanyContactInfo']['business_name'] ; ?> Company’s <?php echo $arr_requests['0']['Designation']['desig_name'] ; ?> of <?php echo $arr_requests['0']['Department']['dept_name'] ; ?>.Your company is poised for continued
                    growth and I wish you much success with your upcoming acquisition of <?php echo $company['CompanyContactInfo']['business_name'] ; ?> Company.</p>-->
...
<!--      <div class="row">
         ...
         /.col 
        <div class="col-xs-6">
          <p class="lead">Applied Date <?php echo $arr_requests['0']['ResignationRequests']['applied_date'] ; ?></p>
      ...
      <div class="row no-print">
        ...
        <div class="col-xs-12">
          ...
          <button type="submit" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Yes i have read all the above and proceed to submit the letter
          </button>
           
          <button onclick="$('#modalDetailForm1').modal('hide');" type="button" class="btn btn-primary pull-right" style="margin-right: 5px;">
            <i class="fa fa-download"></i> Edit Again
          </button>
        </div>
               </form>
      </div>
...
<div class="modal-footer">
    <button type="button" id="btn-submit" class="btn btn-primary" onclick="$('#modalDetailForm1').modal('hide');">
        Cancel
    </button>
</div>
<script>
