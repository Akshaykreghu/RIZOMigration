...
<div class="col-md-13 block-container">
    <div style="display:block; ">
        ...
        <div style="padding-left: 20px;position: absolute;top:120px;left:35px">
    ...
    <div style="padding-left: 20px; margin-top: 20px;text-align:center;">
    ...
    <table class="table" style=" border: 0px; margin: auto;
        ...
        <tbody>
            ...
            <tr style=" border: 0px; ">
                ...
                <td style=" border: 0px"><?php echo "$months &nbsp;&nbsp;Months"; ?></td>
            ...
            <tr style=" border: 0px; ">
                ...
                if ($notice > 0) {
                    ...
                    //End
                    // $after_adjustment = $working_days - $notice_period_served - $leave;
            ...
            <tr style=" border: 0px; ">
                ...
                <td style=" border: 0px"></td>
                <td style=" border: 0px">
                    <?php echo $after_adjustment; ?> days
                </td>
                <td style=" border: 0px">&nbsp;</td>
                <td style=" border: 0px">&nbsp;</td>
            </tr>
