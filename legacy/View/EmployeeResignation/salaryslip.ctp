...
$earning = isset($arr_emp_settle['payd_additional'][$key][0]['salary_amount'])? $arr_emp_settle['payd_additional'][$key][0]['salary_amount']: '' ; 
//if($earning > 0) { ?>
                        <tr>
                            <td><?php
                    ...
                    <tbody>
                        ...
                        }elseif(isset($details[0]['Termination']['amt_paid_by_empaddition']) && $details[0]['Termination']['amt_paid_by_empaddition'] > 0){
                        ...
                        if (($str_company_code =='DEMO'||$str_company_code =='KWMT')){ 
                            ...
                            $notice_period_served =  $leave_balance_total + $work;
                            ...
                            if ($notice > 0) {
                                $after_adjustment = $notice - $notice_period_served - $leave;
                            } else {
                                $after_adjustment = 0;
                            }
