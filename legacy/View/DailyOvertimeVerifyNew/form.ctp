...
<form class="form-horizontal" id="editpunchform" method="post" action="<?php echo $this->webroot; ?>DailyOvertimeVerifyNew/savenew" >
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var att_date = '<?php echo date('Y-m-d', strtotime($att_date)); ?>'; //Edited by Askhay on 21-3-2024
        ...
        if (arrSelectedDate.length == 3) {
            ...
            console.log('att_date1', att_date);
            console.log('selectedDate1',selectedDate);
        } else {
            var selectedDate = new Date();
            console.log('att_date2', att_date);
