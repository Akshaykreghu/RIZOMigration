<?php if (isset($arr_reportcriterias)) { ?>
    ...
    <form class="form-horizontal" method="post" action="" id="form-showreport">
        ...
        <div class="form-group" id="div-criteria1">
            ...
            <div class="col-md-2">
                <?php if ($type == "Dashboard" || $type == "regularisation" || $type == "nonpunched" || $type == "nonattendance") { ?>
			 ...
			 <div id="printPanel" class="form-group col-md-2">
                <div class="col-md-12" align="right">
                    ...
                    <?php if ($type != "Dashboard") { ?>
                        ...
                        <?php if (($type != "Attendance") && ($type != "DetailedAttendance") &&  ($type != "VerifiedAttendance") && ($type != "regularisation") && ($type != "nonpunched") && ($type != "nonattendance")){ if($type != "OvertimeReport") { ?>
    ...
    <script>
         function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'arrearsReports/loadcriteriaitems/' + index + '/' + criteria);
        }
    ...
    //        return false;
            ...
            if (criteria) {
                $('#form-showreport').attr('action', livesite + 'arrearsReports/generatereport/' + type + '/' + mode);
    ...
    <?php if ($type == 'employee') { ?>
            ...
            allempfields.init();
            allempfields.clearAndLoad("<?php echo $this->webroot; ?>arrearsReports/listemployeefields", "json");
      ...
      function viewReport() {
            ...
            if (selectany) {
                ...
                if (criteria) {
                    ...
                    var url = livesite + 'arrearsReports/generatereport/' + type;
                    ...
                    $.post(url, formData, function(response) {
                        ...
                        // Additional actions after the POST request if needed
                    });
                } else {
                    alert("Please select a criteria first");
                }
        ...
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'arrearsReports/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
