<style>
    ...
    #grosssummarytable1 td, th{
        border-style: solid;
        border-color: #d4d4de;
    }

    #grosssummarytable2 td, th{
        border-style: solid;
        border-color: #d4d4de;
    }
    .modal-content {
...
<?php if ($mode == '') { ?>
    <div class="modal-body" style="overflow-y:auto; padding-left:3%; padding-right:3%; padding-bottom:3%;">
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 align="center"  ><b>Gross Salary Summary- <?php echo $month;?></b></h2>
                <h2 style="text-align: center;font-weight: bold;font-size: 19px;"><?php echo "(Report Run by " .$user_id." at "  .$date_time. ")"?> </h2>
...
//                    debug($emp_branch);
//                    debug($all_branches[$emp_branch]);
                            // echo '<h3>' . $all_branches[$emp_branch] . '</h3>';
                            ?>
                            <div style="overflow-x: auto;">
                            <legend style="width: 1400px;"><?php echo $all_branches[$emp_branch];?></legend>
                            <table class="table table-bordered" id="grosssummarytable1">
                                <thead>
                                    <tr>
                                        <th>Sl No</th>
                                        <th>Employee ID</th>
...
//                        debug($emp_wise_values);
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $emp_wise_values['emp_info']['emp_id']; ?></td>
                                            ...
                                            <td>
                                             ...
                                             <td><?php echo $emp_wise_values['emp_info']['joining_date']; ?></td>
                                            <td><?php echo $emp_wise_values['emp_info']['branch']; ?></td>
                                            <td><?php echo $emp_wise_values['emp_info']['department']; ?></td>
                                            <td><?php echo $emp_wise_values['emp_info']['designation']; ?></td>

                                           
                                            <td><?php echo $emp_wise_values['termination']['last_approved_working_date']; ?></td>
                                            
                                            <!--<td><?php // echo $emp_wise_values['prodata']['days'];   ?></td>-->
                                            <!--<td><?php // echo $emp_wise_values['prodata']['type'];   ?></td>-->
                                            <!--<td><?php // echo $emp_wise_values['prodata']['present'];   ?></td>-->
                                        ...
                                        <!--<td><?php // echo isset($emp_wise_values['ot']) ? round(($emp_wise_values['ot'] / 60), 2) :0;   ?></td>-->
                                            <?php
                        ...
                        ?>
                            <?php
                                ...
                                foreach ($gross as $val) {
                                    ...
                                    ?>
                    <div style="overflow-x: auto;">
                        <legend style="width: 1500px;"><?php echo $val['emp_info']['EmpName']; ?><?php echo (isset($val['emp_details']['status'])) && $val['emp_details']['status'] == "2" ? '  (Resigned)' : ''; ?></legend>
                        <table class="table table-bordered" id="grosssummarytable2">
                            <!-- <tbody> -->
                            <thead>
                                <tr>
                                    <th>Sl No</th>
                                 ...
                                 <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $val['emp_info']['EmpName']; ?><?php echo (isset($val['emp_details']['status'])) && $val['emp_details']['status'] == "2" ? '  (Resigned)' : ''; ?></td>
                                         <td><?php echo $val['emp_info']['joining_date']; ?></td>
                ...
                <!--                        <td><?php //echo $val['prodata']['days'];  ?></td>
                                        <td><?php //echo $val['prodata']['type'];  ?></td>-->
                <!--                        <td><?php //echo $val['prodata']['present'];  ?></td>-->
...
'title'=>'Gross Salary Summary  - '.$month));
    ?>
    <?php if (count($gross) <= 0) { ?>
