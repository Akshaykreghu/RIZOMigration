...
<section>
    <div class="container" style="margin-bottom : 46px; margin-top : 46px;">
        <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>DbConfig/completed_setup" method="post">
            <h1 style="text-align: center; color: #126aa3; "> Employee Self Service Access (ESS)  </h1>
            <p style="margin-top: 17px;    text-align: center; ">Give ESS access to all employees with a common password . Employees will have to reset their passwords on their first login.  </p>

            <div class="col-md-12" id="loader">
                <button type="button" class="btn btn-primary" onclick="open_form();" >Set Password</button>
            ...
            <button type="submit" id="cinfosave" class="btn btn-primary pull-right "   style="margin-right:5px">Next</button>
