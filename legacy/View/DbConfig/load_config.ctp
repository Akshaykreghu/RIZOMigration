...
<section>
    ...
    <h1 class="h1"> Manage Employee Policies </h1>
 <p style="margin-top: 17px;
    text-align: center; ">Please select a policy type and drag and drop to the end of the table to add them on it.  </p>
                
    <div class="col-md-12" id="loader">
       
        
</div>
    <!-- //edited by megha form tag replaced to skip button position-->
       <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>DbConfig/emp_login" method="post">
...
<script type="text/javascript">
   ...
   $(document).ready(function() { 
            $('#loader').load(livesite+ 'EmployeeConfig/index/');
