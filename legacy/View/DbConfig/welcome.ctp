...
<section>
    <div class="container" style="margin-bottom : 46px; margin-top : 46px;">
        <form  id="contactInfoFormSection" action="<?php echo $this->webroot; ?>DbConfig/config" method="post">
    <h1 style="text-align: center;"> Edit company informations </h1>
 <p style="margin-top: 17px;
    text-align: center; ">Please update your company details below fields. Also upload your company logo .   </p>
                
     <div class="col-md-12" id="loader" style="margin-bottom: 38px; ">
...
<script type="text/javascript">
   ...
   $(document).ready(function() { 
            $('#loader').load(livesite+ 'Company/infoedit/');
