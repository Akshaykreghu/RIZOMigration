...
<section>
    <div class="container" style="margin-bottom : 46px; margin-top : 46px;">
        <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>DbConfig/load_config" method="post">
    <h1 style="text-align: center;"> Upload your employees </h1>
 <p style="margin-top: 17px;
    text-align: center; ">Please click the button below to download the excel format to upload your branchwise employee data . You can also add your employes one by one through the bottom grid.   </p>
