...
<section>
    <div class="container" style="margin-bottom : 46px; margin-top : 4px;">
        <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>DbConfig/holidays" method="post">
            <h1 style="text-align: center;"> Select Salary Structure </h1>
            <p style="   text-align: center; ">Create any number of salary structures and define your own calculations. </p>
...
<script type="text/javascript">
        ...
        if($(s).attr("class") == 'btn btn-success'){
            ...
            success: function (resp) {
                ...
                if(response.success == 0){
                    ...
                    $(s).addClass("btn-success").removeClass('bg-default');
                }
   ...
   $(document).ready(function() { 
            $('#loader').load(livesite+ 'SalaryStructure');
