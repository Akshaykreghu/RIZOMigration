...
<section>
    <div class="container" style="margin-bottom : 46px; margin-top : 46px; text-align: center;">
<!--        //edited by megha url changed-->
<!--        <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>Dashboard/index" method="post">-->
            <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>index" method="post">
            <h1 style="text-align: center; color: green; "> Congratulations ! </h1>
            <p>Your Initial setup is completed now, you can edit any of the settings from admin login under the menu 'company information'   . </p>
            <!--<h1 style="text-align: center; color: green; "> Completed ! </h1>-->
            <img src="https://cdn4.iconfinder.com/data/icons/generic-interaction/143/yes-tick-success-done-complete-check-allow-512.png" style="width:8%; ">
            <div class="progress sm" style="margin-top: 10px; ">
                <div class="progress-bar anim progress-bar-green" style="width: 100%"></div>
            </div>
            <div class="col-md-12" id="loader">
                <button type="submit" id="cinfosave" class="btn btn-success "   style="margin-right:5px; background: #2c388f; ">Go to Dashboard</button>
...
<script type="text/javascript">
    ...
    function open_form(){
        showModalForm(livesite+'DbConfig/login_cred');
    } 
    
   $(document).ready(function() { 
            //$('#loader').load(livesite+ 'Employee/index/');
