                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-7">
                                ...
                                <select id="emp_fkey1" class="form-control" name="emp_fkey" onchange="findextingsalary();" onchange="findsalary();" required="required" style="width: 100%;">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" required="required" class="form-control date-picker" autocomplete="off" onchange="findextingsalary(); findsalary();"
                                    value="<?php
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-1">:</div>
                            <div class="col-md-7">
                                <input type="number" required="required" class="form-control" value="<?php echo isset($data['advance_amount']) ? $data['advance_amount'] : ''; ?>" name="advance_amount" onmouseenter="findextingsalary();" onblur="findamount();" id="advance_amount">
                            </div>
                        </div>
                    </div>
