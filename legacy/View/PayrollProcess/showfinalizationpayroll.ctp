...
<section class="content-header">
    <h1 class="text-primary-18">Finalization of Payroll</h1>
...
<script>
    jQuery(document).ready(function () {
        ...
        $('.tabset-processpayroll #tab1').load(livesite + "PayrollProcess/showfinalizationpayrolltab/0");
    });
	...
	jQuery('#div-showprocesspayroll .pws_tabs_controll a').on('click', function(){
		...
		if(tabIndex == "tab1"){
			...
			$('.tabset-processpayroll #tab2').load(livesite + "PayrollProcess/showfinalizationpayrolltab/1");
		}
	});
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (success) {
                    ...
                    $('.tabset-processpayroll #tab1').load(livesite + "PayrollProcess/showfinalizationpayrolltab/0", {month: month, branch: branch});
                    $('.tabset-processpayroll #tab2').load(livesite + "PayrollProcess/showfinalizationpayrolltab/1", {month: month, branch: branch});
    ...
    function processPayroll(remarks) {
        ...
        $.ajax({
            url: livesite + "PayrollProcess/finalizationpayroll",
            type: 'post',
            data: {
                branch: branch,
                month: month,
            ...
            success: function (response) {
                ...
                if (success) {
                    ...
                    if (remark !== ''){
                    $.notify("Finalization of payroll processed.", {
                        type: 'success',
                        allow_dismiss: false,
                    });
        ...
        if(canRemove){
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var success = $.parseJSON(response).success;
                    if (success) {
                        $.notify("Finalization of payroll removed.", {
                            type: 'success',
                            allow_dismiss: false
                        });
                        $('#processedpayrolltable').datagrid('load', {
                        ...
                        //alert('Attendance process failed!');
                        $.notify("Finalization of payroll removal failed!", {
                            type: 'danger',
                            allow_dismiss: false
                        });
                    }
