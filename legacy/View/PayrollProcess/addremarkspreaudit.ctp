        ...
        <div class="modal-body">
            ...
            <form class="form-horizontal" id="noticeForm">
                <div class="modal-body">
                    ...
                    <input type="hidden" id="data_to_pass" value='audit'>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var dataToPass = $('#data_to_pass').val();
        ...
        parent.auditPayroll(remarks,dataToPass);
        // console.log('Parent',parent);
        // Close the modal after passing the remarks
        closeModal('addremarks');
    }
</script>