        ...
        <table id="processedpayrolltable" class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'remarks',width:'50%'" sortable="true">Remarks</th>
                </tr>
            </thead>
        </table>
        <?php } ?>
...
<script>
    ...
    $('#payrolltable').datagrid({
        url: livesite + "PayrollProcess/listpreauditpayroll",
        pagination: true,
        singleSelect: false,
        queryParams: {
            branch: branch,
...
//                return 'color:#B22222;';
    ...
    function showModal() {
        ...
        if(row){
            // Show the modal
            showSmallModalForm(livesite + "PayrollProcess/addremarkspreaudit/0");
        }else{
...
<script>
        ...
        // // Show the modal
        // showSmallModalForm(livesite + "PayrollProcess/addreversalremarks2/0");
        // }
        function showReversePreAuditModal() {
        var canRemove = true;
    ...
    $('#processedpayrolltable').datagrid({
        url: livesite + "PayrollProcess/listpreauditedpayroll",
        pagination: true,
        singleSelect: false,
        queryParams: {
            branch: branch,
