        ...
        <table id="payrolltable" class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'remarks',width:'25%'">Remarks</th>
        ...
        <table id="processedpayrolltable" class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'remarks',width:'300%'" sortable="true">Remarks</th>
                </tr>
            </thead>
        </table>
        <?php } ?>
...
<script>
    ...
    $('#payrolltable').datagrid({
        url: livesite + "PayrollProcess/listfinalizationpayroll",
        pagination: true,
        singleSelect: false,
        queryParams: {
            branch: branch,
...
//                return 'color:#B22222;';
    ...
    $('#filterby_employee').select2();//This is to search employee name or company id. By ***ARUL P DAS on 20/12/2019
       ...
       function showModal() {
        ...
        if(row){
            // Show the modal
            showSmallModalForm(livesite + "PayrollProcess/addremarks2/0");
        }else{
...
<script>
    ...
    $('#processedpayrolltable').datagrid({
        url: livesite + "PayrollProcess/listfinalizedpayroll",
        pagination: true,
        singleSelect: false,
        queryParams: {
            branch: branch,
