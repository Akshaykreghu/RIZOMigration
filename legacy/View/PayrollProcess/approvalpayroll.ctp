...
<section class="content-header">
    <h1 class="text-primary-18">Salary Approval</h1>
...
<script>
    jQuery(document).ready(function() {
        ...
        $('.tabset-processpayroll #tab1').load(livesite + "PayrollProcess/approvalpayrolltab/0"+ "/" + month + "/" + branch);
    });
    ...
    jQuery('#div-showprocesspayroll .pws_tabs_controll a').on('click', function() {
        ...
        if (tabIndex == "tab1") {
            ...
            $('.tabset-processpayroll #tab2').load(livesite + "PayrollProcess/approvalpayrolltab/1/" + month + "/" + branch);
        }
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (success) {
                    ...
                    $('.tabset-processpayroll #tab1').load(livesite + "PayrollProcess/approvalpayrolltab/0", {
                        month: month,
                        branch: branch
                    });
                    $('.tabset-processpayroll #tab2').load(livesite + "PayrollProcess/approvalpayrolltab/1", {
                        month: month,
                        branch: branch
                    });
    ...
    function SalaryapprovePayroll(remarks) {
        ...
        $.ajax({
            url: livesite + "PayrollProcess/SalaryapprovePayroll",
            type: 'post',
            data: {
                branch: branch,
                month: month,
            ...
            success: function(response) {
                ...
                if (success) {
                    ...
                    if (remark !== '') {
                        $.notify("Salary approval processed.", {
                            type: 'success',
                            allow_dismiss: false,
                        });
        ...
        if (canRemove) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var success = $.parseJSON(response).success;
                    if (success) {
                        $.notify("Salary approval removed.", {
                            type: 'success',
                            allow_dismiss: false
                        });
                        $('#payrolltable').datagrid('load', {
                        ...
                        //alert('Attendance process failed!');
                        $.notify("Salary approval removal failed!", {
                            type: 'danger',
                            allow_dismiss: false
                        });
                    }
