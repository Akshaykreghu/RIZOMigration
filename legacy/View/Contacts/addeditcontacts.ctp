            ...
            <form role="form" id="form-contacts-master" action="<?php echo $this->webroot; ?>contacts/save" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="reg" type="text" class="form-control" name="reg" value="<?php echo (isset($arr_contacts[0]['Contacts']['reg']) ? $arr_contacts[0]['Contacts']['reg'] : ""); ?>"  placeholder="Enter Reg. Number" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="state" type="text" class="form-control" name="state" value="<?php echo (isset($arr_contacts[0]['Contacts']) ? $arr_contacts[0]['Contacts']["state"] : ""); ?>"  placeholder="Enter State" required="required">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="relationship"  class="form-control" name="relationship" required="required">
                            ...
                            <?php $arr_relationship = array('Vendor', 'Customer', 'Others');
...
<?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="tin" type="tin" class="form-control" name="tin" value="<?php echo (isset($arr_contacts[0]['Contacts']) ? $arr_contacts[0]['Contacts']["tin"] : ""); ?>"  placeholder="Enter TAN" >
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <Label for="account_no" >PAN No.<span style="color: red"> * </span></label>
                        <input autocomplete="off" id="pan_no" type="text" class="form-control" name="pan_no" value="<?php echo (isset($arr_contacts[0]['Contacts']) ? $arr_contacts[0]['Contacts']["pan_no"] : ""); ?>"  placeholder="Enter PAN Number" required="required">
                    </div>
                    <div class="col-md-6">
                        <Label for="account_no" >GST No.<span style="color: red"> * </span></label>
                        <input autocomplete="off" id="gst" type="text" class="form-control" name="gst" value="<?php echo (isset($arr_contacts[0]['Contacts']) ? $arr_contacts[0]['Contacts']["gst"] : ""); ?>"  placeholder="Enter gst" required="required">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="account_no" type="text" class="form-control" name="account_no" value="<?php echo (isset($arr_contacts[0]['Contacts']) ? $arr_contacts[0]['Contacts']["account_no"] : ""); ?>"  placeholder="Enter Account Number" required="required">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="c_designation" type="text" class="form-control" name="c_designation" value="<?php echo (isset($arr_contacts[0]['Contacts']) ? $arr_contacts[0]['Contacts']["c_designation"] : ""); ?>"   placeholder="Designation ">
                    </div>
                </div>
