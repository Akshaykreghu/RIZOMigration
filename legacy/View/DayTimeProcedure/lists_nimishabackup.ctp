...
/*    input[type="radio" i], input[type="checkbox" i] {
    ...
    <input type="hidden" name="day_time_seq" value="<?php echo isset($data['day_time_seq']) ? $data['day_time_seq'] : 0 ?>" />
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-12">
              
                <legend style="font-size: 30px;"> <?php echo isset($data['day_time_desc']) ? $data['day_time_desc'] : '' ?></legend>
                 <span style="float: right;    margin-top: -62px; font-size: 25px;">
                     <?php echo isset($data['on_dutty1']) ? $data['on_dutty1'] : '' ?> - <?php echo isset($data['off_dutty1']) ? $data['off_dutty1'] : '' ?>&nbsp;(<?php echo isset($data['working_time1']) ? $data['working_time1'] : '' ?><span style="font-size: 17px;">Min</span>)
        ...
        <fieldset>
            ...
            <div class="col-sm-6" style="padding-left: 1px;"> 
                <br>
                  <li class="list-group-item" style="height:30px; " >
                      ...
                      <div style="position:relative;top:-4px;" >Overtime - Minimum time after Shift Timing <label>&ensp;: &ensp;</label><?php echo isset($data['min_aftr_off_dutty_cal_ot']) && $data['min_aftr_off_dutty_cal_ot'] != "0" ? 'Enabled' : 'Disabled'; ?>
          ...
          <div style="position:relative;top:-4px;" >   
              ...
              <?php 
                  ...
                  echo ")";
                           ...
                           echo "Working time in a Day-Off<label> &ensp;: &ensp;</label>"; 
                           echo isset($data['work_time_day_off_cal_ot']) && $data['work_time_day_off_cal_ot'] != "0" ? 'Enabled' : 'Disabled'; 
                           $working_component_ot = "";
                           switch($data['work_time_day_off_cal_ot']){
                            case '1': $working_component_ot = "OT";
            ...
            <div class="col-md-6 col-sm-12 col-xs-12" style="padding-left: 1px;"> 
                <br>
                   <li class="list-group-item" style="height:30px;">
           <div style="position:relative;top:-4px;" >     Overtime - Minimum time before Shift Timing<label>&ensp; :&ensp;</label> <?php echo isset($data['min_bfr_on_dutty_cal_ot']) && $data['min_bfr_on_dutty_cal_ot'] != "0" ? 'Enabled' : 'Disabled'; ?>
          ...
          <span id="dayoffchange" ><div style="position:relative;top:-4px;" >Salary Component for OT</span> <label>&ensp;: &ensp;</label>
            ...
            <div class="col-sm-12" style="padding-left: 13px;">
            <legend>
...
<button class="btn btn-primary" onclick="editable(<?php echo isset($data['day_time_seq']) ? $data['day_time_seq'] : 0 ?>);">Edit </button>
            <br>   <br>   </div>
