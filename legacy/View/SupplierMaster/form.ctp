                        ...
                        <table class="table table-bordered">
                            ...
                            if (isset($arr_att) && !empty($arr_att)) {
                                foreach ($arr_att as $value) {
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type = "text" value = "<?php echo isset($value['mr_details']['item_no']) ? $value['mr_details']['item_no'] : ''; ?>" name = "item_no[]" id = "item_no" style = "width: 60px" ></td>
                                            <td><input type = "text" value = "<?php echo isset($value['mr_details']['required_qty']) ? $value['mr_details']['required_qty'] : ''; ?>" name = "required_qty[]" id = "required_qty" style = "width: 60px"></td>
                                            <td><input type = "text" value = "<?php echo isset($value['mr_details']['current_stock']) ? $value['mr_details']['current_stock'] : ''; ?>" namre = "current_stock[]" id = "current_stock" ></td>
                                            <td><input type = "text" value = "<?php echo isset($value['mr_details']['required_qty']) ? $value['mr_details']['required_qty'] : ''; ?>" name = "incoming_qty[]" id = "incoming_qty" ></td>
                                            <td><input type = "text" value = "<?php echo isset($value['mr_details']['incoming_date']) ? $value['mr_details']['incoming_date'] : ''; ?>" name = "incoming_date[]" id = "update_date" placeholder = "select date"></td>
                                            ...
                                            <td><input type = "text" value = "<?php echo isset($value['mr_details']['unit']) ? $value['mr_details']['unit'] : ''; ?>" name = "unit[]" id = "unit" style = "width: 60px"></td>
    ...
    ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type = "text"  name = "incoming_date[]" id = "end_date" placeholder = "select date"></td>
