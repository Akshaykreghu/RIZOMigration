    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box ">
                ...
                <div class="box-body">
                    <fieldset> 
                        <legend>Attedance Reports of <?php  echo isset($value['summary']['0']['0']['branch_name'])? $value['summary']['0']['0']['branch_name'] : '' ; ; ?>  </legend>
...
?>
                ...
                <bookmark class="box-body">
                        ...
                        <h4>Attedance Reports of Attedance Reports of <?php  echo isset($value['summary']['0']['0']['branch_name'])? $value['summary']['0']['0']['branch_name'] : '' ; ; ?>   </h4>
