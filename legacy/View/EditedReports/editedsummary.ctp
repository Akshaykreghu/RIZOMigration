<?php
if ($mode == '') {
    $reporttype = 'Edited Attendance'; ?>

    <div class="modal-body" style="overflow-y: auto;">
        <h2 style="font-weight: bold; text-align: center; font-size: 30px;"> <?php echo "Detailed Edit Attendance - " . $mname . "  "  . $year ?></h2>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (count($arr_data) >= 0) { ?>
                                            ...
                                            foreach ($arr_data as $val) { ?>
                                                <?php $date = $val['EditPunchesHist']['creation_date']; ?>

                                                <?php $c_date = $val['EditPunchesHist']['LOGDATE']; ?>
                                                <?php $c_date = date('Y-m-d', strtotime($c_date)); ?>


                                                <tr>
                                                    <?php $i += 1; ?>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo isset($val['employee_info']['employee_id']) ? $val['employee_info']['employee_id'] : ''; ?></td>
                                                    <td><?php echo $val['EditPunchesHist']['emp_id']; ?></td>
                                                    <!-- <td><?php echo isset($val['user_credentials']['user_id']) ? $val['user_credentials']['user_id'] : ''; ?></td> -->
                                                    <td><?php $S = isset($val['employee_info']['emp_status']) && $val['employee_info']['emp_status'] == "2" ? '(Resigned)' : '';
                                                        echo $val['EmployeeDetails']['first_name'] . ' ' . $val['EmployeeDetails']['last_name'] . $S; ?></td>
