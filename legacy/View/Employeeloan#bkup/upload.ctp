...
//focus on text field
        ...
        if (ctcuploadtype) {
            ...
            window.open('<?php echo $this->webroot; ?>EmployeeLoan/downloademploanformat/' + ctcuploadtype + '/' + branch + '/' + employee + '/' + month, '_blank');
        } else {
            return false;
        }
...
//          /  alert(formData);
        ...
        // Open the connection.
        xhr.open('POST', livesite + 'EmployeeLoan/uploadandsaveempemi/' + ctcuploadtype, true);
...
//$('form[name=myform]').get(0).reset();
  ...
  jQuery(document).ready(function () {
        ...
        $('#att_table').datagrid({
            url: livesite + "EmployeeLoan/employeelist",
            pagination: true,
            singleSelect: true,
            ...
            toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showModalForm(livesite + 'EmployeeLoan/emi_upload')
                    }
...
//                        if (row) {
//
//                            showModalForm(livesite + 'EmployeeLoan/deleteEmployeesemi/' + row.emp_loan_pkey)
//                        } else
//                            $.notify('Please Select A record to edit!', {
//                                type: 'danger',
//                                allow_dismiss: false
...
//                }
            ...
            columns: [[
                    ...
                    {field: 'empname', title: 'Employee Name', width: "24%"},
                    {field: 'empid', title: 'Employee ID', width: "22%"},
                    {field: 'emp_loan_balance', title: 'EMI Amount ', width: '10%'},
                    {field: 'start_date_effective', title: 'EMI Month', width: '11%'},
																		  
																				 
                    {field: 'remarks', title: 'Remark', width: '31%'},
