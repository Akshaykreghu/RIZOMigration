                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            ...
                            <div class="col-md-7">
                                ...
                                ?>"  name="emi_end_month" id="emi_end_month" readonly="readonly" >
                            </div> 
                        </div>
                    </div>
                    <div class="form-group">
...
function filterEmployees()//This is to search employee name or company id. By ***ARUL P DAS on 20/12/2019
{
    ...
    $("#emp_fkey1").select2(
    {
        ...
        allowClear: true,
        ajax: {
            url: livesite + "EmployeeLoan/jsons",
            dataType: 'json',
            delay: 250,
    ...
    function findextingsalary() {
        ...
        var url = 'EmployeeLoan/salarycheck';
//value passiing ajax   
        $.ajax({
            url: url,
            type: 'post',
...
//                    $("#btn-submit").show();
    ...
    function findenddate() {
        var date = document.getElementById("emi_start_month").value;
...
//var n = d.getMonth() +2;
        var getmonth = finalmonth + "-" + esdt.getFullYear();
        $('#emi_end_month').val(getmonth);
    }
