<?php if (isset($arr_reportcriterias)) { ?>
   ...
   <script>
        function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'EmployeeAdvanceReports/loadcriteriaitems/' + index + '/' + criteria);
        }
...
//        return false;
    ...
    if(criteria){
        $('#form-showreport').attr('action',livesite+'EmployeeAdvanceReports/generatereport/'+type+'/'+mode);
    ...
    <?php if ($type == 'employee') { ?>
            ...
            allempfields.init();
            allempfields.clearAndLoad("<?php echo $this->webroot; ?>EmployeeAdvanceReports/listemployeefields", "json");
    ...
    if(criteria){
        ...
        var url = livesite+'EmployeeAdvanceReports/generatereport/'+type;
...
$.ajax({
    ...
    complete: function() {
        ...
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'EmployeeAdvanceReports/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
