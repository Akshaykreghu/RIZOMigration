...
<div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <!-- Form starts -->
  <div id=""class="">
      <form class="form-horizontal" id="form-user-expense" action="<?php echo $this->webroot; ?>ExpenseTypes/save" method="POST" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                          <label style="text-align:left;" for="out_date" class="col-sm-4 control-label">Expense Code<label style="color:red;">*</label><label style="color:red;"></label></label>
                          <div class="col-md-7">
                         ...
                         <div class="form-group">
                            <div class="col-md-12">
                                <label style="text-align:left;" class="col-md-4 control-label" >Expense Type<label style="color:red;">*</label><label style="color:red;"></label></label>
                                <div class="col-md-7">
...
<script>
    ...
    function checkIfExpensecodeExists(callback){        
        ...
        //var id = $('#id').val();
        $.ajax({
            url: 'ExpenseTypes/checkexpensetypecodeexists/',
            type: 'POST',
            data: {
    ...
    function checkIfExpensenameExists(callback){        
        ...
        //var id = $('#id').val();
        $.ajax({
            url: 'ExpenseTypes/checkexpensetypenameexists/',
            type: 'POST',
            data: {
