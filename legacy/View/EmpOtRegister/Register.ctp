...
//        $('#example tbody').on('click', 'td.details-text', function () {
//            var emp = $(this).data('emppkey');
//            var site_fkey = $('#emp_fkey').val();
//            var emp_pkey = $(this).data('total_duration');
//            var month = $(this).data('month');
//             var text = prompt("Set A New Amount",emp_pkey);
//             if(text != null)
//                 {
//                 $.ajax({
//                   url:livesite+ 'OtAttendance/Setvalue',
//                   type: 'post',
//                   data:
//                       {
//                       emp_pkey:emp,
...
//        } );
         ...
         var site_fkey = $('#emp_fkey').val();
            $.ajax({
                                ...
                                success: function(resp){
                                    ...
                                    $('#load').load(livesite+'EmpOtRegister/Approved/'+month,function() { $('#loader').hide(); });
                                }
                            });
          //  alert(selected);
    } );
        ...
        $('#example1 tbody').on('click', 'td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                var month = $('#filterby_month').val();
//                $.ajax({
//                   url:'OtAttendance/subtable/' + emp_pkey +'/'+month,
//                   success: function(resp){
//                       // Open this row
////                       row.child( resp ).show();
////                       tr.addClass('shown');
...
//        $('#example1 tbody').on('click', 'td.details-remarks', function () {
//            var emp = $(this).data('emppkey');
//            var site_fkey = $('#emp_fkey').val();
//            var emp_pkey = $(this).data('total_duration');
//            var month = $(this).data('month');
...
//                 {
//                 $.ajax({
//                   url:livesite+ 'OtAttendance/remarks',
//                   type: 'post',
//                   data:
//                       {
//                       emp_pkey:emp,
...
<div class="tabset0">
<div data-pws-tab="tab1" data-pws-tab-name="To be Approved" data-pws-tab-icon="fa-spinner fa-spin">
...
<table id="example1" class="table table-bordered display" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        <td><?php if($val['emp_ot_master']['set_duration'] == NULL){ echo round(($val['emp_ot_master']['total_duration']/60),2); }else{ echo round(($val['emp_ot_master']['set_duration']/60),2); } ?></td>
        <td class="details-text" data-total_duration="<?php echo $val['emp_ot_master']['total_duration'] ; ?>" data-month="<?php echo $val['emp_ot_master']['month']; ?>" data-emppkey="<?php echo $val['emp_ot_master']['emp_fkey']; ?>"><?php if($val['emp_ot_master']['set_duration'] == NULL){ echo $val['emp_ot_master']['total_duration'] ; }else{ echo $val['emp_ot_master']['set_duration'] ; } ?>&nbsp;&nbsp;<span class="fa fa-pencil" style="color:blue;"></span></td>
...
<!--            <th>Remarks</th>
    ...
    <tbody>
        ...
        foreach ($attendancesverified as $val) {
            ...
            ?>
        <tr id="<?php echo $val['emp_ot_master']['emp_fkey']; ?>">
        <td class="details-control" data-emppkey="<?php echo $val['emp_ot_master']['emp_fkey']; ?>"></td>
        <td style="text-align:left;"><?php echo $val['emp_ot_master']['emp_name'] ; ?></td>
        <td><?php echo round(($val['emp_ot_master']['total_duration'] / 60),2) ; ?></td>
<!--        <td><?php echo $val['emp_ot_master']['remarks'] ; ?></td>
        <td><?php echo $val['emp_ot_master']['is_verified'] ; ?></td>-->
        <td data-total_duration="<?php echo $val['emp_ot_master']['total_duration']; ?>" data-month="<?php echo $val['emp_ot_master']['month']; ?>" data-emppkey="<?php echo $val['emp_ot_master']['emp_fkey']; ?>"><?php if($val['emp_ot_master']['set_duration'] == NULL){ echo round(($val['emp_ot_master']['total_duration'] / 60),2) ; }else{ echo round(($val['emp_ot_master']['set_duration'] / 60),2) ; } ?></td>
        <td><?php echo $val['emp_ot_master']['remarks'] ; ?></td>
        </tr>
