...
<div>
    <legend style="border:none;margin:0px;">Today Attendance </legend>
</div>
<div>
        <!-- Add Buttons Here -->
        <button type="button" class="btn btn-danger"
        onclick="openAttendanceReport('Latein','Daily')">
  Late In
</button>

<button type="button" class="btn btn-success"
        onclick="openAttendanceReport('Earlyin','Daily')">
  Early In
</button>

<button type="button" class="btn btn-success"
        onclick="openAttendanceReport('Lateout','Daily')">
  Late Out
</button>

<button type="button" class="btn btn-danger"
        onclick="openAttendanceReport('Earlyout','Daily')">
  Early Out
</button>
