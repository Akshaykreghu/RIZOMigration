...
/* Style table headers */
#attendance_verification thead th {
...
/* Style rows */
#attendance_verification tbody td {
    padding: 8px 10px;
}
...
<table class="table no-margin" id="attendance_verification">
    <thead>
        <tr>
...
foreach ($data as $row): ?>
    <tr>
        <td><?= $i++; ?></td>
         <td><?= $row['employee_info']['employee_id']; ?></td>
        <td><?= $row['employee_info']['EmpName']; ?></td>
        <td><?= $row['employee_info']['joining_date']; ?></td>
         <td><?= $row['employee_info']['branch']; ?></td>
         <td><?= $row['employee_info']['department']; ?></td>
         <td><?= $row['employee_info']['designation']; ?></td>
...
<script>
    ...
    $(document).ready(function () {
       ...
       var table= $('#attendance_verification').DataTable({
            "paging": true,
            "lengthChange": false,
            "searching": true,
