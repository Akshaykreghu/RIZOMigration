...
/* Style table headers */
#todays_presentall_details thead th {
...
/* Style rows */
#todays_presentall_details tbody td {
    padding: 8px 10px;
}
...
<div class="modal-body" style="overflow-y: auto;">
    <legend>Employees Present Today</legend>
    <div class="row">
        <div class="col-md-12">
            <div class="box ">
                ...
                <div class="box-body">
                    <fieldset>
			    <table class="table table-bordered todayattandence" id="todays_presentall_details">
                            <thead>
                              <tr>
                                  <th>Sl.No.</th>
                            ...
                            <tbody>
                               <?php $i=0; foreach ($presentall as $value) {
                               $i += 1; ?>
                                    
                                        <tr> 
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $value['present_today_all']['EmpName']; ?></td>
...
<script> 
    ...
    var table = $('#todays_presentall_details').DataTable({
        paging: true,
        lengthChange: false,
        searching: true,
        ordering: true,
        ...
        buttons: [
            ...
            },
            {
                ...
                // Keep your existing customize function for styling
