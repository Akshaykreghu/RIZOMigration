...
<div>
    <legend style="border:none;margin:0px;">Last Month Attendance </legend>
</div>
<div>
        <!-- Add Buttons Here -->
        <button type="button" class="btn btn-danger"
        onclick="openAttendanceReport('Latein','LastMonth')">
  Late In
</button>

<button type="button" class="btn btn-success"
        onclick="openAttendanceReport('Earlyin','LastMonth')">
  Early In
</button>

<button type="button" class="btn btn-success"
        onclick="openAttendanceReport('Lateout','LastMonth')">
  Late Out
</button>

<button type="button" class="btn btn-danger"
        onclick="openAttendanceReport('Earlyout','LastMonth')">
  Early Out
</button>
