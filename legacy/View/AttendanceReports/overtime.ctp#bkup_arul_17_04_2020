<?php if ($mode == '') { ?>
    <div class="modal-body" style="overflow-y: auto;">
        <legend>Employee Over Time Attendance  Report</legend>
        <div class="row">
            <div class="col-md-12">
                <div class="box ">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td><b>Verified Duration(In Hrs)</b></td>
                                            <th>Approved</th>
                                            <th>Remarks</th>
                                        </tr>
                                    </thead>
...
<?php } else { ?>
    ...
    echo $this->element('reportadminheader', array(
        'title' => 'Employees OT Attendance  Report'));
    ?>
                                ...
                                <table class="table table-bordered" align="center">
                                    <thead>
                                        <tr>
                                            ...
                                            <td>Department</td>
                                            <td>Joining Date</td>
                                            <td>Total Duration(In Hrs)</td>
                                            <td>Verified Duration(In Hrs)</td>
                                            <td>Approved</td>
                                            <td>Remarks</td>
                                        </tr>
                                    </thead>
