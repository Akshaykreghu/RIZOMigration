...
<?php if ($mode == '') { 
     if($reporttype == 'Attendance'){
       ...
       $reporttype = 'Attendance Register'; 
    }
    ?>
    <div class="modal-body">
        <legend style="text-align: center; "><b><?php echo 'Attendance Register - '.$date; ?></b></legend>
                      ...
                      // debug($value);
                        ...
                        <div class="box-body">
                            <fieldset>
                                ...
                                {
                              $empstatus = (isset($value['summary']['0']['Info']['emp_status'])) && $value['summary']['0']['Info']['emp_status'] =="2" ? '  (Resigned)':'';
                                    ?>
                              
                                    <legend><?php echo isset($value['summary']['0']['Info']['EmpName']) ? $value['summary']['0']['Info']['EmpName'].' '.$empstatus : '    (No Datas Found Under This Employees)'; ?>  </legend>
                                <?php
                                    }
                                ?>
                                <!--       <div class="row">
        ...
        <?php if (count($arr_data) >= 0) { ?>
            ...
            ?>
                                                <tr> 
                                                    ...
                                                    <td><?php $status = isset($val['Info']['emp_status']) && $val['Info']['emp_status'] =="2" ? '  (Resigned)':''; echo $val['Info']['EmpName'] .$status; ?></td>
