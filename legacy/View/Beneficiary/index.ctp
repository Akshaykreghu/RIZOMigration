    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box ">
                ...
                <div class="box-body">
                    <h1 class="page-header"> Beneficiary List</h1>
...
<script>
    ...
    function downloadEmployeeCTCForm() {
        ...
        window.open('<?php echo $this->webroot; ?>Beneficiary/downloadempctcformat/' , '_blank');
    }
...
//alert(formData);
        ...
        // Open the connection.
        xhr.open('POST', livesite + 'Beneficiary/uploadandsaveempctc/' , true);
...
//$('form[name=myform]').get(0).reset();
    ...
    $(document).ready(function () {
        ...
        $('#contacttable').datagrid({
            url: livesite + 'Beneficiary/listcontacts',
            rownumbers: true,
            ...
            toolbar: [{
                    ...
                    handler: function () {
                        ...
                        var url = livesite + 'Beneficiary/addeditcontacts';
                        showModalForm(url);
                    ...
                    handler: function () {
                        ...
                        if (row) {
                            ...
                            var url = livesite + 'Beneficiary/addeditcontacts/' + contact_id;
                            showModalForm(url);
                            //$('#modalDiv').load(url,function(){
                            //    $('#modalDiv').modal('show');
                            //});
                    ...
                    handler: function () {
                        ...
                        if (row) {
                            ...
                            if (r == true) {
                                ...
                                var contact_id = row.contact_id;
                                $.ajax({
                                    url: livesite + 'Beneficiary/deletecontacts/' + contact_id,
            ...
            columns: [[
                    {field: 'company_name', title: 'Beneficiary Name', width: "20%", sortable: true, order: 'asc'},
