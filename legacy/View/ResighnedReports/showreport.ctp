...
<form class="form-horizontal" method="post" action="" id="form-showreport">
    ...
    <div class="col-md-5">
     ...
     <div class="col-md-1"><b>Month</b></div>
        <div class="col-md-3">
            <!-- <select id="reportfrom" name="reportfrom" class="form-control" style="width: 100px; float: left;"> -->
            ...
            <!-- </select> -->
            <!-- <span>&nbsp;&nbsp;</span> -->
             <!-- End month or To date is added by ***ARUL P DAS on 13/12/2019 -->
            <!-- <select id="reportto" name="reportto" class="form-control" style="width: 100px; float: left;">            -->
                <!-- <?php
                $start_month = strtotime(date('Y-m', strtotime("+1 month", strtotime(date('Y-m')))));
                for ($i = 0; $i < 10; $i++) {
                    $month = date('Y-m', strtotime("-$i month", $start_month));
            ...
            <!-- The date format changed by ***ARUL P DAS on 16/12/2019 -->
            <input type="text" id="reporstfrom" name="reportfrom" class="form-control pickerDate" value="<?php echo date("Y-m", strtotime("-1 months")); ?>" style="width: 80px; float: left;" />
            <input type="text" id="reporstto" name="reportto" class="form-control pickerDate" value="<?php echo date("Y-m"); ?>" style="width: 80px; float: left; margin-left: 10px;" />
        </div>
...
//        return false;
	...
	if(criteria){
        $('#form-showreport').attr('action',livesite+'ResighnedReports/generatereport/'+type+'/'+mode);
...
<?php if($type == 'employee'){ ?>
    ...
    allempfields.init();    
    allempfields.clearAndLoad("<?php echo $this->webroot; ?>ResighnedReports/listemployeefields", "json");
...
function viewReport(){ 
     $('#loaders').show();
        ...
        var url = livesite+'ResighnedReports/generatereport/'+type;
...
function loadCriteriaItems(index){
    ...
    $('#div-items-criteria'+index).load(livesite+'ResighnedReports/loadcriteriaitems/'+index+'/'+criteria);
}
function addOneReportCriteria(index){
    ...
    $('#div-criteria'+newIndex).load(livesite+'ResighnedReports/addreportcriteria/'+type+'/'+newIndex+'/'+currentcriteriaschosen);
