...
<div class="col-md-10">
    ...
    ?>
    <ul title="<?php echo 'Select '.$msg; ?>" lines="true" style="width:100%;min-height:200px;height:auto;max-height:500px;"><li></li></ul>
</div>
<script>
...
$(document).ready(function(){
    ...
    $('#div-items-criteria<?php echo $index; ?> ul').datalist({
        ...
        url: livesite + 'ResighnedReports/listcriteriaitems/'+criteria,
        //checkbox: true,
        searchFilter:true,///This is turn on by ***ARUL P DAS on 5/12/2019
        checkOnSelect: true,
        singleSelect: false,
        lines: true,
        valueField: "key",
