  <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>EmployeeLeaveRequest/saveLeaveEntry" id="myleaverequestform">
          ...
          <div class="modal-body">
              ...
              <fieldset>
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                          <label style="text-align:left;" class="col-md-4 control-label" for="contact_person">Employee</label>
                          <div class="col-md-8">
                              ...
                              <select style="width:100%; " id="Employee" name="Employee" placeholder="Employee" class="form-control select2-searching input-md strict-field">
                                  <option>Select</option>

                                  <?php foreach ($arr_users as $users) {
                                        //debug($arr_users);
                                    ?>
                                      <option value="<?php echo $users['emp_details']['emp_pkey']; ?>"><?php echo $users['0']['name'].' - '. $users['ei']['employee_id']; ?></option>
                                  <?php
                                    }
                                    ?>
                              </select>
                  ...
                  <div class="form-group">
                      ...
                      <!--                      <label style="text-align:left;" id="" class="col-md-2 control-label"></label>
                     <div class="col-md-4" style="padding-right: 0px;padding-top: 7px; padding-left: 25px;">
                         <input type="hidden" id="planned_type" name="planned_type" value="" />
                        <label style="text-align:left;color:#00c0ef;" id="PlannedLeave"></label>
                     </div>-->
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                          ...
                          <div class="col-md-8" style="padding-left: 0px;padding-right: 0px;">
                              ...
                              <div class="col-md-6">
                                  <select <?php echo ($leaveentryId > 0) ? 'disabled="disabled"' : 'required=""'; ?> class="form-control input-md strict-field" id="FROMHALF" name="FROMHALF" onchange="getLeaveBalance()">
                                      <option value="1" <?php echo ($arr_leave_details["FROMHALF"] == '1') ? 'selected="selected"' : ''; ?>>First Half</option>
                                      <option value="2" <?php echo ($arr_leave_details["FROMHALF"] == '2') ? 'selected="selected"' : ''; ?>>Second Half</option>
                                  </select>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-6">
                          ...
                          <div class="col-md-8" style="padding-left: 0px;padding-right: 0px;">
                              ...
                              <div class="col-md-6">
                                  <select <?php echo ($leaveentryId > 0) ? 'disabled="disabled"' : 'required=""'; ?> class="form-control input-md strict-field" id="TOHALF" name="TOHALF" onchange="getLeaveBalance();">
                                      <option value="1" <?php echo ($arr_leave_details["TOHALF"] == '1') ? 'selected="selected"' : ''; ?>>First Half</option>
                                      <option value="2" <?php echo ($arr_leave_details["TOHALF"] != '1' || $arr_leave_details["TOHALF"] == '2') ? 'selected="selected"' : ''; ?>>Second Half</option>
                                  </select>
                              </div>
                          </div>
                      </div>
                  ...
                  <input type="hidden" id="Currentemp" name="Currentemp" value="" />
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                          ...
                          <div class="col-md-8">
                              ...
                              <input type="text" id="Authorized" class="form-control strict-field" value="" name="Authorized" placeholder="Search Your Employee Name" style="width: 250px;" required="" />
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="col-md-8">
                              <!--                         <select id="APPROVEDBY" class="form-control js-example-basic-single" name="APPROVEDBY" style="width: 250px;" >
                                </select>  -->
                              ...
                              <input type="hidden" id="APPROVEDBY" class="form-control" name="APPROVEDBY" value="" />
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="col-md-8">
                              <input id="contact_No" name="contact_No" value="<?php echo $arr_leave_details["contact_No"]; ?>" type="number" placeholder="Contact Number" class="form-control input-md strict-field">
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                          ...
                          <div class="col-md-8">
                              ...
                              <select style="width:100%; " id="contact_person" name="contact_person" placeholder="Duties handed over to" class="form-control select2-searching input-md strict-field">
                                  ...
                                  <?php foreach ($arr_users as $users) {
                                    ?>
                                      <option value="<?php echo $users['0']['name']; ?>"><?php echo $users['0']['name'].' - '. $users['ei']['employee_id']; ?></option>
                                  <?php
                                    }
                                    ?>
                              </select>
                      ...
                      <div class="col-md-6">
                          <label style="text-align:left;display: flex;" class="col-md-4 control-label" for="file">Upload File <div id="mandatory">&nbsp;<span style="color:red;">*</span></div></label>
                          <div class="col-md-8">
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                          <label style="text-align:left;display: flex;" class="col-md-4 control-label" for="File">Uploaded File Name<div id="mandatoryfilename">&nbsp;<span style="color:red;">*</span></div></label>
                          <div class="col-md-8">
          ...
          <div class="modal-body">
              <div class="box-body">
                  ...
                  <div class="row" style="padding-left: 15px;margin-top: -15px;">
                      <div class="col-md-4 col-sm-4 col-xs-4" style="font-size: 16px;font-weight: 600;"><?php echo date('d-m-Y', strtotime($arr_leave_details["FROMDATE"])); ?><span style="font-size: 15px;font-weight: 300"><?php echo isset($arr_leave_details["FROMHALF"]) && $arr_leave_details["FROMHALF"] == "1" ? '&nbsp;(First Half)' : '&nbsp;(Second Half)' ?></span></div>
                      <div class="col-md-1 col-sm-1 col-xs-1" style="padding-top: 4px;"> To</div>
                      <div class="col-md-4 col-sm-4 col-xs-4" style="font-size: 16px;font-weight: 600;"><?php echo date('d-m-Y', strtotime($arr_leave_details["TODATE"])); ?><span style="font-size: 15px;font-weight: 300"><?php echo isset($arr_leave_details["TOHALF"]) && $arr_leave_details["TOHALF"] == "1" ? '&nbsp;(First Half)' : '&nbsp;(Second Half)' ?></span> </div>
                  ...
                  <div class="form-group ">
                      <div class="row" style="padding-top: 2px;padding-left: 30px;">
                          ...
                          <div class="col-md-3 col-sm-4 col-xs-4">
                              <b> : <?php echo date('d-m-Y', strtotime($arr_leave_details['applied_date'])) ?></b>
                          </div>
                          <div class="col-md-3 col-sm-2 col-xs-2">
                              <span>
                                  Leave Status
                      ...
                      <div class="row" style="padding-top: 12px;padding-left: 30px;">
                          ...
                          <?php } else { ?>
                              <div class="col-md-3 col-sm-4 col-xs-4">
                                  <b> : <?php echo $arr_leave_details['Reason'] ?></b>
                      ...
                      <div class="row" style="padding-top: 12px;padding-left: 30px;">
                          ...
                          <div class="col-md-3 col-sm-4 col-xs-4">
                              <b> : <?php $authorizedDate = $arr_leave_details['Autherized_date'];

                                    if ($authorizedDate != '0000-00-00' && strtotime($authorizedDate) !== false) {
                                        echo date('d-m-Y', strtotime($authorizedDate));
                                    } else {
                                        echo ''; // or any other default value you want to show for invalid dates
                                    } ?></b>
                          </div>
                      ...
                      <div class="row" style="padding-top: 12px;padding-left: 30px;">
                          ...
                          <div class="col-md-3 col-sm-4 col-xs-4">
                              <b> : <?php echo isset($arr_leave_details['APPROVED_date']) ? date('d-m-Y', strtotime($arr_leave_details['APPROVED_date'])) : ''; ?></b>
                          </div>
                              ...
                              <?php $docs = isset($arr_leave_details['file_name']) ? $arr_leave_details['file_name'] : '';
                                ...
                                foreach ($fielddocs as $doc) {
                                    ...
                                    if (strpos($doc, '.pdf') !== false) { ?>
                                      <ul>
                                          <li style="margin:2px;">: <b><?php echo $nm; ?></b>&nbsp;&nbsp; <span class="tooltiptext">
                                                  ...
                                                  <i class="fa fa-trash tooltip1" style="font-size:15px;color:#3c8dbc;" onclick="deleteleavedocument(<?php echo $leaveid; ?>,'<?php echo $lstatus; ?>','<?php echo $nm; ?>','<?php echo $doc; ?>');"></i>&nbsp;
                                              </span></li>
                                      </ul>
                                      <!--                              echo '<div style="margin:2px;color:black;"> : <b>'.$name.'</b>&nbsp;&nbsp;<span class="tooltiptext"><a href="'.$doc.'"  download="'.$doc.'">'
//                                      . '<i class="fa fa-file-pdf-o" style="font-size:15px;color:#3c8dbc;"></i></a>'
//                               . '&nbsp;&nbsp;<a href="'.$doc.'" target="_blank"><i class="fa fa-cloud-download" style="font-size:15px;color:#3c8dbc;"></i></a></span></div>';  -->
                                  <?php  } else if (strpos($doc, 'g') !== false || strpos($doc, 'G') !== false) { ?>
                                      ...
                                      <!--         echo '<ul><li style="margin:2px;">: <b>'.$nm.'</b>&nbsp;&nbsp; <span class="tooltiptext">'
                               ...
                               . '<i class="fa fa-trash tooltip1" style="font-size:15px;color:#3c8dbc;" onclick="deleteleavedocument('.$leaveid.','.$lstatus.','.$nm.','.$doc.');"></i>&nbsp;'
                               .  '</span></li></ul>';
//                                 echo '<div style="margin:2px;color:black;"> : <b>'.$name.'</b>&nbsp;&nbsp;<span class="tooltiptext"><a href="'.$doc.'"  download>'
//                                      . '<i class="fa fa-file-image-o" style="font-size:15px;color:#3c8dbc;"></i></a>'
//                               . '&nbsp;&nbsp;<a href="'.$doc.'" target="_blank"><i class="fa fa-cloud-download" style="font-size:15px;color:#3c8dbc;"></i></a></span></div>'; -->
                              <?php       } else {
                                    }
                                    $i++;
  ...
  <script>
      function deleteleavedocument(id, status, name, doc) {
          ...
          if (status !== "Applied") {
              ...
              if (confirm("Do you want to delete the selected leave request(s)?")) {
                  $.ajax({
                      url: livesite + 'EmployeeLeaveRequest/deletedoc/' + id + '/' + name + '/' + doc,
                      success: function(resp) {
                          ...
                          if (response.status == 1) {
                              ...
                              showLargeModalForm(livesite + 'EmployeeLeaveRequest/addeditleave/' + id);
      ...
      jQuery(document).ready(function() {
          ...
          var usersoptions = {
              url: function(phrase) {
                  ...
                  empPkey = $("#Employee").val();
                  return livesite + 'EmployeeLeaveRequest/getusers?username=' + phrase + '&action=auth&empPkey=' + empPkey;
              },
              getValue: "full_name",
              list: {
          ...
          var usersoptionsappr = {
              url: function(phrase) {
                  //Edited by Akshay on 20-2-2024
                  empPkey = $("#Employee").val();
                  //return livesite + 'LeaveRequest/getusers?username=' + phrase;
                  //edited by megha on 11_6_19 approved by hierarchy persons only
                  return livesite + 'EmployeeLeaveRequest/getusers?username=' + phrase + '&action=apr&uname=' + $("#ISAutherizedby").val() + '&empPkey='+empPkey;
              },
              getValue: "full_name",
              list: {
                  onClickEvent: function() {
          ...
          var usersoptionsnotify = {
              url: function(phrase) {
                  return livesite + 'EmployeeLeaveRequest/getusers_notify?username=' + phrase;
              },
              getValue: "full_name",
              list: {
                  onClickEvent: function() {
      ...
      function getLeaveBalance() {
          ...
          var emp = $('#Currentemp').val();
          if (salary_head_item_fkey == '') {
              alert('Select any leave type');
              $('#showremarks').hide();
          } else {
              $.ajax({
                  url: livesite + 'EmployeeLeaveRequest/GetLeaveBalance/' + salary_head_item_fkey + '/' + emp + '/' + end_date,
                  type: 'POST',
                  data: {
                      end_date: end_date,
                  ...
                  success: function(resp) {
                      ...
                      //var PlannedLeave = $.parseJSON(resp).PlannedLeave;
                      ...
                      //$('#planned_type').val(PlannedLeave);
                      $('#Leavebalance').html('Available Leave Balance : ' + monthly_balance);
                      //$('#PlannedLeave').html( 'Planned Leave Days : ' + PlannedLeave );
                      //$('#PlannedLeave').show();
                      $('#showremarks').show();
                      ...
                      if ((monthly_balance == 0 && allow_negative != 'Y') || yearly_balance == 0) {
      ...
      function changeLeaveBalance(e) {
          ...
          $('#hid_monthly_balance').val(selected_leave_balance);
      }
      ...
      $(document).ready(function() {
          // Bind change event to the employee select box
          $('#Employee').change(function() {
              var selectedEmployeeId = $(this).val(); // Get the selected employee ID
              $('#Authorized').val('');
              $('#ISAutherizedby').val('');
              $('#APPROVED').val('');
              $('#APPROVEDBY').val('');
              $('#Currentemp').val(selectedEmployeeId);
              // Make an AJAX request to fetch authorized and approved persons
              $.ajax({
                  type: 'POST',
                  url: livesite + 'EmployeeLeaveRequest/Getauther_approv',
                  data: {
                      employee_pkey: selectedEmployeeId
                  },
                  dataType: 'json',
                  success: function(response) {
                      // Accessing the data returned by the PHP script
                      var approvedName = response.approvedname;
                      var approvedBy = response.approvedby;
                      var authorisedByName = response.authorisedbyname;
                      var authorisedBy = response.authorisedby;
                      $('#Authorized').val(authorisedByName);
                      $('#ISAutherizedby').val(authorisedBy);
                      $('#APPROVED').val(approvedName);
                      $('#APPROVEDBY').val(approvedBy);
                      // console.log('Approved Name: ' + approvedName);
                      // console.log('Approved By: ' + approvedBy);
                      // console.log('Authorised By Name: ' + authorisedByName);
