...
jQuery(document).ready(function() {
    ...
    $('#empleaverequeststable').datagrid({
                url:livesite+"EmployeeLeaveRequest/listempleaves",
                pagination:true,
                singleSelect:true,
                rownumbers:true,
                ...
                handler: function(){
                    ...
                    showLargeModalForm(livesite+'EmployeeLeaveRequest/manageempleave/' + row.LEAVEENTRYID);
                }
                }],
                fitColumns:true,
                ...
                url:livesite+"EmployeeLeaveRequest/listempleavesverified",
                pagination:true,
                rownumbers:true,
                singleSelect:true,
                toolbar: [{
