<section class="content-header">
    <h1 class="text-primary-18">Employee Leave Request(s)</h1>
...
jQuery(document).ready(function() {
    ...
    $('#myleaverequeststable').datagrid({
                ...
                pagination:true,
                singleSelect:true,
                PostsearchFilter: true,     //edited by ASHIN on 11-11-24 
                rownumbers:true,
                toolbar: [{
                text:'New Leave',
                iconCls:'icon-add',
