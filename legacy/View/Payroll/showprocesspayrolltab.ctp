            ...
            <table cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        ...
                        ?>
                        <!--td>
                            <a href="javascript:void(0)" onclick="holdProcessPayroll();" class="l-btn l-btn-small l-btn-plain" group="" id="">
                                <span class="l-btn-left l-btn-icon-left">
                                    <span class="l-btn-text">Hold</span>
...
<script>
    ...
    $('#payrolltable').datagrid({
        url: livesite + "payroll/listpayroll",
        pagination: true,
        singleSelect: false,
        queryParams: {
            branch: branch,
        ...
        //add color for net salary =0,-ve // added by nimisha 26-04-2019
         rowStyler:function(index,row){
            if (row.net_salary < '0' || row.net_salary === '0') { // Edited by Akshay on 5-8-2025
                    return 'color:white; background-color: red';
//                return 'color:#B22222;';
            }
                else if(row.resigned === true){
                    return 'color:red;'
                }
        },
...
<script>
    ...
    $('#processedpayrolltable').datagrid({
        url: livesite + "payroll/listprocessedpayroll",
        pagination: true,
        singleSelect: false,
        queryParams: {
            branch: branch,
