      ...
      <div class="collapse navbar-collapse box-shadow {{app.settings.navbarCollapseColor}}">
        ...
        <!-- search form -->
     <!--
        <form class="navbar-form navbar-form-sm navbar-left shift" ui-shift="prependTo" target=".navbar-collapse" role="search" ng-controller="">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a href class="dropdown-toggle clear" data-toggle="dropdown">
              ...
              <span class="hidden-sm hidden-md"><?php echo  $loginname; ?></span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
            <ul class="dropdown-menu animated fadeInRight w">
              ...
              <li class="divider"></li>
              <li>
                <a href="<?php $this->webroot ?>Site/logout">Logout</a>
              </li>
            </ul>
            <!-- / dropdown -->
          </li>
