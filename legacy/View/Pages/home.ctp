...
//    case 'forsight':
?>
<!--                    <img src="<?php echo $this->webroot; ?>/files/mpm.png" width="80px;" class="responsive">
                </div>
                <div class="login-logo">
                ...
                // default:
                ?>
                <img src="http://login.mypayrollmaster.com/files/mpm.png" width="80px;" class="responsive">
            </div>
            <div class="login-logo">
                <a href=""><b>My Payroll Master</b></a>
            </div> 
            ...
            // case 'giridhar':
            ?>
            <img src="<?php echo $this->webroot; ?>/files/logogiri.jpg" width="80px;" class="responsive">
        </div>
        <div class="login-logo">
            <a href=""><b>Giridhar Eye Institute</b></a>
        </div> -->
<?php
//   break;
//}
...
<!--<div class="box box-header pull-right login-box-body col-sm-12" style="border-radius: 28px;">-->
<!--    <p class="login-box-msg">Sign in to start your session</p>-->
<?php if (isset($messages)) { ?>
    <div class="alert alert-danger" role="alert" style="padding: 4px 9px;"><?php echo $messages; ?></div>
<?php } ?>
<form method="post" id="formLogin" action="<?php echo $this->webroot ?>Site/login">
    ...
    <div class="form-button">
        <button id="login" type="button" onclick="submitForm();" class="ibtn">Login</button> <a href="<?php echo $this->webroot; ?>Site/passwordreset">Forget password?</a>
    </div>
    <!--        <div class="row">
           <div class="col-xs-8">
