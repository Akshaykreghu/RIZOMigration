<div  style="/*background-image: url('https://mypayrollmaster.com/ws/0a02dd1e22fcb979963554cad8a8002e.jpg'), url('https://mypayrollmaster.com/ws/Snowflake.gif'); background-repeat: repeat;
...
?>
        ...
        <div class="login-logo">
        <a href=""><b style='padding: 43px; 
    background: white;
    border-radius: 26px; '>My Payroll Master</b></a>
      </div> 
        <?php
        break;
     case 'giridhar':     
