...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="Otattendance" action="<?php echo $this->webroot; ?>OtAttendance/save" method="POST">
...
<script type="text/javascript">
    ...
    function setsave() {
        ...
        $.ajax({
            type: 'POST',
            url: livesite + 'OtAttendance/savedata',
            data: {
                month: month,
                emp: emp,
                duration: duration,
            ...
            success: function(data) {
                ...
                if (data) {
                    ...
                    $('#load').load(livesite + 'OtAttendance/Approved/' + month + '/' + empPkey + '/' + 1 + '/' + branch, function() {
                        $('#loader').hide();
    ...
    $(document).ready(function() {
        ...
        // $('#Otattendance').submit(function() {
        //     var month = $('#month').val(); // Get month value from hidden input
        //     var formattedMonth = month.substring(0, 7);
        //     var emp = $('#emp').val(); // Get emp value from hidden input
        //     $.ajax({
        //         url: livesite + 'OtAttendance/counting/' + formattedMonth + '/' + emp,
        ...
        $('#Otattendance').submit(function(event) {
