    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editpunchesbydate').datagrid({
                ...
                width: '550px',
                //height: '600px',
                url: livesite + "EditAttendance/listpunchesbydate",
                pagination: true,
                singleSelect: true,
                iconCls: 'icon-edit',
                pageSize: 20,
                ...
                columns: [
                    [{
                        ...
                        {
                            field: 'C3',
                            title: 'Adtnl Out Time',
                            width: "30%",
                        },
                        {
                            field: 'C3',
                            title: 'Adtnl Duration',
                            width: "30%",
                        },
                        {
                            field: 'C3',
        ...
        function saverow(target, row, value) {
            ...
            $.ajax({
                type: "POST",
                url: livesite + "EditAttendance/savepunch/" + empid,
                data: {
                    C1: row.C1,
        ...
        function insert() {
            ...
            if (emp) {
                $('#empid').val(emp);
                //Add form
                showSmallModalForm(livesite + 'EditAttendance/form/' + emp + '/' + att_date + '/' + site_trans_fkey);
            } else {
