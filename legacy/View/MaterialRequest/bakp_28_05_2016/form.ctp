                                ...
                                foreach ($arr_att as $value) {
                                   ...
                                   <?php
                                      ...
                                      ?>
                                            ...
                                            <td><input type = "text" value = "<?php echo isset($value['mr_details']['incoming_date']) ? $value['mr_details']['incoming_date'] : ''; ?>" name = "incoming_date[]" id ="end_date" placeholder = "select date"></td>
