...
function addOneReportCriteria(index){
 ...
 $('#div-criteria'+newIndex).load(livesite+'MaterialRequest/addnewrow');
}
 ...
 <form class="form-horizontal" id="form-user-master" method="post" action="<?php echo $this->webroot; ?>MaterialRequest/save" >
            <div role="tabpanel" class="tab-pane" id="div-" name="">
                       ...
                       <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-3">
                                <label  class="col-md-4 control-label" >MR Date<label style="color:red">*</label></label>
                                <div class="col-md-8">
                            ...
                            <label  class="col-md-2 control-label" >Branch</label>
                                <div class="col-md-3">
                                    <input id="branch" name="branch" value="<?php echo  isset($arr_att['0']['material_request']['branch']) ?$arr_att['0']['material_request']['branch'] : '' ; ?>" type="text"  class="form-control input-md" required="required" >
                                                                    </div>
                            </div>
                        </div>
...
<!--                                    <input id="store_code" name="store_code" value="<?php //echo  isset($arr_att['0']['material_request']['store_code']) ?$arr_att['0']['material_request']['store_code'] : '' ; ?>" type="text"  class="form-control input-md" >-->
    ...
    ?> 
                                <tbody>
                                    <tr>
                                        <td><select id="" class="selectdata" name="item_code[]" style = "width:135px" required="reduired">
                                      <option value="" >-select-</option>
                                   <?php
