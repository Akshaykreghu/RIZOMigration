...
<section>
    <div class="container" style="margin-bottom : 46px; margin-top : 46px;">
        <h1 style="text-align: center;padding-top: 20px;"> Analysis Master </h1>
        <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>DbConfig/emp_upload" method="post">

            <div class="col-md-12">
                <br>
                <div class="row ">
                    <h3>Get the Topic You Want to Analyse </h3>
                    <select id="dept" class="form-control js-example-basic-single" >
                        <?php foreach($arr_employees as $val){ ?>
                            <option value="<?php echo $val['emp_pkey']; ?>"><?php echo $val['emp_name']; ?></option>
                        <?php } ?>
                    </select>
                        <div class="box box-solid">
                            <div class="box-body">
                                <table id="layout-skins-list" class="table table-striped bring-up nth-2-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><code>Employee Duplication Found </code></td>
                                            <td>
                                                <a onclick="move_departments('Analysis/duplication_founds/');" data-skin="skin-blue" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>Payroll Process </code></td>
                                            <td>
                                                <a onclick="move_departments('Analysis/payroll/');" data-skin="skin-blue" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>Salary Allocation Error </code></td>
                                            <td>
                                                <a onclick="move_departments('Analysis/payroll/');" data-skin="skin-blue" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>Leave Balance Not Showing </code></td>
                                            <td>
                                                <a onclick="move_departments('Analysis/payroll/');" data-skin="skin-blue" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>Login Issue </code></td>
                                            <td>
                                                <a onclick="move_departments('Analysis/payroll/');" data-skin="skin-blue" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><code>Always Show In Button  </code></td>
                                            <td>
                                                <a onclick="move_departments('Analysis/payroll/');" data-skin="skin-blue" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                ...
                                <div id="load_calender" style="margin-left: 10px; " class="row box box-body"></div>
                            </div><!-- /.box-body -->
