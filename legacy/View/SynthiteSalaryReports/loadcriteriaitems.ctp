<script>let select_all = false; </script>
...
<!--    //edited by arul on 4/12/2019  li list not showing fully-->
    ...
    <ul title="<?php echo 'Select '.$msg; ?>" lines="true" style="width:320px;min-height:200px;height:auto;max-height:500px;margin-left:-50px;"><li></li></ul>
</div>
...
<input type="hidden" id="selectall" value="0" name="selectall">
...
$(document).ready(function(){
    ...
    $('#div-items-criteria<?php echo $index; ?> ul').datalist({
            ...
            iconCls: 'icon-ok',
            handler: function () {
                $('#selectall').val('1');//Edited by Akshay on 26/10/2023
            ...
            iconCls: 'icon-delete',
            handler: function () {
                $('#selectall').val('0');//Edited by Akshay on 26/10/2023
        ...
        columns:[[
		{
                    ...
                    formatter: function(value,row,index){
                        //console.log(row);
                        return '<input type="checkbox" id ="drop_down" class="checkw" name="'+criteria+'[]" value="'+row.key+'" />';
                        // }
                    }
                },
		{
        ...
        url: livesite + 'SynthiteSalaryReports/listcriteriaitems/'+criteria,
        //checkbox: true,
        checkOnSelect: true,
	searchFilter:true,
        singleSelect: false,
