...
<?php if ($mode == '') { ?>
    ...
    <?php } else { ?>
        ...
        ?>
                        ...
                        <page backtop="25mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size: 12pt; ">

                            <page_header>
                                <h3 style="text-align: center; padding-top: 10px;"><?php echo isset($arr_comp_contact_info['CompanyContactInfo']['business_name']) ? $arr_comp_contact_info['CompanyContactInfo']['business_name'] : ''; ?></h3>
                        ...
                        <table class="table" align="center" style="margin-top: 10px;;  ">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th style=" font-weight: bold; ">Earnings</th>
                                    ...
                                    <th style="font-weight: bold; ">Deductions</th>
                                ...
                                ?>
                                    ...
                                    ?>
                                        ...
                                        <tr> <?php
                                                ...
                                                ?>
                                            <!-- edited by megha on 30_05_19 round off  -->
                                            <td style="width:60px;word-wrap: break-word;overflow: hidden;  "><?php echo isset($arr_data[$i]['ectc']['salary_head_item_desc']) ? trim($arr_data[$i]['ectc']['salary_head_item_desc']) : ''; ?></td>
                                            ...
                                            <?php } else { ?>
                                                <td style="width:60px;word-wrap: break-word; overflow: hidden; " class="amounts"><?php echo isset($arr_data[$i][0]['total_earned_salary']) ? sprintf("%.2f", abs(round($arr_data[$i][0]['total_earned_salary']))) : ''; ?></td>
                                            <?php }
                                            ?>


                                            <td style="width:60px;word-wrap: break-word; overflow: hidden; "><?php echo isset($arr_withoutComponents[$i]['ectc']['salary_head_item_desc']) ? trim($arr_withoutComponents[$i]['ectc']['salary_head_item_desc']) : ''; ?></td>

                                            <!--  //edited by megha on 6_7_19 remove 0 values from deductions-->
                                            <td style="width:60px;word-wrap: break-word; overflow: hidden; " class="amounts"><?php echo isset($arr_withoutComponents[$i][0]['total_actual_salary']) ? sprintf("%.2f", abs(round($arr_withoutComponents[$i][0]['total_actual_salary']))) : ''; ?></td>
                                    ...
                                    <tr>
                                        <th style="text-align :left;"><b>TOTAL EARNINGS</b></th>
                                        <th class="amounts" style=""><b><?php echo formatIndianNumber(sprintf("%.2f", abs(round($structure)))); ?></b></th>
                                        <th class="amounts" style=""><b><?php echo formatIndianNumber(sprintf("%.2f", abs(round($sum,2)))); ?></b></th>
                                        <th style=""><b>TOTAL DEDUCTIONS</b></th>
                                        <th class="amounts" style=""><b><?php echo formatIndianNumber(sprintf("%.2f", abs(round($st_dd)))); ?></b></th>
                                        <th class="amounts"><b><?php echo formatIndianNumber(sprintf("%.2f", abs(round($dd,2)))); ?></b></th>
                                    </tr>
                                    <!-- edited by megha on 16/11/19 settlement amount  -->
                                    <?php if ($value['summary']['0']['ed']['status'] == 2) { ?>
                                        <!-- <tr style="background: #cccccc ;"> -->
                                    ...
                                    // debug($structure);
                                    // debug($st_dd); exit;
                                    $net_amount = round(abs($structure) - abs($st_dd));
                                    $net_amount2 = round((abs($sum) - abs($dd)),2);
                                    ?>

                                    <tr>
                                        <th style="text-align :left ; "><b>NET PAY</b></th>
                                        <!-- <th class="amounts" style=""><b><?php echo formatIndianNumber(sprintf("%.2f", $net_amount)); ?></b></th> -->
                                        <th class="amounts" style="border-right:.2px solid white;"><b><?php echo formatIndianNumber(sprintf("%.2f", $net_amount2)); ?></b></th>
                                        <th colspan="4" style="text-align :left ; "><b></b></th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th style="text-align :left ; "><b>NO:OF EMPLOYEES</b></th>
                                    ...
                                    ?>
                                        ...
                                        <?php if ($value['summary']['0']['ed']['status'] == 2) { ?>
                                            ...
                                            <tr>
                                                <th style="text-align :center ; " colspan="4"></th>
                                                <th style="text-align :left ; "><b>Settlement Amount</b></th>
                                                <th class="amounts" style=""><b><?php echo formatIndianNumber(sprintf(round($value['settle']))); ?></b></th>
                                            </tr>
                                        <?php }
                                        // debug($structure);
                                        // debug($st_dd); exit;
            ...
            <page backtop="40mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size: 12pt">
            ...
            <div style="padding-left: 100px; font-size: 20px;">No data available under the selected criteria.</div>
