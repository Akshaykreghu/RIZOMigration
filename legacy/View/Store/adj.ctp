...
<script>
    function newmode()
    {
        $('#div-criteria1').load('Store/adj');
    }
$('#adjustment_date').on('change', function (event) {
...
<!--                                <div class="col-md-3">
                    ...
                    <!-- <h1 class="text-primary-18"> Stock Adjustment</h1> -->
                      <div class="heading">
                    <h1 class="text-primary-18">Stock Adjustment</h1>
                    ...
                    <form class="form-horizontal" style="padding-left:1px; padding-right:8px ; border:1px;" id="form-user-master" method="post" action="<?php echo $this->webroot; ?>Store/save_stock_transfer" >
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            <input id="adjustment_code" name="adjustment_code" value="<?php echo isset($arr_att['0']['stock']['adjustment_code']) ? $arr_att['0']['stock']['adjustment_code'] : mt_rand(); ?>" type="text"  class="form-control input-md" required="required" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label style="text-align:left;" class="col-md-5 control-label" >Transaction Date<label style="color:red;">*</label></label>
                                        <div class="col-md-7">
                                            <input id="adjustment_date" onchange="close();" placeholder="select date" name="adjustment_date" value="<?php echo isset($arr_att['0']['stock']['adjustment_date']) ? $arr_att['0']['stock']['adjustment_date'] : ''; ?>" type="text"  class="form-control input-md"  required="required">
                                        </div> 
                                    </div>
                                    <div class="col-md-4">
                                        <label style="text-align:left;" class="col-md-5 control-label" >Select Store <label style="color:red;">*</label></label>
                                        <div class="col-md-7">
                                            <input id="store_code"    name="from_stores" value="<?php echo isset($arr_att['0']['stock']['from_store']) ? $arr_att['0']['stock']['from_store'] : ''; ?>" type="text"  class="form-control input-md" onchange="clear();" required="required">
                                            <input type="hidden" name="from_store" id="from_store" value="" onchange="clear();">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
<!--                                    <div class="col-md-4">
                                        <label style="text-align:left;" class="col-md-5 control-label" >To Store <label style="color:red;">*</label></label>
                                        <div class="col-md-7">
                                            <input id="tostore_code"  name="to_stores" value="<?php echo isset($arr_att['0']['stock']['to_store']) ? $arr_att['0']['stock']['to_store'] : ''; ?>" type="text"  class="form-control input-md" required="required" onchange="listitem();" >
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            <select name="remarks" id="remarks" class="form-control input-md" >
                            ...
                            <div class="form-group">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-7">
                                        <select id="item_desc" class="form-control js-example-basic-single" name="item_desc" onchange="finditem();" >
                                        </select>
                                        <!-- <input type="text" id="item_desc" class="form-control" name="item_desc"  style="width:190px;" onkeyup="checkitem();" onchange="finditem();" required="required"> -->
                                        <input type="hidden" id="item_pkey" class="form-control" name="item_pkey"  >
                                    </div> 
                                </div>
                                <!--<div class="col-md-4" style="display : none ; ">
                                    <label style="text-align:left;" class="col-md-5 control-label"  >Item Code<label style="color:red;"  >*</label></label>
                                    <div class="col-md-6">
                                        <input type="text" id="item_code" class="form-control" name="item_code"  style="width:190px;"   onkeyup="checkitemcode();" required="required">   
                                    </div> 
                                </div>-->
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label style="text-align:left;" class="col-md-5 control-label" >Adjusted Qty<label style="color:red;">*</label></label>
                                    <div class="col-md-7">
                                        <input type="number" id="required_qty" min="1" class="form-control"  name="required_qty"  onchange="valuecheck();" required="required ">   
                                    </div>
                                </div>
...
//        }
        ...
        $.ajax({
            url: 'Store/finditem_qtyvalue/' + date_allocated + '/' + store_fkey+'/'+item_pkey,
...
//        alert("change clicked");
    ...
    $(document).ready(function () {
        ...
        $('#att_table').datagrid({
            url: livesite + "Store/stockadjlist",
            pagination: true,
            singleSelect: true,
            rownumbers: true,
            ...
            columns: [[
                    ...
                    {field: 'store', title: 'Store Name', width: "20%"},
                    {field: 'item', title: 'Item Name', width: "20%"},
                    {field: 'qty', title: 'Qty', width: "20%"},
                    {field: 'dates', title: 'Date Transfered', width: "20%"},
        ...
        $('#form-user-master').on('submit', function (event) {
            ...
            $('#form-user-master').ajaxSubmit({
                success: function (resp) {
                    ...
                    $("#stock_tranfer_pkey").val(pid);
                    //loadtable(pid, 1);
                  if($.parseJSON(resp).pk != 0 ){
                    $("#item_code").focus();
                    $('#item_desc').val('');
                    $("#item_code").val('');
                    $("#item_desc").select2( {allowClear: true});
                     filterItems();
                    $("#sumdata").val('');
                    $("#tranfer_stock").val('');
                    $("#required_qty").val('');
...
//find itemcode
        var item_desc = {
            url: function (phrase) {
                return "StockTranfer/getautocompletionsitem_desc?item_desc=" + phrase + "&store="+$('#from_store').val();
            },
            getValue: "item_desc",
            list: {
                onSelectItemEvent: function () {
                    var selectedItem = $('#item_desc').getSelectedItemData();
                    $('#item_pkey').val(selectedItem.item_master_pkey);
...
//find itemcode
        var item_code = {
            url: function (phrase) {
                return "StockTranfer/getautocompletionsitem_code?item_code=" + phrase;
            },
            getValue: "item_code",
            list: {
                onSelectItemEvent: function () {
...
// search from   store    
        var store_code = {
            url: function (phrase) {
                return "StockTranfer/getautocompletionsstore_code?store_code=" + phrase;
            },
...
//search main stocktranfer
        var billno = {
            url: function (phrase) {
                return "StockTranfer/getautocompletionsadjustment_code?adjustment_code=" + phrase;
            },
...
// item count find
    function  finditem() {
        ...
        // alert (item_pkey);
        $.ajax({
             url: 'StockTranfer/finditem/' + item_pkey + '/' + tostore_name+'/'+adjustment_date,
            success: function (response) {
                var data = response;
                if(response == null){
                $('#sumdata').val(data);
    ...
    function removedaata(index, id) {
        if (id) {
            ...
            if (r == true) {
                ...
                $.ajax({
                    url: 'StockTranfer/deletestoreitem/' + id,
                    success: function (resp) {
                        loadtable(pid, 1);
                        $.notify($.parseJSON(resp).msg, {
                            type: 'danger',
...
//edit data
    function editdaata(index, id) {
        ...
        var url = 'StockTranfer/editstoreitem/' + id;
