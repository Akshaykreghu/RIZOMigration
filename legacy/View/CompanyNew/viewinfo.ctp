        ...
        <div class="row">
            ...
            <div class="col-md-9" style="padding: inherit;">
                <b>   <?php echo isset($contactinfo['address']) ? $contactinfo['address'] : '' ?>
                    ...
                    <div>Zip Code<span style="padding-left: 4px;">-</span> <?php echo isset($contactinfo['pincode']) ? $contactinfo['pincode'] : '' ?></b></div></div></div><br>
    <p> <i class="fa fa-phone-square" style="color: #3c8dbc;" aria-hidden="true"></i>
        <b> <?php echo isset($contactinfo['phone']) ? $contactinfo['phone'] : '' ?></b></p>
    <p> <i class="fa fa-envelope" style="color: #3c8dbc;" aria-hidden="true"></i>
        <b> <?php echo isset($contactinfo['email']) ? $contactinfo['email'] : '' ?></b></p>
    <p><i class="fa fa-fax" style="color: #3c8dbc;" aria-hidden="true"></i>
        <b> <?php echo isset($contactinfo['fax']) ? $contactinfo['fax'] : '' ?></b></p>
</div>
</div>
    ...
    <form  id="contactInfoForm" action="<?php echo $this->webroot; ?>CompanyNew/savecompanysetup" method="post">
        <div class="row">
            <div class="form-group">
                <div class="col-md-12" style="text-align: center;">
                    <legend>  <h2><b> <?php echo isset($contactinfo['business_name']) ? $contactinfo['business_name'] : '' ?>
                                <button type="button" class="btn btn-primary" id="cinfoedit" style="float:right; " onclick="editable();"><i class="fa fa-pencil-square-o"  aria-hidden="true"></i></button></b></h2></legend>
                </div>
        ...
        <div class="row" style="font-size: 15px; min-height: 48px;">
            <div class="form-group">
                ...
                <div class="col-md-6" style=" background-color: white; " >
                    <label for="business_nature" required class=" control-label">Nature Of Business</label>
        ...
        <div class="row" style="font-size: 15px; min-height: 48px;" >         
            <div class="form-group">
                ...
                </div> <div class="col-md-6" style=" background-color: white;  ">
        ...
        <div class="row" style="font-size: 15px; min-height: 48px;">
            <div class="form-group">
                <div class="col-md-6" style=" background-color: white; ">
                    <label for="panno" class="control-label">TAN No</label>
        ...
        <div class="row" style="font-size: 15px; min-height: 48px;">
            <div class="form-group">
                <div class="col-md-6" style="background-color: white; " >
                    <label for="pfno" class=" control-label">PF No</label>
                ...
                <div class="col-md-6" style=" background-color: white;  ">
                    <label for="empstateinsno" class=" control-label">ESI No</label>
        ...
        <div class="row" style="font-size: 15px; min-height: 48px;">
            <div class="form-group">
                <div class="col-md-6" style=" background-color: white;  ">
                    <label for="ptnoco" class="control-label">Prof Tax No(Co.)</label>
                    <span style="padding-left: 25px;">:</span>

                    <b style="float: right;">  <?php echo isset($complianceInfo['ptnoco']) ? $complianceInfo['ptnoco'] : '' ?></b>
                </div>
                <div class="col-md-6" style=" background-color: white;  ">
                    <label for="ptnodir" class=" control-label">Prof Tax No(Dir.)</label>
        ...
        <div class="row" style="font-size: 15px; min-height: 48px;">
            <div class="form-group">
                <div class="col-md-6" style=" background-color: white;  ">
                    <label for="ptnoemp" class=" control-label">Prof Tax No(Emp.)</label>
                    <span style="padding-left: 12px;">:</span> 
...
<script type="text/javascript">
    function editable() {
        $("#infoid").load(livesite + "CompanyNew/infoedit")
    }
</script>