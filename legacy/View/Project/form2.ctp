...
<div class="form-group form-group-sm">
     ...
     <div class="col-sm-6">
        <label class="col-sm-4 control-label" for="item_desc">Number <label style="color:red">*</label></label>
        <div class="col-sm-7">
    ...
    <!-- Providing mandatory notation for start date and end date End -->
        ...
        <div class="col-sm-6">
          <button style="margin-right: 3px;margin-bottom: 14px; margin-right: 50px;" type="button" class="btn btn-success pull-right" onclick="addtolist();" >Save </button>
   ...
   $(document).ready(function(){
    ...
    function addtolist(s){
       ...
       if(expense_rate > sales_price){
           alert("Sales Rate is Lesser than Expense Rate ");
           return false;
       }
