...
<section class="content-header">
    <h2 style="text-align:left;"> Project Master   </h2>
</section>
<!-- Main content -->
...
<script>
         ...
         $("#project").select2(
                {
                    ...
                    allowClear: true,
                    ajax: {
                        url: livesite + "Project/filtersite" ,
                        dataType: 'json',
                        delay: 250,
  ...
  function filterAttendanceupload(obj) {
       //var branch = $('#importemployeectcform #filterby_branch').val();
        var project = $('#importemployeectcform #project').val();
    ...
    jQuery(document).ready(function () {
        ...
        $('#att_table').datagrid({
            ...
            toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showLargeModalForm(livesite + 'Project/form')
                    }
                },'-',
                {
                    iconCls: 'icon-edit',
                    ...
                    handler: function () {
                       ...
                       showLargeModalForm(livesite + 'Project/form/' + row.site_pkey)  
                        } else
                    ...
                    handler: function () {
                     ...
                     if (row) {
                      ...
                      if(r==true){
                               ...
                               $.ajax({
                                 url: livesite + 'Project/delete/' + site_pkey,
                                 success: function (resp) {
                                   
                                        //if (resp.msg) {
                                            $.notify("Project Details Deleted.", {
                                                type: 'success',
                                                allow_dismiss: true
...
//                    iconCls: 'icon-add',
//                    handler: function () {
//                        showModalForm(livesite + 'Project/activity_form')
//                    }
//                }
  , '-',
                        {
                            ...
                            handler: function () {
                                ...
                                {
                                    $.notify('Please choose a Project', {
                                        type: 'warning',
                                        allow_dismiss: false
                                    });
                                }
            ...
            columns: [[
                    ...
                    {field: 'site_id', title: 'Project ID', width: "10%"},
					{field: 'latitude', title: 'Work Order No.', width: "11%"},
					{field: 'po_expirydate', title: 'Work Order Date', width: "10%"},
					{field: 'longitude', title: 'Work Order Value', width: "12%"},
					{field: 'special_remarks', title: 'Consultant', width: "12%"},
                    {field: 'manager', title: 'Project Manager', width: "12%"},
                    {field: 'engineer', title: 'Site Engineer', width: "12%"},
                ]],
				onSearch:function(s){
                $('#att_table').datagrid('load',{
