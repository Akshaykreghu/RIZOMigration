...
<div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <!-- Form starts -->
  <div id=""class="">
      <form class="form-horizontal" id="form-user-expense" action="<?php echo $this->webroot; ?>Project/activity_save" method="POST" >
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                          ...
                          <option <?php if(isset($arr_data['0']['project_activity']['project_fkey']) && $value['site']['site_pkey'] == $arr_data['0']['project_activity']['project_fkey']){ echo 'selected="selected"'; } ?> value="<?php echo $value['site']['site_pkey']; ?>"><?php echo $value['site']['site_name'].'-'.$value['site']['site_id'] ;?></option>
                          <?php } ?>
                          </select>
                          </div> 
                          </div>
                    ...
                    <div class="modal-footer">
                        <input type="hidden" id="activity_pkey" name="activity_pkey" value="<?php echo isset($arr_data['0']['project_activity']['activity_pkey']) ? $result['0']['project_activity']['activity_pkey'] : '' ;?>" />
