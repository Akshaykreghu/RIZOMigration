<?php if ($mode == '') { ?>
    <div class="modal-body" style="overflow-y: auto;">
        <legend style="text-align: center; font-weight: bold;">Leave Hierarchy </legend>
                ...
                <div class="box ">
                    ...
                    foreach ($arr_hierarchy_for_template as $value) {
                        ...
                        if (count($value['summary']) > 0) {
                            ...
                            <div class="box-body" >
                                <fieldset>
         <legend style="font-weight: bold ; ">  <?php $supstatus = isset($value['summary']['0']['0']['superior_status']) && $value['summary']['0']['0']['superior_status'] == "2" ? '  (Resigned)' : ''; 
         echo isset($value['summary']['0']['0']['superior']) ? "Superior - ".$value['summary']['0']['0']['superior']." - ".$value['summary']['0']['0']['superior_comp_id']." ".$supstatus : '';?>  </legend>
                                ...
                                <fieldset>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $val['employee_info']['EmpName'].$empstatus; ?></td>
...
'title'=>' Leave Hierarchy'));
    ...
    <h4 align="center" style="font-weight:bold;">(<?php echo isset($user_id) ? "Report run by " . ($user_id) . " - " . $date_time : ''; ?>)</h4>
                    ...
                    foreach ($arr_hierarchy_for_template as $value) {
                        ...
                        if (count($value['summary']) > 0) {
                            ?>
         <h5 align="center" style="font-weight:bold;"><?php echo isset($value['summary']['0']['0']['superior']) ? "Superior - ".$value['summary']['0']['0']['superior']."  (".$value['summary']['0']['0']['superior_comp_id'].")" : '';?>  </h5>
