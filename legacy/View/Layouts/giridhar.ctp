...
<div class="wrapper" style="background:#262882;">
  <header class="main-header skin-blue sidebar-mini">
    <!-- Logo -->
    <a href="index2.html" class="logo" style="color:#ffffff;">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>M</b>PM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b><img style="width:166px" src="<?php echo $this->webroot; ?>/files/dd.png"></b></span>
    </a>
