...
<html>
  <head>
    <meta charset="UTF-8">
    <title>My Payroll Master sasdasd </title>
    ...
    <div class="wrapper" style="background:#0070C0;">
      ...
      <footer class="main-footer" style="position: absolute;
        ...
        <div class="container">
          ...
          <strong>Copyright &copy; 2014-2015 <a href="https://mypayrollmaster.com">My Payroll Master</a>.</strong> All rights reserved.
        </div>
      </footer>
...
<head>
    ...
    <!-- edited by athira on 13-03-2026 -->
    <title>Rizo</title>
    <!-- end -->
    <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>newlogin/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>newlogin/css/fontawesome-all.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>newlogin/css/iofrm-style.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $this->webroot; ?>newlogin/css/iofrm-theme2.css">
</head>
<body>
               	<?php echo $this->fetch('content'); ?>
