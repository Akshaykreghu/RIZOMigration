...
//  echo $this->Html->meta('icon', $this->webroot . 'newlogin/img/logo.png'); 
  echo $this->Html->meta('icon', $this->webroot . 'newlogin/img/rizo.png');
  //end
...
<body class="skin-blue sidebar-mini box sidebar-collapse">
  <div class="wrapper">
    ...
    <header class="main-header">
       <!-- Logo /* edited by bindu_18_11_25 */ -->
      <a href="<?php echo $this->webroot . "Dashboard" ?>" class="logo" style="background-color:#fff;color:#1E516E;">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <!-- <span class="logo-mini" style="font-weight: 600;">MPM</span> -->
         <span class="logo-mini" style="font-weight: 600;margin-left:-5px;"><img src='/newlogin/img/rizonew.png'></span>
        <!-- logo for regular state and mobile devices -->
         <span class="logo-lg" style="font-weight: 600;margin-left:-5px;width:30%;margin-left: auto;margin-right: auto;margin-top: 6px;"><img src='/newlogin/img/rizonew.png'></span>
        <!-- <span class="logo-lg"><b>MPM HR</b></span> -->
      </a>
      <!-- Header Navbar: style can be found in header.less --><!--edited by sinsiya to change the backgroundcolor in header 10-06-2024-->
      <nav class="navbar navbar-static-top" role="navigation" style="background-color:#ffffff;color:#1E516E;">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
                    ...
                    <li>
                      ...
                      <ul class="menu">
                        ...
                        ?>
                          <li>
                            <ul class="sidebar-menu" id="menu">
                              <li><a href="#" data-url="<?php echo $this->webroot . "SalaryIncrement/index"; ?>" data-toggle="tooltip" title="Increment History"><?php echo $slno++ . ". " . $empName . " (" . $empId . ") - " . $formattedDate; ?></i></a></li>
                            </ul>
            ...
            <li class="dropdown user user-menu">
              ...
              <!-- edited by bindu 23-11-25 -->
              <ul class="dropdown-menu">

                <!-- User Image for both groups -->
                <?php if ($user_group == 2): ?>

                  <!-- GROUP 2 -->
                  <li class="user-footer linkbtn" style="text-align: left !important;">

                    <!-- <input type="hidden" id="emp_fkey" name="emp_fkey"
                   value="<?php echo $this->Session->read('emp_fkey'); ?>"> -->

                    <!-- Profile Button -->
                    <!-- Profile Button -->
                    <a href="#" id="profileBtn" class="btn btn-default btn-flat profile-btn"
                      style="width: 80%; margin-bottom: 8px;">
                      <i class="fa fa-user"></i> Profile
                    </a>

                    <input type="hidden" id="emp_fkey" value="<?php echo $this->Session->read('emp_fkey'); ?>">


                    <!-- Signout Button -->
                    <a href="<?php echo $this->webroot; ?>Site/logout"
                      class="btn btn-default btn-flat profile-btn"
                      style="width: 80%;">
            ...
            <img src="<?php echo $this->webroot . $user['avatar']; ?>" class="img-circle" alt="User Image" />
            <p><?php echo $this->Session->read('user_name'); ?></p>
        </li> -->

                  <!-- Profile + Signout (Stacked, with icons) -->
                  <li class="user-footer linkbtn">
                    <!-- <div class="pull-left"> -->
                    <ul id="menu">
                      <li class="profile-logo">
                        <a href="#" data-url="<?php echo $this->webroot . "User/profile"; ?>"
                          class="btn btn-default btn-flat profile-btn"
                          style="width: 80%; margin-bottom: 8px;padding:6px 20px;">
...
if ($user_group == 2 && !in_array($company_code, $not_allowed_companies)) {
    ?>
 <li class=" activee" style="background-color: #ffffff;">
              <a href="#" data-url="<?php echo $this->webroot . "Dashboard" ?>" onclick="navigateToUrl(this)"> <i style="color:#000" class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
            </li>
        <!-- Standard Menus -->
        <li class="activee" style="background-color: #ffffff;">
            <a href="#" 
               data-url="<?php echo $this->webroot . "EmployeeMenu" ?>" 
               onclick="loadInContainer(this)">
                <i style="color:#1E516E" class="fa fa-user"></i> 
        ...
        <li class="activee" style="background-color: #ffffff;">
            <a href="#" 
               data-url="<?php echo $this->webroot . "EmployeeMenu/addon" ?>" 
               onclick="loadInContainer(this)">
                <i style="color:#1E516E" class="fa fa-plus-circle"></i> 
                <span>Add-Ons</span>
            </a>
        </li>
...
<script>
  ...
  $(document).on('click', '#profileBtn', function(e) {
    e.preventDefault();
 var usergroup = "<?php echo $this->Session->read('user_group'); ?>"
  var company_code = "<?php echo $this->Session->read('company_code'); ?>"
  ...
  if (![
    'HRBL','KWMT','AIMA','ESNP','MBCT','MRBS','STCL','VGNN','STFR',
    'ABSG','VGFS','VSFS','DRRC','DJIC','AGNG','AYRK','SRTS','VNDG'
].includes(company_code)) {
if (usergroup == 2){
 var emp_pkey = $('#emp_fkey').val();
    

    if (!emp_pkey) {
      alert('Employee key not found!');
      return;
    }

    // Call your modal function
    showLargeModalForm(livesite + 'Employee/setups/' + emp_pkey);

    // Wait a tiny bit for the overlay to appear, then remove absolute positioning
    setTimeout(function() {
      $('.isloading-overlay').css('position', ''); // remove absolute
    }, 100);
 }
  }
