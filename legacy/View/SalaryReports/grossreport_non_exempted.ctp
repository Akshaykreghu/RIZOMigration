                        ...
                        <?php foreach ($gross as $branch => $brnch) {
                            ...
                            <td><?php //echo $val['prodata']['present'];
                                ?></td>-->
                                                            ...
                                                            <!-- Edited by Akshay on 27-2-2026 -->
                                                            <td><?php echo isset($val['ar']['lop_only']) ? $val['ar']['lop_only'] : ''; ?></td>
                                                            <?php $lop_only = isset($val['ar']['lop_only']) ? $val['ar']['lop_only'] : 0; ?>
                                                            <?php $total_val[3] = isset($total_val[3]) ? ($total_val[3] + $lop_only) : $overtime; ?>
                                                            <!-- End -->
