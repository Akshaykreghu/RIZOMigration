                                    ...
                                    <table class="table table-bordered" id="table1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="16" style="text-align: center;">Employee Details</th>
                                                <!-- end -->
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($brnch as $val) {
                                                // Edited by Akshay on 24-9-2025
                                                $present_total = ($company_code === 'KWMT' || $company_code === 'GTRA') ? (isset($val['payroll_master']['days_presant']) ? $val['payroll_master']['days_presant'] : '') : (isset($val['ar']['presant_total']) ? $val['ar']['presant_total'] : '');
                                                $leave = ($company_code === 'KWMT' || $company_code === 'GTRA') ? (isset($val['payroll_master']['days_leave']) ? $val['payroll_master']['days_leave'] : '') : (isset($val['ar']['leave_total']) ? $val['ar']['leave_total'] : '');
                                                $lop = ($company_code === 'KWMT' || $company_code === 'GTRA') ? (isset($val['payroll_master']['loss_of_pay']) ? $val['payroll_master']['loss_of_pay'] : '') : (isset($val['ar']['lop_total']) ? $val['ar']['lop_total'] : '');
                                                $weekoff = ($company_code === 'KWMT' || $company_code === 'GTRA') ? (isset($val['payroll_master']['week_off_days']) ? $val['payroll_master']['week_off_days'] : '') : (isset($val['ar']['weekoff_total']) ? $val['ar']['weekoff_total'] : '');
                                                $holiday = ($company_code === 'KWMT' || $company_code === 'GTRA') ? (isset($val['payroll_master']['holidays']) ? $val['payroll_master']['holidays'] : '') : (isset($val['ar']['holiday_total']) ? $val['ar']['holiday_total'] : '');
                                                $adjust_lop = isset($val['payroll_master']['adjust_lop']) ? $val['payroll_master']['adjust_lop'] : 0; // Edited by Akshay on 25-9-2025
                                                // End
                                                ...
                                                if (isset($val['emp_info'])) {     //To check if 'emp_info' is set
                                                    if ($val['emp_info']['branch'] == $val['emp_info']['branch']) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php $present_days = $present_total; ?>
                                                            ...
                                                            <td><?php echo $lop; ?></td>
                                                            <?php $lop_total = $lop; ?>
                                                            <?php $total_val[2] = isset($total_val[2]) ? ($total_val[2] + $lop_total) : $lop_total; ?>
                                                            <!-- Edited by Akshay on 26-9-2025 -->
                                                            <td><?php echo $adjust_lop; ?></td>
                                                            <?php $total_val[3] = isset($total_val[3]) ? ($total_val[3] + $adjust_lop) : $adjust_lop; ?>
                                                            <!-- End -->
                                                            <td><?php echo $leave; ?></td>
                                                            <?php $leave = $leave; ?>
                                                            <?php $total_val[4] = isset($total_val[4]) ? ($total_val[4] + $leave) : $leave; ?>
                                                            <td><?php echo $weekoff; ?></td>
                                                            <?php $weekoff_total = $weekoff; ?>
                                                            <?php $total_val[5] = isset($total_val[5]) ?  ($total_val[5] + $weekoff_total) : $weekoff_total; ?>
                                                            <td><?php echo $holiday; ?></td>
                                                            <?php $holiday = $holiday ?>
                                                            <?php $total_val[6] = isset($total_val[6]) ?  ($total_val[6] + $holiday) : $holiday; ?>
