...
<?php if($criteria != 'Banks'){?>
    <h2 style="font-weight: bold;text-align: center;"> <?php echo "Salary Bank Transfer - " .$date?> </h2>
   <?php }else{?>
    <h2 style="font-weight: bold;text-align: center;"> <?php echo "Bank Statement - " .$date?> </h2>
    <?php }?>
...
foreach ($arr_salary_for_template as $value) {
 ...
 if (true) {
              ...
              <?php if($cr=='EmployeeDetails'){ echo $value['leavepolicyname']['0']['info']['EmpName']; echo (isset($value['leavepolicyname']['0']['EmployeeDetails']['status'])) && $value['leavepolicyname']['0']['EmployeeDetails']['status'] =="2" ? '  (Resigned)':'';} elseif ($cr == 'Units'){ echo $value['leavepolicyname']['0']['info']['branch']; }else { 
			$bk = isset($value['leavepolicyname']['0']['0']['BANK_NAME'])?$value['leavepolicyname']['0']['0']['BANK_NAME']:''; 
            ...
            <table class="table table-bordered"  id="report_table1" style="overflow-x: auto;">
                <thead>
                    <tr>
                       <th>Sl No</th>
                        <th>Employee ID</th>
                         <!-- edited by athira on 09-07-2025 -->
...
<!--                      // edited by megha on 25_06_19 zero valued net salary removed-->
                    ...
                    <tr>
                        ...
                        <td><?php echo $val['info']['employee_id'];?></td>
                         <!-- edited by athira on 09-07-2025 -->
                         <?php if($company_code =='DEMO' || $company_code =='GLET' || $company_code=='SRTS'){ ?>
                            <td><?php echo $val['EmployeeDetails']['emp_us_company_id'];?></td>
                        <?php } ?>
                        <!-- end -->
                        ...
                        <!-- edited by athira on 09-07-2025 -->
                         <?php if($company_code =='DEMO' || $company_code =='GLET' || $company_code=='SRTS'){ ?>
                       <td><?php echo $val['EmployeeDetails']['emp_us_name'];?></td>
                       <?php } ?>
                        <td><?php 
...
//                       }
        ...
        <div class="col-md-12">
			...
			// $i = 0;
            if (true) { //Edited by Akshay on 4-6-2024
			echo ($bk != '')?$bk:'N/A';  ?></h3> -->
            <!-- <h3>Month : <?php echo $month;?></h3> -->
            <legend style="border: 0;">Bank Statement of 
                <?php $bk = isset($value['leavepolicyname']['0']['0']['BANK_NAME'])?$value['leavepolicyname']['0']['0']['BANK_NAME']:''; 
			
			echo ($bk != '')?$bk:'N/A';  ?><?php echo " - ".$mname."  "  .$year?></legend>
            <div style="overflow-x: auto;">
    ...
    <?php } else {?>
        ...
        <?php if($criteria != 'Banks') {
            ...
            <table class="table ">
                <tbody>
                    <tr style="background-color:#f0f0ff;">
                        ...
                        <th style="width:14%;">Branch Name</th>
			...
			if($acc_number == ''){
                    ...
                    <?php if($val['payroll_master']['net_salary'] > 0){   if (true) { ?>
                    <tr>
                        <td style="width:1%;" ><?php echo $i;?></td>
                        <td  style="width:15%;"><?php echo $val['info']['employee_id'];?></td>
                        <td  style="width:10%;"><?php echo $val['info']['EmpName'];echo (isset($val['EmployeeDetails']['status'])) && $val['EmployeeDetails']['status'] =="2" ? '  (Resigned)':'';?></td>
                        <td  style="width:12%;"><?php echo $val['info']['designation'];?></td>
                        <td  style="width:11%;"><?php echo $val['info']['department'];?></td>
                        <td  style="width:11%;"><?php echo $val['info']['branch'];?></td>
              
                       
                        <td style="width:13%; word-wrap: break-word;"><?php echo $bank_name;?></td>
                      
                        <td style="width:14%; word-wrap: break-word;"><?php echo $branch_name;?></td>
                        <td  style="width:11%;"><?php echo $ifsc_code;?></td>
                        <td  style="width:16%;"><?php echo $acc_number;?></td>
                        <?php  $dd_amt=round($val['payroll_master']['net_salary'] + $settle); ?>
                        <?php $netamt=$dd_amt; ?>
                        <td  style="width:7%;"><?php echo $netamt; ?></td>
                    </tr>
                    <?php  $i++;} else{?>
					<tr><td colspan="11" style="text-align:center;">
                    No data available under the selected criteria
