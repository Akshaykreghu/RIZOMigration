...
//                             debug($valuees);
    ...
    <?php if ($cr=='Units') { ?>
                <h5 style="font-size:16px;"><b> <?php echo isset($value['summary'][0]['a']['branch_name']) ? $value['summary'][0]['a']['branch_name'] :''  ?></b></h5>
       <?php } ?>
       <!-- end -->
    <div class="row">
                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr> <?php
                                ...
                                <!-- edited by athira on 07-07-2025 -->
                                <?php if($company_code =='DEMO' || $company_code =='GLET' || $company_code=='SRTS'){ ?>
                                     <td><?php echo $val['a']['emp_us_company_id']; ?></td>
                                <?php } ?>
                                <!-- end -->
                                <!-- edited by athira on 18-02-2025 -->
                                <td><?php echo $val['a']['user_id']; ?></td>
                                <td><?php echo $val['a']['first_name'] . ' ' . $val['a']['last_name']; echo (isset($val['a']['status'])) && $val['a']['status'] =="2" ? '  (Resigned)':'';?></td>
                                 <!-- edited by athira on 07-07-2025 -->
                                <?php if($company_code =='DEMO' || $company_code =='GLET' || $company_code=='SRTS'){ ?>
                                     <td><?php echo $val['a']['emp_us_name']; ?></td>
                                <?php } ?>
                                <!-- end -->
                                <!-- edited by athira on 28-02-2025 -->
                                <td><?php echo date('d-m-Y', strtotime($val['a']['joining_date'])); ?></td>
                                <!-- end -->
                                <td><?php echo $val['a']['branch_name']; ?></td>
                                <td><?php echo $val['a']['dept_name']; ?></td>
                                <td><?php echo $val['a']['desig_name']; ?></td>
                                <!-- edited by athira on 01-03-2025 -->
                                <td><?php if(!empty($val['a']['last_approved_working_date'])){
                                    echo date('d-m-Y', strtotime($val['a']['last_approved_working_date']));
                                    }
                                    else{
                                        echo '';
                                    }
...
<!--                                <td><?php echo round($annual); ?></td>-->
                            ...
                            <!-- edited by athira on 08-07-2025 -->
                             <?php if($company_code =='DEMO' || $company_code =='GLET' || $company_code=='SRTS'){ ?>
                                <tr><th colspan="11" style='text-align:center;'>TOTAL</th>
                                <?php } else { ?>
                                     <tr><th colspan="9" style='text-align:center;'>TOTAL</th>
                                    <?php } ?>
