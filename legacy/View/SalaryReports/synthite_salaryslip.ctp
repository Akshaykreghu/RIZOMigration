                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr style="background: #cccccc ;">
                                                ...
                                                <th style="" colspan="3"><?php echo round($sum) + round($dd) + round($value['settle']); ?></th>
                                            </tr>
    ...
    if ($cr == 'EmployeeDetails') {
        ...
        ?>
            ...
            <?php echo date("l,F j, Y"); ?> </div>-->
                        <div style="text-align:left; width:100%; ">
                            ...
                            <div style="width: 80%; margin-left: 100px; margin-top: 10px; position : absolute ; float: left; font-size: 14px; ">
                                ...
                                <hr>
                                <h3 style="text-align: center;padding-bottom: 0px;padding-top: 0px; margin-top: 0px;"><?php echo 'Salary Slip - ' . "$mname-" . $year; ?></h3>
                            </div>
            ...
            <th>Holidays</th>-->
                        ...
                        <tr>
                            <th style="padding-top:10px;border-right-style: hidden; border-right: 0px solid white; border-bottom: 0px solid white ;  " colspan="2"><span style="text-align:  left ; ">Employee ID &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo isset($value['empdet']['0']['ep']['emp_company_id']) ? $value['empdet']['0']['ep']['emp_company_id'] : ''; ?></span></th>
