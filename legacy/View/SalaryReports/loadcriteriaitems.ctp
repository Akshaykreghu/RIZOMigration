        ...
        <?php } else { ?>
            ...
            <script>
                ...
                function setwidth() {
                    ...
                    if ($('#checkrsgnd').length == 0) {
                        ...
                        if (criteria !== 'Banks' && type !== "BankTranferSynthite") {
                            //edited by athira on 30-04-2025
                ...
                $(document).ready(function() {
                        ...
                        columns: [
                            [{
                                    ...
                                    formatter: function(value, row, index) {
                                        //edited by athira on 24-04-2025
                                        if (type === "Comparison" && criteria == 'Units') {
                                            // Render radio button if type is Comparison
                                            return '<input type="radio" class="checkw" name="' + criteria + '[]" value="' + row.key + '" />';
                                        } else {
                                            // Default checkbox for other types
                    ...
                    $(document).on('change', '.checkw', function() {
                        var type = $('#hidden-report-type').val();
                        var criteria = $('#hidden-criteria<?php echo $index; ?>').val();

                        // Only apply limit when Comparison + EmployeeDetails
                        if (type === "Comparison" && criteria === "EmployeeDetails") {
                            var checkedCount = $('#div-items-criteria<?php echo $index; ?> .datagrid-view input.checkw:checked').length;
                            const message = '*Maximum 10 employees can be selected';

                            if (checkedCount >= 10) {
                                if (!$('#search-message-container-<?php echo $index; ?>').length) {
                                    $('#div-items-criteria<?php echo $index; ?> .datagrid-toolbar').after(`
                                <div id="search-message-container-<?php echo $index; ?>" style="color: red; margin: 3px 0; text-align: center;">
                                    ${message}
                                </div>
                            `);
                                }
                                let checkboxes = $('#div-items-criteria<?php echo $index; ?> input:checkbox');
                                checkboxes.not(':checked').prop('disabled', true);
                            } else {
                                // Remove the message if it exists
                                $('#search-message-container-<?php echo $index; ?>').remove();
