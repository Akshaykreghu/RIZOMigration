...
$total = 0;
                    foreach($value['leavepolicyname'] as $val){  
                                ...
                                list($bank_name, $branch_name, $ifsc_code,$acc_number) = explode(',', $bank);
                                 ...
                                 if($ifsc_code == ''){
                                  $ifsc_code = isset($val['EmployeeDetails']['ifsc_code'])?$val['EmployeeDetails']['ifsc_code']:'';
                                  }
                                if($acc_number == ''){
                                  $acc_number = isset($val['EmployeeDetails']['account_no'])?$val['EmployeeDetails']['account_no']:'';
                                  } 
                    $settle = 0;
                    ...
                    ?>
                       <tbody>
                        ...
                        <td><?php echo $val['info']['EmpName'];echo (isset($val['EmployeeDetails']['status'])) && $val['EmployeeDetails']['status'] =="2" ? '  (Resigned)':'';?></td>
                          ...
                          <td><?php echo $account_number;?></td>
                          <td><?php $sms="YES"; echo $sms;?></td>
                         <td style="width:12%"><?php echo $val['EmployeeDetails']['mobile_no'];?></td>
                    </tr>
                    <?php  $i++;
                    $total = $total +$netamt;
                } else{?>
