        ...
        <div class="col-md-12">
            ...
            { ?>
                <div style="font-size: 25px;text-align:center; background-color:#F7D3D2;">
                    There is no data available with respect to your Criteria</div>
                <?php 
            } else {
                if ($criteria=="Units") //***********BRANCH WISE***********************THIS BRANCH WISE SECTION BY ARUL P DAS 26/10/2019*************
                {
                    ?>
                    <h3 align="center"><b>Payroll Report with LOP : <?php echo $month;?></b></h3>
                            ...
                            <tbody>
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><?php echo $val['present'];?></td> 
                                        <td><?php echo $val['leave'];?></td> 
                                        <td><?php echo $val['lopdays'];?></td> 
                                        <td><?php echo $val['lop_only']; ?></td>
                                        <td><?php echo round($val['lop']); ?></td>
                                        ...
                                        for($m=0;$m<$count_addition;$m++)
                                        {
                                            ...
                                            ?>
                                            <td><?php echo abs(round($number,2));?></td>
                                            <?php
                                        } 
...
<?php 
    ...
    <?php
    echo $this->element('reportadminheader',array('title'=>'Payroll Report with LOP'));
    ?>
    <?php if (count($gross) <= 0) 
    {
        ?>
