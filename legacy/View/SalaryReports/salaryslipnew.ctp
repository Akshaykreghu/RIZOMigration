...
function formatIndianNumber($number, $decimals = 2)
{
    ...
    $formattedNumber = number_format($number, $decimals, '.', ''); // Format with standard number_format

    // Split the formatted number into integer and decimal parts
    list($integerPart, $decimalPart) = explode('.', $formattedNumber);

    // Insert commas after every two digits in the integer part (without reversing the order)
    $integerPart = implode(',', str_split($integerPart, 2));

    // Join the integer and decimal parts with the Indian decimal separator
                    ...
                    if ($cr == 'EmployeeDetails') {
                        ...
                        foreach ($arr_salary_for_template as $value) { ?>
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                <tr> <?php
                                                    ...
                                                    <td class="value"><?php echo isset($arr_data[$i]['ectc']['salary_amount']) ? formatIndianNumber(abs(round($arr_data[$i]['ectc']['salary_amount'])), 2) : ''; ?></td>
                                                    ...
                                                    <td class="value"><?php echo isset($arr_withoutComponents[$i]['ectc']['salary_amount']) ? formatIndianNumber(abs(round($arr_withoutComponents[$i]['ectc']['salary_amount'])), 2) : ''; ?></td>
                                            ...
                                            <tr>
                                                <th>Total</th>
                                                <th class="value"><?php echo formatIndianNumber((abs(round($sum))), 2); ?></th>
                                                <th>Total </th>
                                                <th class="value"><?php echo formatIndianNumber((abs(round($dd))), 2); ?></th>
                                            </tr>
                            ...
                            <th style="text-align :center ; " colspan="3">Settlement Amount</th><th><?php echo $value['settle']; ?></th>
                                            ...
                                            $netpay1 = (float)round($sum) + (float)round($dd);
                                            $netpay = $netpay1;
                                            if ($netpay < 0) {
                                                $direction = 'Negative';
                                                $netpay = abs($netpay);
                                ...
                                <div style="text-align: left; font-size: 15px;"><b>Net Pay&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo formatIndianNumber($netpay1, 2); ?> </b></div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                            <tr>
                                                                ...
                                                                <td style=" text-align: right;"><?php echo formatIndianNumber($values, 2); ?></td>
                                                                <td style=" text-align: right;"><?php echo $excempt; ?></td>
                                                                <td style=" text-align: right;"><?php echo formatIndianNumber($taxable, 2); ?></td>
                                                            </tr>
                                            <?php
                                                        }
                                                    }
                                ...
                                <div class="col-md-6" style="padding-left:2px;padding-right:0px;margin-top:-12px;">
                                    <table class="table table-bordered" style="margin:0;">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                if (count($value['summary']) !== 0 || count($arr_data) !== 0) {
                                                    if (count($arr_data) >= 0) {
                                                        foreach ($arr_data as $val) {
                                                            // debug($value);
                                                            // debug($value['taxcomponents']['0']['EmployeeTaxsalsumNew']);
                                                            // debug(isset($value['taxcomponents']['0']['EmployeeTaxsalsumNew']['other_income'])?$value['taxcomponents']['0']['EmployeeTaxsalsumNew']['other_income']:0);
                                                            //$stdecn = 50000;
                                                            ...
                                                            //$std =  isset($val['tax_computation_report']['Standard_deduction']) ? formatIndianNumber($val['tax_computation_report']['Standard_deduction'],2) : formatIndianNumber($stdecn,2);
                                                            //$Income_from_Other_Source = isset($val['tax_computation_report']['Taxable_Income_from_Other_Sources']) ? formatIndianNumber($val['tax_computation_report']['Taxable_Income_from_Other_Sources'], 2) : 0.00;
                                                            //Edited by Akshay on 2-9-2024
                                                            $Income_from_Other_Source = (isset($value['taxcomponents']['0']['EmployeeTaxsalsumNew']['other_income']) ? $value['taxcomponents']['0']['EmployeeTaxsalsumNew']['other_income'] : (isset($value['taxcomponents']['0']['EmployeeTaxsalsum']['other_income'])?($value['taxcomponents']['0']['EmployeeTaxsalsum']['other_income']):0 ));
                                                            //End
                                                            $Taxable_Income =  isset($val['tax_computation_report']['Taxable_Income_from_Salary']) ? formatIndianNumber($val['tax_computation_report']['Taxable_Income_from_Salary'], 2) : 0.00;
                                                            $Total_Tax =  isset($val['tax_computation_report']['Total_Tax']) ? formatIndianNumber($val['tax_computation_report']['Total_Tax'], 2) : 0.00;
                                                            $Surcharge =  isset($val['tax_computation_report']['Surcharge']) ? formatIndianNumber($val['tax_computation_report']['Surcharge'], 2) : 0.00;
                                                            $Tax_Deducted_Till_date = isset($val['tax_computation_report']['Tax_Deducted']) ? formatIndianNumber($val['tax_computation_report']['Tax_Deducted'], 2) : 0.00;
                                                            $Tax_to_be_Deducted = isset($val['tax_computation_report']['Balance_Tax']) ? formatIndianNumber($val['tax_computation_report']['Balance_Tax'], 2) : 0.00;
                                                            $Monthly_tax =  isset($val['tax_computation_report']['Monthly_Tax']) ? formatIndianNumber($val['tax_computation_report']['Monthly_Tax'], 2) : 0.00;
                                                        }
                                                    }
                                                }
                                                ...
                                                ?>
                                                <td style="width:15%;text-align:right;"><?php echo formatIndianNumber($totalValuesSum, 2); ?></td>
                                            </tr>
                                            <?php
                                            //                                            $pt = 0.00;									  
                                            ...
                                            //                                                                $pt = formatIndianNumber(abs($ptAmount), 2);
                                            //                                                                break ;
                                            //                                                            }
                                            //                                                        }
                                            //                                                    }
                                            ...
                                            if ($value['regime'] == 'N') {
                                                ...
                                                $standerd_deduction = ($monthYear >= '2024-08') ? 75000 : 50000; //Edited by Akshay on 4-9-2024;
                                                ...
                                                $Surchargecess = formatIndianNumber($Surcharge + $cess, 2);
                                                $Monthly_tax = isset($value['taxcomponents']['0']['EmployeeTaxsalsumNew']['tax_monthly_proj']) ? formatIndianNumber($value['taxcomponents']['0']['EmployeeTaxsalsumNew']['tax_monthly_proj'], 2) : 0;
                                                ...
                                                $Surchargecess = formatIndianNumber($Surcharge + $cess, 2);
                                                $Monthly_tax = isset($value['taxcomponents']['0']['EmployeeTaxsalsum']['tax_monthly_proj']) ? formatIndianNumber($value['taxcomponents']['0']['EmployeeTaxsalsum']['tax_monthly_proj'], 2) : 0;
                                                ...
                                                $totalSum = formatIndianNumber($totalSum, 2);
                                                // $pt = isset($value['pt']) ? $value['pt'] : 0;
                                                //Edited by Akshay on 1-8-2024
                                                $pt = 2500;
                                                //End
                                                $pt = formatIndianNumber($pt, 2);
                                            }
                                            $taxableincome = formatIndianNumber($taxableincome, 2);
                                            $totalded = formatIndianNumber($totalded, 2);
                                            $taxtilldate = 0;
                                            for ($i = 0; $i < 12; $i++) {
                                            ...
                                            <tr>
                                                ...
                                                foreach ($arr_taxheadfields['Income']['tax_heads'] as $heads) {
                                                    if ($heads['tax_name'] == $TaxHead) {
                                                        ...
                                                        foreach ($value['tax'] as $key => $val) {
                                                            if ($heads['tax_heads_pkey'] == $key) {
                                                                $houseProperty = formatIndianNumber($val['tax_value'], 2);
                                                                break;
                                                            }
                                                        }
                                                        break;
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right;"><?php echo ($Income_from_Other_Source != 0) ? number_format($Income_from_Other_Source, 2) : "0"; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right;"><?php echo ($taxableincome < 0) ? 0 : $taxableincome; ?></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;Total Tax</td>
                                                <td style="text-align: right;"><?php echo isset($Total_Tax) ? formatIndianNumber($Total_Tax, 2) : 0; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right;"><?php echo isset($taxtilldate) ? formatIndianNumber($taxtilldate, 2) : 0; ?></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;Tax to be Deducted</td>
                                                <td style="text-align: right;"><?php echo isset($Tax_to_be_Deducted) ? formatIndianNumber($Tax_to_be_Deducted, 2) : 0; ?></td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            if ($val['tax_value'] > 0) {
                                                                if ($heads['tax_heads_pkey'] == $key) { ?>
                                                                    ...
                                                                    <td style="width:67px; text-align: right;">
                                                                        <?php $result = formatIndianNumber($val['tax_value'], 2);
                                                                        echo $result; ?>
                                                                    </td>
                                                        <?php $j++;
                                                                }
                                ...
                                <div class="col-md-6" style="margin-top:-10px;padding-left: 2px;padding-right: 0px;">
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <!-- Edited by Akshay on 23-6-2024 -->
                                            <?php
                                            $start_month = $value['summary'][0]['fin_year']['start_month'];
                                            $end_month = $value['summary'][0]['fin_year']['end_month'];
                                            ...
                                            <tr>
                                                ...
                                                foreach ($period as $date) {
                                                    if ($column < 6) { ?>
                                                        <th style="text-align:center;"><?php echo strtoupper($date->format('M')) . ' '; ?></th>
                                                <?php   }
                                                    $column++;
                                                }
                                                ?>
                                            ...
                                            <tr>
                                                <?php for ($i = 0; $i < 6; $i++) { ?>
                                                    <td style="height:36px;text-align:center;"><?php echo ($value['taxdates'][$i]['tax']) ? formatIndianNumber($value['taxdates'][$i]['tax']) : 0; ?></td>
                                                <?php } ?>
                                            </tr>
                                            <?php
                                            $column = 0;
                                                ...
                                                <?php for ($i = 6; $i < 12; $i++) { ?>
                                                    <td style="width:20px;text-align:center;">
                                                        ...
                                                        echo (isset($value['taxdates'][$i]['tax']) && $value['taxdates'][$i]['tax'] != 0) ?
                                                            formatIndianNumber($value['taxdates'][$i]['tax']) : 0;
                                                        ?>
                                                    </td>
                                                <?php } ?>
                                            </tr>
    ...
    ?>
        ...
        <div style="width: 100%; text-align: left">
            Downloaded By <?php echo $user_name; ?> <?php echo date("l,F j, Y"); ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                ?>
                                    <tr <?php if ($i === $countss - 1); ?>>
                                        ...
                                        <td style="text-align:right;border: .5px solid black;"><?php echo isset($arr_data[$i]['ectc']['salary_amount']) ? formatIndianNumber(abs(round($arr_data[$i]['ectc']['salary_amount'])), 2) . '&nbsp;&nbsp;' : ''; ?></td>
                                        ...
                                        <td style="text-align:right;border: .5px solid black;"><?php echo isset($arr_withoutComponents[$i]['ectc']['salary_amount']) ? formatIndianNumber(abs(round($arr_withoutComponents[$i]['ectc']['salary_amount'])), 2) . '&nbsp;&nbsp;' : ''; ?></td>

                                    </tr>
                                    <?php }

                                // Add remaining blank rows if the number of rows is less than 20
                                $remainingRows = 125 - $countss; //Edited by Akshay on 26-6-2024
                                if ($remainingRows > 0) {
                                ...
                                <tr style="border-collapse: seperate;border-color: black!important;">
                                    ...
                                    <td style="border: .5px solid black;text-align:right;border-bottom: .5px solid black;"><b><?php echo formatIndianNumber((round($sum)), 2) . '&nbsp;&nbsp;'; ?></b></td>
                                    <td style="border: .5px solid black;border-bottom: .5px solid black;" class="shrinknew"></td>
                                    <td style="border: .5px solid black;border-bottom: .5px solid black;"><b>&nbsp;&nbsp;Total </b></td>
                                    <td style="text-align:right;border: .5px solid black;border-bottom: .5px solid black;"><b><?php echo formatIndianNumber((abs(round($dd))), 2) . '&nbsp;&nbsp;'; ?></b></td>
                                </tr>
                                <tr>
                            ...
                            <tr>
                                <th style="display: flex; justify-content: space-between; align-items: center; width: 32%; font-size: 12px; border: .5px solid white;padding-top:10px;">
                                    ...
                                    <span style="margin-left: auto;"><b><?php echo formatIndianNumber($netpay1, 2); ?></b></span>
                                </th>
                                        ...
                                        <td style="border:none">
                                            <table style="width:400px;margin-bottom: 0px; padding:0;margin-top:3px;">
                                                <tbody>
                                                    ...
                                                    ?>
                                                                    <tr>
                                                                        <td style="width: 145px; padding: 0px;padding-left:5px;"><?php echo trim($component); ?></td>
                                                                        <td style="width: 70px; text-align: right;"><?php echo formatIndianNumber($values, 2); ?></td>
                                                                        <td style="width: 70px; text-align: right;"><?php echo $excempt; ?></td>
                                                                        <td style="width: 70px; text-align: right;"><?php echo formatIndianNumber($taxable, 2); ?></td>
                                                                    </tr>
                                                    <?php
                                                                }
                                                            }
                                                    ...
                                                    if ($count < 9) {
                                                        for ($k = 0; $k <= (8 - $count); $k++) { ?>
                                                            <tr>
                                                                <td style="width: 145px; font-size: 12px; height: 9px;padding-left:5px;"><?php echo "  "; ?></td>
                                            ...
                                            <table class="" style="width:100%;margin-top: 3px;">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td colspan="2" style="font-size: 12px;width: 379px;text-align: center;"><b>&nbsp;Deduction Under Chapter VI-A</b></td>
                                                    </tr>
                                                        ...
                                                        foreach ($arr_taxheadfields['Deductions']['tax_heads'] as $heads) {  ?>
                                                            <tr>
                                                                <?php foreach ($value['tax'] as $key => $val) {
                                                                    if ($val['tax_value'] > 0) {
                                                                        if ($heads['tax_heads_pkey'] == $key) { ?>
                                                                            <td style="width:302px; padding-left:5px;"> <?php echo $heads['tax_name']; ?></td>
                                                    ...
                                                    <?php for ($i = $j; $i < 8; $i++) {  ?>
                                                        <tr>
                                                            <td style="width:302px;height:9px; padding-left:5px;"></td>
                                                            <td style="width:67px;height:9px;"></td>
                                                        </tr>
                                                    <?php } ?>
                                            ...
                                            <table class="table table-bordered" style="width:665px;margin-top: 3px; margin-left: 0px;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        foreach ($period as $date) {
                                                            if ($column < 6) { ?>
                                                                <th style="text-align:center;width: 40px;"><?php echo strtoupper($date->format('M')) . ' '; ?></th>
                                                        <?php   }
                                                            $column++;
                                                        }
                                                        ?>
                    ...
                    <p style="text-align:center;font-size: 11px; margin-bottom: 0px;">*This is an electronically generated document and does not require a signature.</p>
                </page>
        ...
        foreach ($arr_salary_for_template as $value) {
            ...
            ?>
                <page backtop="30mm" backbottom="0mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
                                    ...
                                    <tr>
                                        <td style="border:none">
                                            <table style="width:400px;margin-bottom: 0px; padding:0;margin-top:3px;">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 145px; text-align: center; font-size: 12px;" colspan="1"><b>Description</b></td>
                                                        <td style="width: 70px; text-align: center; font-size: 12px;"><b>Gross</b></td>
                                                        <td style="width: 70px; text-align: center; font-size: 12px;"><b>Exempt</b></td>
                                                        <td style="width: 70px; text-align: center; font-size: 12px;"><b>Taxable</b></td>
                                                    </tr>
                                                    ...
                                                    ?>
                                                                    <tr>
                                                                        <td style="width: 145px; padding-left:5px;"><?php echo $component; ?></td>
                                                                        <td style="width: 70px; text-align: right;"><?php echo formatIndianNumber($values, 2); ?></td>
                                                                        <td style="width: 70px; text-align: right;"><?php echo $excempt; ?></td>
                                                                        <td style="width: 70px; text-align: right;"><?php echo formatIndianNumber($taxable, 2); ?></td>
                                                                    </tr>
                    ...
                    <p style="text-align:center;font-size: 11px; margin-bottom: 0px; border: 1px solid black;">*This is an electronically generated document and does not require a signature.</p>
                </page>
