        ...
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                        ...
                        if ($cr == 'Units') {
                        ?>
                            <legend><?php echo isset($value['0']['summary']['0']['0']['0']['branch_name']) ? $value['0']['summary']['0']['0']['0']['branch_name'] : ''; ?> </legend>
                        <?php
                        }
                        ...
                        ?>
                            ...
                            <fieldset>
                                <legend> <?php echo isset($values['summary']['0']['0']['0']['first_name']) ? $values['summary']['0']['0']['0']['first_name'] : '';
                                            echo ' ';
                                ...
                                <div class="col-md-4" style="margin-bottom:15px;">EMP ID : <?php echo  isset($values['summary']['0']['0']['0']['emp_company_id'])?$values['summary']['0']['0']['0']['emp_company_id'] : '' ; ?>  </div>
                                
                                <?php if($company_code =='DEMO' || $company_code =='GLET' || $company_code=='SRTS'){ ?>
                                  <div class="col-md-4" style="margin-bottom:15px";>Employee Name (US Format) : <?php echo  isset($values['summary']['0']['0']['0']['emp_us_name'])?$values['summary']['0']['0']['0']['emp_us_name'] : '' ; ?>  </div>
                                  <?php } ?>
                                  <div class="col-md-4" style="margin-bottom:15px;">Branch : <?php echo  isset($values['summary']['0']['0']['0']['branch_name'])?$values['summary']['0']['0']['0']['branch_name'] : '' ; ?>  </div>   
                                  <?php if($company_code =='DEMO' || $company_code =='GLET' || $company_code=='SRTS'){ ?>           
                                  <div class="col-md-4">Employee ID (US Format) : <?php echo  isset($values['summary']['0']['0']['0']['emp_us_company_id'])?$values['summary']['0']['0']['0']['emp_us_company_id'] : '' ; ?>  </div>
                                  <?php } ?>
                                 <!-- end -->
...
<?php  } else { ?>
    ...
    ?>
            ...
            if ($cr == 'Units') {
            ?>
                <h2><?php echo isset($value['0']['summary']['0']['0']['0']['branch_name']) ? $value['0']['summary']['0']['0']['0']['branch_name'] : ''; ?> </h2>
            <?php
            } ?>
            <!--                         <div class="row">
        <div class="col-md-12">-->
