            ...
            <?php echo date("l,F j, Y"); ?> </div>-->
                ...
                <table class="table" align="center" style="margin-top: 10px; margin-left: 30px; width: 550px !important;  ">
                    <tbody>
                        ...
                        <tr>
                            <th style="border-right-style: hidden; border-right: 0px solid white; border-bottom: 0px solid white ;   " colspan="2"><span>Bank Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : </span><span style="margin-left: 1px; text-align: center;">
                                    <?php
                        ...
                        <tr>
                            ...
                            ?>
                            <th style="border-right-style: hidden; border-right: 1px solid black; white-space: normal;    " colspan="2"><span style="text-align:  left ; ">Branch&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;: </span><span style="text-align:center;"><?php echo $wrapped_branch_name; ?> </span></th>
                        </tr>
                    ...
                    <table class="table" align="center" style="margin-top: 10px; margin-left: 30px; width: 550px !important;  ">
                        <tbody>
                            ...
                            <tr>
                                ...
                                $wrapped_branch_name = wordwrap($branch_name, 16, "<br> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", true);
                                ?>
                                <th style="border-right-style: hidden; border-right: 1px solid black;    " colspan="2"><span style="text-align:  left ; ">Branch&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;: </span><span style="text-align:center;"><?php echo $wrapped_branch_name; ?> </span></th>
                            </tr>
