<?php if (isset($arr_reportcriterias)) { ?>
   ...
   <script>
        function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'EventReports/loadcriteriaitems/' + index + '/' + criteria);
        }
...
//        return false;
    ...
    if(criteria){
        $('#form-showreport').attr('action',livesite+'EventReports/generatereport/'+type+'/'+mode);
    ...
    <?php if ($type == 'employee') { ?>
            ...
            allempfields.init();
            allempfields.clearAndLoad("<?php echo $this->webroot; ?>EventReports/listemployeefields", "json");
    ...
    if(criteria){
        ...
        var url = livesite+'EventReports/generatereport/'+type;  
...
$.ajax({
    ...
    complete: function() {
        ...
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'EventReports/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
