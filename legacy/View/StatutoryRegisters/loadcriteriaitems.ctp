...
<?php } else { ?>
    ...
    <div class="col-md-10" style="float: inherit;">
        ...
        <ul title="<?php echo 'Select ' . $msg; ?>" lines="true" style="width:330px;min-height:200px;height:auto;max-height:500px;">
            <li></li>
        </ul>
    </div>
    ...
    <script>
        ...
        function setwidth() {
            ...
            if ($('#checkrsgnd').length == 0) {
                // Edited by Akshay on 10-2-2026
                $('.datagrid-toolbar').find('tr').append(
                    '<td>' +
                    '<input type="checkbox" name="rsgnemp" style="vertical-align: sub;" ' +
                    'id="checkrsgnd" onclick="showrsgnd();" value="0"> ' +
                    '&nbsp;Include Resigned' +
                    '</td>' +
                    '<td>' +
                    '<input type="checkbox" name="ngemp" style="vertical-align: sub;" ' +
                    'id="checkng" onclick="showng();" value="0"> ' +
        ...
        $(document).ready(function() {
            ...
            $('#div-items-criteria<?php echo $index; ?> ul').datalist({
                ...
                url: livesite + 'StatutoryRegisters/listcriteriaitems/' + criteria,
                //checkbox: true,
                checkOnSelect: true,
                searchFilter: true,
                singleSelect: false,
