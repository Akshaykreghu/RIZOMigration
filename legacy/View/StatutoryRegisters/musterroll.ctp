...
<?php if ($mode == '') { 
     if($reporttype == 'Attendance'){
       ...
       $reporttype = 'Muster Roll'; 
    }
    ?>
    <div class="modal-body">
        <legend style="text-align: center; "><b><?php echo $reporttype; ?> Register - <?php echo $report_month; ?></b></legend>
        <div class="row">
            <div class="col-md-12">
                <div class="box ">
                    <?php
                    ...
                    foreach ($arr_leavepolicydetails_for_template as $value) {
                        ...
                        <div class="box-body">
                            <fieldset>
                                ...
                                {
                                ?>
                                <legend><?php echo $reporttype; ?> Register of  <?php echo isset($value['summary']['0']['Branch']['branch_name']) ? $value['summary']['0']['Branch']['branch_name'] : '    (No Datas Found Under This Branch)'; ?>  </legend>
                                <?php
                                }
                                else
                                {
                              $empstatus = (isset($value['summary']['0']['EmployeeDetails']['status'])) && $value['summary']['0']['EmployeeDetails']['status'] =="2" ? '  (Resigned)':'';
                                    ...
                                    <legend><?php echo $reporttype; ?> Register of  <?php echo isset($value['summary']['0']['Info']['EmpName']) ? $value['summary']['0']['Info']['EmpName'].' '.$empstatus : '    (No Datas Found Under This Employees)'; ?>  </legend>
                                <?php
                                    }
                                ?>
                                <!--       <div class="row">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                           <!--  <th colspan="2"></th> -->
                                            ...
                                            <th colspan="1"><?php echo $arr_comp_contact_info['CompanyContactInfo']['business_name'];?></th>
                                            <th colspan="1">Year</th>
                                            <th colspan="1"><?php echo $year;?></th>
                                            <th colspan="1">Muster Roll</th>
                                            <th colspan="38"></th>
                                         </tr>
                                          <tr>
                                            <!-- <th colspan="2"></th> -->
                                            ...
                                            <th colspan="1"><?php echo $arr_comp_contact_info['CompanyContactInfo']['city'];?></th>
                                            <th colspan="1">Month</th>
                                            <th colspan="1"><?php echo $mname;?></th>
                                            <th rowspan="2"></th>
                                            <th colspan="37"></th>
                                         </tr>
                                         <tr>
                                           <!--  <th colspan="2"></th> -->
                                            ...
                                            <th colspan="1"><?php echo $arr_comp_contact_info['CompanyContactInfo']['state'];?></th>
                                            <th colspan="1"></th>
                                            <th colspan="1"></th>
                                            <!-- <th colspan="1"></th> -->
                                            <th colspan="39"></th>
        ...
        <?php if (count($arr_data) >= 0) { ?>
            ...
            foreach ($arr_data as $val) { ?>
                                                <tr> 
                                                    ...
                                                    <td><?php echo ucwords(strtolower($val['Info']['EmpName'])); ?></td>
                                                    <td><?php echo ucwords(strtolower($val['EmployeeDetails']['guradian'])); ?></td>
                                                    <td><?php echo ucwords(strtolower($val['Info']['designation'])); ?></td>
                                                     <td><?php echo $val['Info']['joining_date']; ?></td>
                                                     <td><?php echo $val['Termination']['last_approved_working_date']; ?></td>
                                                    <td><?php echo ucwords(strtolower($val['Info']['department'])); ?></td>
                                                    <td><?php echo ucwords(strtolower($val['Info']['branch'])); ?></td>
...
//        var tables = $('.table-bordered').DataTable({
//            "paging": true,
//            "lengthChange": true,
//            "searching": true,
...
//            var n = $('#demo_info')[0];
//            var searchboxval = $('#attendanceTable_filter').find('input').val();;
//            //n.innerHTML += '<div>'+type+' event - '+searchboxval+'</div>';
//            $('#searchval').val(searchboxval);
//            //n.scrollTop = n.scrollHeight;      
//        }
//        tables.on( 'search.dt', function () { eventFired( 'Search' ); } )
//
//    });
</script>
<?php } else { ?>
...
//        'title' => 'Attendance Register Report - '.$report_month));
    ?>
    <?php
    $i = 0;
    ...
    foreach ($arr_leavepolicydetails_for_template as $value) {
        ...
        <?php
                                ...
                                {
                                ?>
                                <h3>Verified Attendance Register Report of  <?php echo isset($value['summary']['0']['Branch']['branch_name']) ? $value['summary']['0']['Branch']['branch_name'] : '    (No Datas Found Under This Branch)'; ?>  </h3>
                                <?php
                                }
                                else
                                {
                                   // $empstatus = (isset($value['summary']['0']['EmployeeDetails']['status'])) && $value['summary']['0']['EmployeeDetails']['status'] =="2" ? '  (Resigned)':'';
                                    ...
                                    <h3>Verified Attendance Register Report of  <?php echo isset($value['summary']['0']['Info']['EmpName']) ? $value['summary']['0']['Info']['EmpName'] : '    (No Datas Found Under This Employees)'; ?>  </h3>
                                <?php
                                    }
                                ?><br>
        <table class="table table-bordered">
