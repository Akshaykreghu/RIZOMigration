                                    ...
                                    <div>
                                        ...
                                        ?>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea id="approval_remarks" name="approval_remarks" class="form-control" placeholder="Approved Person Remarks"></textarea>
                                                </div>
                                            </div>
                                        <?php
                                        } ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editpunchesbydate').datagrid({
                ...
                width: '550px',
                //height: '600px',
                url: livesite + "Regularisation/listpunchesbydate/" + '<?= ($shownewbutton) ? $shownewbutton : '' ?>',
                pagination: true,
                singleSelect: true,
                iconCls: 'icon-edit',
                pageSize: 20,
                ...
                columns: [
                    [{
                        ...
                        ?> {
                            field: 'C3',
                            title: 'Remarks',
                            width: "<?= ($shownewbutton == 'no') ? '20' : '20' ?>%",
                        },
                        {
                            field: 'approved',
                            title: 'Reg. Status',
                            width: "<?= ($shownewbutton == 'no') ? '15' : '18' ?>%",
                            formatter: function(val, row) {
                                if (val == 'A') {
                                    return 'Approved';
                                } else if (val == 'R') {
