...
<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        ?>
            ...
            <form class="form-horizontal" id="regularisation_approve" method="post" action="<?php echo $this->webroot; ?>Regularisation/bulkupdate/true">
                <?php
                $attendance_dates = [];
                ...
                <!-- <div class="form-group col-md-12">
                    ...
                    <div class="col-md-1">:</div>
                    <div class="col-md-7">
                        <textarea id="remarks" name="remarks" class="form-control">Approved By Admin:</textarea>
                    </div>
                </div>
                <div class="form-group col-md-12">
