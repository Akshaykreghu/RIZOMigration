...
<section class="content-header">
    <h1 class="text-primary-18">Attendance Regularisation</h1>

    <div class="right-actions">
        <button title="If you are finished correcting missing in/out punches of the employee then use the Amendments button. Only then it will reflect in attendance records."
    ...
    $(document).ready(function() {
        ...
        $('#editpunches').datagrid({
            ...
            onClickRow: function(index, row) {
                // console.log(index);
                if($(".select_" + row.att_date).prop('checked')) {
                    $(".select_" + row.att_date).prop('checked', false);
                } else {
                    $(".select_" + row.att_date).prop('checked', true);
                }
            },
            fitColumns: true,
                ...
                [{
                        ...
                        formatter: function(value, row, index) {
                            if (row.isdelete == 'Y' && row.joining_date <= row.att_date && '<?php echo $current_pkey ?>' == row.emp_pkey) {
                                ...
                                var e = '<input type="checkbox" name="selectDate[]" class="select_' + row.att_date + '" value="' + row.att_date + '" onclick="this.checked = (this.checked) ? false : true;" /> ';
                    ...
                    },
                    {
                        ...
                        formatter: function(value, row, index) {
//row.isdelete == 'Y' && 
                            if (row.joining_date <= row.att_date && '<?php echo $current_pkey ?>' == row.emp_pkey) {
