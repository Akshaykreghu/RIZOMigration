                    ...
                    <div id="tab1" data-pws-tab="tab1" data-pws-tab-name="Attendance">
                        <div class="row">
                            <!-- <div class="col-md-12" style="padding-bottom: 10px;">
                                <input type="button" onclick="bulkEdit()" id="bulkEditButton" class="btn btn-primary pull-right" value="Update in Bulk">
                            </div> -->
                            <div class="col-md-12" style="padding-bottom: 10px;">
...
<script type="text/javascript">
    function refresheditpunchgrid() {
        ...
        // Only logged employee can add his attendance.
...
<script>
    $(document).ready(function() {
        ...
        $('#editpunches').datagrid({
            ...
            height: '600px',
            url: livesite + "Regularisation/listpunches/" + true,
            pagination: true,
            singleSelect: false,
            iconCls: 'icon-edit',
            pageSize: 32,
                ...
                [{
                        ...
                        formatter: function(value, row, index) {
                            if (row.isdelete == 'Y' && row.joining_date <= row.att_date) {
                                // / && '<?php echo $current_pkey ?>' == row.emp_pkey

                                var e = '<input type="checkbox" name="selectRegDate[]" class="select_' + row.att_date + '" value="' + row.att_date + '" onclick="this.checked = (this.checked) ? false : true;" /> ';
                    ...
                    {
                        field: 'applied_in_time',
                        title: 'Start',
                        width: "20%"
                    },
                    {
                        field: 'applied_out_time',
                        title: 'End',
                        width: "20%",
                    },
                    {
                        field: 'applied_duration',
                        title: 'Duration',
                        width: "15%",
                    },
                    {
                        field: 'applied_status',
                        title: 'Status',
                        width: "15%",
                        formatter: function(value, row, index) {
                            ...
                            var e = "<strong style=\"color: " + row.applied_status_color + ";\">" + value + applied_attendance + " </strong>";
                            // alert(e);
                            // }
                            //               else{
