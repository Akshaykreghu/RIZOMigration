...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18"> Statutory </h1>
    <!-- end -->
   ...
   <h3 style="font-size: 14px;font-weight: bold;margin-left:20px"> ** When the payroll process is at the stage, only the data marked 'Include Tax: YES' is included in the case of Tax details report
 </h3>
<!-- Main content -->
        ...
        <div class="col-md-12">
            ...
            <div class="box ">
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-md-4"><h3 class="box-title"> Criterias for <label id="current_reporttype"></label></h3></div>
                        <div class="col-md-4">
...
jQuery(document).ready(function() {
    ...
    $('#div-reportcriterias').load(livesite+'StatutoryReport/changereporttype/'+reporttype);
});
