                    ...
                    ?>
                        ...
                        ?>
                                <div class="box-body " style="overflow-y:auto; ">
                                    <fieldset>
                                        <legend><?php $branchCode = $values[0]['summary']['0']['employee_info']['branch_code'];
                                                echo $values[0]['summary']['0']['employee_info']['branch']; ?></legend>
                                    </fieldset>
                                    <br>
                                    <fieldset>
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th colspan="16" style="text-align:center;"><?php echo $arr_comp_contact_info['CompanyContactInfo']['business_name'] . ' - ESI Report - ' . $from; ?></th>
                                                </tr>
                                                <tr>
                                                <tr>
                                                    <th colspan="16" style="text-align:center;">Employer ESI No : <?php echo $eip; ?></th>
                                                </tr>
                                                <tr>

                                                    <th colspan="9" style="text-align:center">Employee Details</th>
                                            ...
                                            <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        foreach ($arr_e as $employee => $val) {;
                                                            if ($val['0']['Esi'] > 0) {
                                                                ...
                                                                $last_approved_working_date = isset($val['termination']['last_approved_working_date']) ? $val['termination']['last_approved_working_date'] : '';
                                                                $row_style = '';

                                                                if ($last_approved_working_date !== '') {

                                                                    // Convert d-m-Y to DateTime
                                                                    $lawd = new DateTime($last_approved_working_date);
                                                                    if ($lawd) {
                                                                        // Compare year-month
                                                                        if ($lawd->format('Y-m') === $prevMonth) {
                                                                            $row_style = 'style="background-color: #fff000;"';
                                                                        }
                                                                    }
                                                                }
                                                                // End
                                                        ?>
                                                                <tr <?php echo $row_style; ?>>
                                                                    ...
                                                                    <td><?php echo $i;
                                                                        ?></td>
                                                                    <td><?php echo ucwords(strtolower($val['employee_info']['EmpName'])); ?></td>
                                                                    ...
                                                                    <td><?php echo ucwords(strtolower($val['employee_info']['branch'])); ?></td>
                                                                    <td><?php echo ucwords(strtolower($val['employee_info']['department'])); ?></td>
                                                                    <td><?php echo ucwords(strtolower($val['employee_info']['designation'])); ?></td>
                                                                    <!-- Edited by Akshayon 13-6-2025 -->
                                                                    <td><?php echo ''; ?></td>
                                                                    <!-- End -->
                                                                    <?php
                                                                    ...
                                                                    $esi_sal += round($esi_salary); // Edited by Akshay on 30-6-2025
                                                                    ?>
                                                                    <td><?php echo $days; ?></td>
                                                                    <td><?php echo $sal; ?></td>
                                                                    <!-- Edited by Akshay on 30-6-2025 -->
                                                                    <td><?php echo $esi_salary; ?></td>
                                                                    <!-- End -->
                                                ...
                                                if (isset($arr_termination[$branchCode]))
                                                    foreach ($arr_termination[$branchCode] as $val) {
                                                        $i++;
                                                ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $val['IPNAME']; ?></td>
                                                        <td><?php echo $val['EMPID']; ?></td>
                                                        <td><?php echo $val['IPNO']; ?></td>
                                                        <td><?php echo $val['joining_date']; ?></td>
                                                        <td><?php echo $val['branch']; ?></td>
                                                        <td><?php echo $val['dept']; ?></td>
                                                        <td><?php echo $val['desg']; ?></td>
                                                        <td><?php echo $val['last_approved_working_date']; ?></td>
                                                        <td><?php echo 0; ?></td>
                                                        <td><?php echo 0; ?></td>
                                                        <td><?php echo 0; ?></td>
                                                        <td><?php echo 0;  ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><?php echo $day; ?></th>
                                                    <th><?php echo indian_format($gross); ?></th>
                                                    <th><?php echo indian_format($esi_sal); ?></th>
                                                    <th><?php echo indian_format($pf_salary); ?></th>
                                                    <th><?php echo indian_format($split1); ?></th>
                                                    <th><?php echo indian_format($split2); ?></th>
                                                    <th><?php echo indian_format($split3); ?></th>
                                                </tr>
                                                <!-- End -->
                                            </tbody>
                                        </table>
                        ...
                        if (count($arr_salary_for_template) !== 0) { // Edited by Akshay on 1-1-2026
                            $i += 1;
                        ?>
                            <div class="box-body " style="overflow-y:auto; ">
                                    ...
                                    <th>4.75%</th>-->
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($arr_salary_for_template as $value) {
                                                $arr_e = $value['summary'];
                                                $esi_salary = $value['esi_salary']; // Edited by Akshay on 30-6-2025
                                                foreach ($arr_e as $employee => $val) {
                                                    if ($val['0']['Esi'] > 0) {
                                                        // Edited by Akshay on 2-1-2025
                                                        $last_approved_working_date = isset($val['termination']['last_approved_working_date']) ? $val['termination']['last_approved_working_date'] : '';
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo ucwords(strtolower($val['IPNAME'])); ?></td>
                                                    <td><?php echo $val['EMPID']; ?></td>
                                                    <td><?php echo $val['IPNO']; ?></td>
                                                    <td><?php echo $val['joining_date']; ?></td>
                                                    <td><?php echo ucwords(strtolower($val['branch'])); ?></td>
                                                    <td><?php echo ucwords(strtolower($val['dept'])); ?></td>
                                                    <td><?php echo ucwords(strtolower($val['desg'])); ?></td>
                                                    <td><?php echo $val['last_approved_working_date']; ?></td>
                                                    <td><?php echo 0; ?></td>
                                                    <td><?php echo 0; ?></td>
                                                    <td><?php echo 0; ?></td>
...
<?php } else { ?>
    ...
    ?>
        ...
        foreach ($arr_salary_for_template as $values) {
            if (count($values) !== 0) {
                $i += 1;
                $branchCode = $values[0]['summary']['0']['employee_info']['branch_code'];
        ?>
                <page backtop="50mm" backbottom="2mm" backleft=7mm" backright="2mm" font-size: 12pt">
                    <page_header>
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th colspan="4" style="text-align:center">ESI Details</th>
                            <th colspan="1" style="width:25px;">ESI - Employee</th>
                            <th colspan="1" style="width:25px;">ESI - Employer</th>
                            <th colspan="1" style="width:20px;">Total</th>
                        </tr>
                        <tr>
                            <th style="width:15px;">Sl No</th>
                            <th style="width:60px;">Employee Name</th>
                            <th style="width:30px;">Employee ID</th>
                            <th style="width:30px;">ESI IP No:</th>
                            <th style="width:30px;">Joining Date</th>
                            <th style="width:60px;">Branch</th>
                            <th style="width:60px;">Department</th>
                            <th style="width:60px;">Designation</th>
                            <!-- Edited by Akshay on 13-6-2025 -->
                            <!-- <th style="width:60px;">Termination Date</th> -->
                            <!-- End -->
                            <th style="width:15px;">Days Worked</th>
                            <th style="width:15px;">Actual Gross </th>
                            <th style="width:15px;">ESI Salary</th>
                            <th style="width:20px;">Excluded Salary</th>
                            <!-- edited by megha -->
                            <?php $chg_date = '2019-07-01';
                            if ($otdate < $chg_date) {  ?>
                                <th style="width:10px;">1.75%</th>
                                <th style="width:10px;">4.75%</th>
                            <?php } else { ?>
                                <th>0.75%</th>
                                <th>3.25%</th>
                                <th>4%</th>
                            ...
                            ?>
                                ...
                                ?>
                                        <tr <?php echo $row_style; ?>>
                                            ...
                                            <td><?php echo $i;
                                                ?></td>
                                            <td style="width:60px;"><?php echo ucwords(strtolower($val['employee_info']['EmpName'])); ?></td>
                                            <td><?php echo $val['employee_info']['employee_id']; ?></td>
                                            <td><?php echo $val['emp_details']['esi']; ?></td>
                                            <td><?php echo $val['employee_info']['joining_date']; ?></td>
                                            <td style="width:60px;"><?php echo ucwords(strtolower($val['employee_info']['branch'])); ?></td>
                                            <td style="width:60px;"><?php echo ucwords(strtolower($val['employee_info']['department'])); ?></td>
                                            <td style="width:60px;"><?php echo ucwords(strtolower($val['employee_info']['designation'])); ?></td>
                                            <!-- Edited by Akshayon 13-6-2025 -->
                                            <!-- <td style="width:60px;"><?php echo $val['termination']['last_approved_working_date']; ?></td> -->
                                            <!-- End -->
                                            <?php
        ...
        if (count($arr_salary_for_template) !== 0) {
            $i += 1;
        ?>
            <page backtop="50mm" backbottom="2mm" backleft=6mm" backright="2mm" font-size: 12pt">
                <page_header>
                    <div style="text-align:left; width:100%; ">
                        <?php if (isset($arr_comp_contact_info['CompanyContactInfo']['logo']) && !empty($arr_comp_contact_info['CompanyContactInfo']['logo'])) { ?>
                            <div style="width: 20%; margin-left: 20px; font-size: 18px; ">
                ...
                <tbody>
                    ...
                    ?>
                                <tr <?php echo $row_style; ?>>
                                    ...
                                    <td style="width:60px;"><?php echo ucwords(strtolower($val['employee_info']['branch'])); ?></td>
                                    <td style="width:60px;"><?php echo ucwords(strtolower($val['employee_info']['department'])); ?></td>
                                    <td style="width:60px;"><?php echo $val['employee_info']['designation']; ?></td>
                                    <!-- Edited by Akshayon 13-6-2025 -->
                                    <!-- <td style="width:60px;"><?php echo $val['termination']['last_approved_working_date']; ?></td> -->
                                    <!-- End -->
                                    <?php
                                    ...
                                    $salary = round($val['0']['SALARY'] - $esi_salary);
                                    $pf_salary += round($salary);
                                    $esi_sal += round($esi_salary); // dited by Akshay on 30-6-2025
                                    ?>
                                    <td><?php echo $days; ?></td>
                                    <td><?php echo $sal; ?></td>
                                    <!-- Edited by Akshay on 30-6-2025 -->
