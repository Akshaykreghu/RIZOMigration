...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18">Employee Expense Reports</h1>
     <!-- /* edited by bindu 20-11-2025 */ -->
      <?php if ($plan !== 'basic') : ?>
            ...
            <div class="box ">
                <div class="box-header with-border">
                    ...
                    <div class="col-md-4" style="font-size: medium;font-weight: 600;margin-bottom: -22px;margin-top: 17px;" > <span>Choose Report Type &nbsp; : </span></div>
                        <div class="col-md-4" style="float: right;margin-right:530px;margin-top: -2px;">
...
jQuery(document).ready(function() {
    ...
    $('#div-reportcriterias').load(livesite+'EmployeeExpenseReports/changereporttype/'+reporttype);
});
