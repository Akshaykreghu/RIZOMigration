<?php if (isset($arr_reportcriterias)) { ?>
    ...
    <script>
         function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'EmployeeExpenseReports/loadcriteriaitems/' + index + '/' + criteria);
        }
...
//        return false;
	...
	if(criteria){
        $('#form-showreport').attr('action',livesite+'EmployeeExpenseReports/generatereport/'+type+'/'+mode);
    ...
    <?php if ($type == 'employee') { ?>
            ...
            allempfields.init();
            allempfields.clearAndLoad("<?php echo $this->webroot; ?>EmployeeExpenseReports/listemployeefields", "json");
    ...
    <?php } ?>
        ...
        function viewReport() {
            ...
            var url = livesite + 'EmployeeExpenseReports/generatereport/' + type;
    ...
    //        });
        ...
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'EmployeeExpenseReports/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
