...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18"> Assets Reports </h1>
    <!-- end -->
     <!-- /* edited by bindu 20-11-2025 */ -->
            ...
            <div class="box ">
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="float: right;margin-right: 682px;margin-top: -2px;">
...
jQuery(document).ready(function() {
    ...
    $('#div-reportcriterias').load(livesite+'AssetsReports/changereporttype/'+reporttype);
});
