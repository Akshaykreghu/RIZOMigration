<?php if (isset($arr_increment)) { ?>
    ...
    <script>
        function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'EmployeeIncrementReports/loadcriteriaitems/' + index + '/' + criteria);
        }
    ...
    //        return false;
        ...
        if(criteria){
            ...
            var url = livesite+'EmployeeIncrementReports/generatereport/'+type;  
...
//        return false;
    ...
    if(criteria){
        $('#form-showreport').attr('action',livesite+'EmployeeIncrementReports/generatereport/'+type+'/'+mode);
