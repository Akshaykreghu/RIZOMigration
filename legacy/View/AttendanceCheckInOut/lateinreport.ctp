...
<div class="modal-body" style="overflow-y: auto;">
    <h2 style="font-weight: bold;text-align: center;"><?php echo " Late IN - " .$mname."  "  .$year?>  </h2>
                         ...
                         <fieldset> 
                             ...
                             <?php
                              ...
                              $empstatus = (isset($value['summary']['0']['ed']['status'])) && $value['summary']['0']['ed']['status'] =="2" ? '  (Resigned)':'';
                                    ...
                                    <legend><?php echo $value['summary']['0']['latein']['EmpName'] .$empstatus; ?>  </legend>
                                <?php
                                    }
                                ?>
                                    ...
                                    ?>
                                        ...
                                        <tr> 
                                            <?php $i += 1; ?>
                                             ...
                                             <td><?php  $empstatus = isset($val['ed']['status']) && $val['ed']['status'] == "2" ? '(Resigned)' : ''; echo $val['latein']['EmpName'] .$empstatus;?></td>
                                            ...
                                            <td><?php  $dateatt = date("d-m-Y", strtotime($date)); echo $dateatt; ?></td>
                                            <td><?php echo $val['0']['Location']; ?></td>
                                            <td><?php echo $val['latein']['ShiftTime']; ?></td>
                                            <td><?php echo  $val['latein']['LateInLimit']; ?></td>
                                             <td><?php echo $val['latein']['InTime'];?></td>
                                            <td><?php echo $latetimeatt; ?></td>
