    <?php if (isset($arr_reportcriterias)) { ?>
        ...
        <form class="form-horizontal" method="post" action="" id="form-showreport">
           ...
           -->
                ...
                <div class="col-md-3" style="padding-right: 50px;">
                    <?php if ($type != "BreakReport" && $type != "DailyAttendance")  { ?>
                        <select id="reportfrom" name="reportfrom" class="form-control">
                    ...
                    <?php } else { ?>
                        <div class="">
                            <div class="col-md-4" style=" padding-right: 50px;">
                                <input type="text" id="reporstfrom" name="reportfrom" style="width: 77px;" class="form-control pickerDate" placeholder="From Date" readonly value="<?php echo date("Y-m-d"); ?>" />
                            </div>
                            <div class="col-md-4" style="padding-left: 60px;  ">
                                <input type="text" id="reporstto" name="reportto" style="width: 78px;" class="form-control pickerDate" placeholder="To Date" readonly value="<?php echo date("Y-m-d"); ?>" />
                            </div>
                        </div>
                    <?php } ?>
                </div>
                ...
                ?>
                    ...
                    <div class="col-md-1">
                        <select id="status_type" name="status_type" class="form-control">
                            ...
                            <option value="WFH/WFH">WFH/WFH</option>
                ...
                <div class="<?= ($type == 'AttendanceStatus') ? 'col-md-2' : 'col-md-3' ?>">
                    <select id="select-criteria1" name="select-criteria1" style="width: 240px;padding-left: 0px;" class="form-control" onchange="loadCriteriaItems(1);">
            ...
            <div class="form-group">
                <div class="col-md-12" align="right">
                    <?php if ($type != 'AttendanceCombined' && $type != 'Attendance') { ?>
        ...
        <script>
            function loadCriteriaItems(index) {
                ...
                $('#div-items-criteria' + index).load(livesite + 'AttendanceCheckInOut/loadcriteriaitems/' + index + '/' + criteria);
            }
            ...
            function downloadReport(mode) {
                ...
                if (criteria) {
                    $('#form-showreport').attr('action', livesite + 'AttendanceCheckInOut/generatereport/' + type + '/' + mode);
            ...
            <?php if ($type == 'employee') { ?>
                ...
                allempfields.init();
                allempfields.clearAndLoad("<?php echo $this->webroot; ?>AttendanceCheckInOut/listemployeefields", "json");
                    ...
                    if (edt < sdt) {
                        ...
                        if (edt != null) {
                            ...
                            if (Difference_In_Days > 30) {
                                alert("Selected total number of days should be less than or equal to 31 days");
                                $("#reporstfrom").val('');
                            }
                        }
                    }
                ...
                $('#reporstto').datepicker({
                    ...
                    if (edt < sdt) {
                        ...
                        if (sdt != null) {
                            ...
                            var Difference_In_Days = Difference_In_Time / (1000 * 3600 * 24);
                            if (Difference_In_Days > 30) {
                                alert("Total number of days should be less than or equal to 31");
                                $("#reporstto").val('');
                            }
                        }
                    }
            ...
            function viewReport() {
                ...
                var url = livesite + 'AttendanceCheckInOut/generatereport/' + type;
            ...
            function addOneReportCriteria(index) {
                ...
                $('#div-criteria' + newIndex).load(livesite + 'AttendanceCheckInOut/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
