...
<div class="col-md-2">
    <!-- <a onclick="toggleItemsDisplay(<?php echo $index; ?>);"><i class=""></i></a> -->
...
function setwidth(){
    ...
    var criteria = $('#hidden-criteria<?php echo $index; ?>').val();
          ...
          // exists.
            $('.datagrid-toolbar').find('tr').append('<td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name"rsgnemp" id="checkrsgnd" onclick="showrsgnd();" value="1">&nbsp;Include Resigned </td>');
        } 
         //   }
    }
    function showrsgnd()
...
$(document).ready(function(){
    ...
    $('#div-items-criteria<?php echo $index; ?> ul').datalist({
        ...
        url: livesite + 'AttendanceCheckInOut/listcriteriaitems/'+criteria,
        //checkbox: true,
		searchFilter:true,
        checkOnSelect: true,
        singleSelect: false,
