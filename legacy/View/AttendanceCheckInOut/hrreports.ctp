...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18">Attendance IN OUT </h1>
    <!-- end -->
      <!-- /* edited by bindu 20-11-2025 */ -->
            ...
            <div class="box ">
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="float: right;margin-right:540px;margin-top: -4px;">
                ...
                <div class="row">
                        <div class="col-md-12" style="margin-top: -3px;padding-left: 24px;">
...
jQuery(document).ready(function() {
    ...
    $('#div-reportcriterias').load(livesite+'AttendanceCheckInOut/changereporttype/'+reporttype);
});
