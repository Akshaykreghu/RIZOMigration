...
<div class="modal-body" style="overflow-y: auto;">
 <h2 style="font-weight: bold;text-align: center;"><?php echo "Employee Late OUT Duration of " .$mname." "  .$year?></h2>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <fieldset> 
                             ...
                             <?php
                              ...
                              $empstatus = (isset($value['summary']['0']['ed']['status'])) && $value['summary']['0']['ed']['status'] =="2" ? '  (Resigned)':'';
                                    ...
                                    <legend><?php  ?> <?php echo isset($value['summary']['0']['lateout']['EmpName']) ? $value['summary']['0']['lateout']['EmpName']:'    (No Datas Found Under This Employees)'; ?>  </legend>
                                <?php
                                    }
                                ?>
                ...
                <table class="table table-bordered">
                            <thead>
                              <tr>
                                  ...
                                  <th style="width:50px;">Late Out Duration</th>
                               </tr>
                            </thead>
                            <tbody>
                                    ...
                                    foreach($arr_data as $val){
                                        ...
                                        <tr> 
                                           ...
                                           <td style="width:80px;"><?php echo $val['ed']['employee_id'];?></td>
                                            ...
                                            <td style="width:50px;"><?php echo $val['0']['lateoutsum']; ?></td>
                                         </tr>
...
<div>
                ...
                {?>
                       <!--  <h4 style="font-weight: bold;margin-top: 20px;">Late In of <?php  echo isset($value['summary']['0']['lateout']['EmpName']) ? $value['summary']['0']['lateout']['EmpName'] : '' ; ?> <?php  echo isset($value['summary']['0']['ed']['status']) && $value['summary']['0']['ed']['status']=="2" ? '(Resigned)':'' ;?></h4> -->
