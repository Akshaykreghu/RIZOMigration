...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Form starts -->
            <form class="form-horizontal" id="emp_expance" action="<?php echo $this->webroot; ?>Uniform/Master_save" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-md-10">
                            <label for="in_date" class="col-sm-4 control-label">Item Name<span class="star">*</span></label>
                            <div class="col-md-7">
                                <input type="text"  class="form-control" value="<?php echo isset($item_details['0']['item']['item_name'])?$item_details['0']['item']['item_name']:''; ?>" name="item_name" id="item_name" placeholder="Enter Item"  required="required" >                       
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-10">
                            <label for="in_time" class="col-sm-4 control-label">Item Code<span class="star">*</span></label>
                            <div class="col-md-7">
                                <input type="text"  class="form-control" value="<?php echo isset($item_details['0']['item']['item_code'])?$item_details['0']['item']['item_code']:''; ?>" name="item_code" id="item_code" placeholder="Enter item code"  required="required" >
                            </div> 
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-10">
                            <label for="in_time" class="col-sm-4 control-label">Item Description<span class="star">*</span></label>
                            <div class="col-md-7">
                                <input type="text"  class="form-control" value="<?php echo isset($item_details['0']['item']['item_desc'])?$item_details['0']['item']['item_desc']:''; ?>" name="item_desc" id="item_desc" placeholder="Enter item Description"  required="required" >
                            </div> 
                        </div>
                    </div>
