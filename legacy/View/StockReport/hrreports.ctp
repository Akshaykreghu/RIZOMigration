...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18"> Stock Reports </h1>
    <!-- /* edited by bindu 20-11-2025 */ -->
            ...
            <div class="box ">
                <div class="box-header with-border">
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-md-4" style="font-size: medium;font-weight: 600;">Choose Report Type &nbsp;&nbsp;&nbsp;&nbsp;: </div>
                        <div class="col-md-4" style="margin-left: -258px;">
                            <select id="filterby_reporttype" name="filterby_reporttype" style="width: 260px;" class="form-control" onchange="changeReportType(this);" >
                                <?php
...
jQuery(document).ready(function() {
    ...
    $('#div-reportcriterias').load(livesite+'StockReport/changereporttype/'+reporttype);
});
