...
<?php if ($mode == '') { ?>
    <div class="modal-body" style="overflow-y:initial; padding-left:3%; padding-right:3%; padding-bottom:3%;" >
        <h3 align="center" style="font-weight:bold; font-size: 30px;">Goods Received Notes Report :<?php echo $month; ?></h3>
                                        ...
                                        if (count($arr_data) >= 0) {
                                            ...
                                            <?php foreach ($arr_data as $val) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $val['gi']['ordering_qty']; ?></td>
...
<?php } else { ?>
    ...
    <?php
      echo $this->element('reportadminheader', array(
          'title' => 'Goods Received Notes Report - '.$month));
    ?>
