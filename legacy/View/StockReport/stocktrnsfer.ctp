<?php if ($mode == '') { ?>
    <div class="modal-body" style="overflow-y:initial; padding-left:3%; padding-right:3%; padding-bottom:3%;" >
        <h3 align="center" style="font-weight:bold; font-size: 30px;">Stock Transfer Report :<?php echo $month; ?></h3>
            ...
            <div class="col-md-12">
                ...
                foreach ($arr_stocksummary_for_template as $value) {
                    ...
                    if (count($value) !== 0) {
                        ...
                        echo isset($value['0']['0']['from_storelocation']) ? "Stock Transfer Report of - " . $value['0']['0']['from_storelocation'] : '';
                    }
                        echo ' ';
                        ?> 
                            </legend>
...
//                                                    }
                                                ...
                                                <td><?php echo $val['0']['from_storelocation']; ?></td>
                                                <td><?php echo $val['0']['to_storelocation']; ?></td>
