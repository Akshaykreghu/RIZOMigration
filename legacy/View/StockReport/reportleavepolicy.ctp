...
<div class="modal-body" style="overflow-y: auto;">
    <legend>Leave Policy Report</legend>
    <div class="row">
        <div class="col-md-12">
            <div class="box ">
                   <?php $i=0; foreach ($arr_leavepolicydetails_for_template as $value) { $i += 1; ?>
                <div class="box-body">
                    <fieldset>
                        <legend>leave Summary <?php  echo $i ; ?>  </legend>
                        <div class="row">
                            <div class="col-md-12">
