...
<div class="col-md-12" id="mes" style="display:none; "><div class="alert alert-warning alert-dismissible">
                ...
                Sorry! No Data Found for selected Employee on selected Date range. Try Other
              </div></div>
<div id="map" style="width: 100%; height: 800px;"></div>

<div class="col-md-12">
    <h3>Employee Mobile Tracking Report</h3>
...
<!--                                <td><?php echo $val['mob_user_tracking']['customer_name']; ?></td>
                                <td><?php echo $val['mob_user_tracking']['purpose']; ?></td>
                                <td><?php echo $val['mob_user_tracking']['stepinout']; ?></td>-->
                            </tr>
                        <?php } ?>
                </tbody>
    </table>
...
<script src='../../js/markerclusterer.js'></script>
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
      ...
      center: new google.maps.LatLng(9.96, 76.28),
