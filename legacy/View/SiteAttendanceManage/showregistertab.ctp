<script>
    var controllerName = "<?php echo isset($hierarchy) ? 'Empattendance' : 'SiteAttendanceManage'; ?>";
</script>
<div class="row">
    <div class="col-md-12">
...
//                                }
            ...
            <table id="attendanceregistertable" class="table table-bordered table-hover">
                <thead frozen="true">
                    <tr>
                        ...
                        <th data-options="field:'days_present',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbsp;Present</th>
    <!--                    <th data-options="field:'days_leave',width:'5%'" formatter="formatEmployeeName">&nbsp;&nbsp;Leave</th>-->
                        ...
                        <th data-options="field:'days_lop',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbsp;LOP/Blank</th>
                    </tr>
                </thead>
                <thead>
                    <tr>
