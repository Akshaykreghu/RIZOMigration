<form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>SiteAttendanceManage/submitregisterentry" id="updateregisterentryform">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <div class="col-md-12">
			<div class="col-md-4">
<!--                            <input type = "text" id="select-reg-date-all" name="select-reg-date-all" class="form-control">-->
...
<!--                    <table class="table table-bordered">
        ...
        <div class="form-group">
            ...
            foreach ($arr_dates as $fieldno => $date) { ?>
                ...
                ?>
                <div class="col-md-6">
                    <label style="text-align:left;" class="col-md-6 control-label" for="reg-date-<?php echo $i; ?>"><?php echo date('Y-m-d D', strtotime($date)); ?> <?php echo $half; ?></label>
                    ...
                    <div class="col-md-6">
<!--                        <input type="text"  onFocus=(this.olds=this.value) onchange="leavabalance(this,this.olds);this.olds=this.value" id="reg-date-<?php echo $i; ?>" name="reg-date-<?php echo $i; ?>" class="form-control">-->
