...
<script src="<?php echo $this->webroot; ?>plugins/easyui/jquery.easyui.min.js"></script>
 ...
 <div class="col-md-12">
        	 <div class="tabset0">
			         <div data-pws-tab="tab1" data-pws-tab-name="Contact Info" data-pws-tab-icon="fa-info">
                ...
                <div class="box-body">
                  <form class="form-horizontal infomode" id="contactInfoForm" action="<?php echo $this->webroot; ?>Company/savecompanysetup" method="post">
                ...
                <div class="box-body">
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>Company/saveCompanyComplianceInfo" id="complianceform">
