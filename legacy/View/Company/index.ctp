...
<section class="content">
    ...
    <div class="col-md-12">
        ...
        <div class="tabset0" style="height:700px !important; ">
            <div data-pws-tab="tab1" data-pws-tab-name="Settings" data-pws-tab-icon="fa-info">
                <br>
            ...
            <div data-pws-tab="tab2" data-pws-tab-name="Branches" data-pws-tab-icon="fa-sitemap">
                ...
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="brtable" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Name</th>
            ...
            <div data-pws-tab="tab3" data-pws-tab-name="Departments" data-pws-tab-icon="fa-bars">
                ...
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;" >
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="dpttable" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;" >
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Name</th>
            ...
            <div data-pws-tab="tab4" data-pws-tab-name="Designation" data-pws-tab-icon="fa-bars">
                ...
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="designation" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th>SL. No</th>
               ...
               <!-- edited by athira on 05-02-2025 -->
               <?php if($plan!='basic'){ ?>
            <div data-pws-tab="tab5" data-pws-tab-name="Grade" data-pws-tab-icon="fa-bars">
                ...
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="tbl_grade" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Grade Code</th>
            ...
            <div data-pws-tab="tab6" data-pws-tab-name="Notice Period" data-pws-tab-icon="fa-calendar">
                ...
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="tbl_notice" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Days</th>
           ...
           <!-- edited by sinsiya 20-06-2024-->
            <div data-pws-tab="tab7" data-pws-tab-name="Leave/Financial Years" data-pws-tab-icon="fa-calendar">
                <br>
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="finyeartable" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Year</th>
            ...
            <div data-pws-tab="tab8" data-pws-tab-name="Banks" data-pws-tab-icon="fa-university">
                <br>
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="banktable" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Name</th>
...
<div data-pws-tab="tab9" data-pws-tab-name="Division" data-pws-tab-icon="fa-bars">
                <br>
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="dvtable" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Name</th>
...
<div data-pws-tab="tab10" data-pws-tab-name="Section" data-pws-tab-icon="fa-bars">
                <br>
                <div class="box box-primary " style="margin-top: -21px;">
                    <div class="box-body" style="    margin-top: -11px;">
                        <br>
                        <!-- Edited by Akshay on 1-12-2023 -->
                        <table id="sectable" class="table table-bordered table-hover" style="overflow-y:auto; max-height:500px !important;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Name</th>
...
<?php } ?>
        ...
        $('#brtable').datagrid({
            ...
            columns: [[
                    ...
                    {field: 'city', title: 'City', width: "10%", sortable: true},
                    {field: 'state', title: 'State', width: "10%", sortable: true},
                    {field: 'pincode', title: 'Pincode', width: "10%", sortable: true},
                    {field: 'LeaveStart', title: 'Leave Year StartDate', width: "15%", sortable: true},
                    {field: 'LeaveEnd', title: 'Leave Year EndDate', width: "15%", sortable: true},
                    {field: 'FinStart', title: 'Financial Year StartDate', width: "15%", sortable: true},
                    {field: 'FinEnd', title: 'Financial Year EndDate', width: "15%", sortable: true},
                ]]
        });
        $('#dpttable').datagrid({
            ...
            columns: [[
                    ...
                    {field: 'dept_name', title: 'Department', width: "50%", sortable: true},
                ]]
        });

//edited by sinsiya on 13-03-2024
$('#dvtable').datagrid({
            url: livesite + "Division/listdivision",
            singleSelect: true,
            pagination: true,
            width: '96%',
            rownumbers: true,
            toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showModalForm(livesite + 'Division/form')
                    }
                }, {
                    iconCls: 'icon-edit',
                    text: 'Edit',
                    handler: function () {
                        var row = $('#dvtable').datagrid('getSelected');
                        if (row) {
                            showModalForm(livesite + 'Division/form?id=' + row.id)
                        } else {
                            alert("Please select a record to edit")
                        }
                    }
                    ...
                    text: 'Remove',
                    handler: function () {
                        var rows = $('#dvtable').datagrid('getSelected');
                        if (rows) {
                            var str_ids = "";
                            //for(var i=0;i<rows.length;i++){
                            //    var data = rows[i];
                            ...
                            if (confirm("Are you sure want to delete ")) {
                                $.ajax({
                                    url: livesite + "Division/deleteDivision",
                                    data: {
                                        ids: rows.id
                                    },
                                    success: function (response) {
                                       ...
                                       var responseObj = JSON.parse(response);
                                        ...
                                        if (responseObj.danger) {
                                              $.notify(responseObj.msg, {
                                              type: 'danger',
                                              allow_dismiss: true
                                           });
                                        } else {
            ...
            pageList: [2, 5, 10, 50, 100],
            columns: [[
                    {field: 'div_code', title: 'Code', width: "50%", sortable: true},
                    {field: 'div_name', title: 'Division', width: "50%", sortable: true},
                ]]
        });

        $('#sectable').datagrid({
            url: livesite + "Section/listsection",
            singleSelect: true,
            pagination: true,
            width: '96%',
            rownumbers: true,
            toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showModalForm(livesite + 'Section/form')
                    }
                }, {
                    iconCls: 'icon-edit',
                    text: 'Edit',
                    handler: function () {
                        var row = $('#sectable').datagrid('getSelected');
                        if (row) {
                            showModalForm(livesite + 'Section/form?id=' + row.id)
                        } else {
                            alert("Please select a record to edit")
                        }
                    }
                    ...
                    text: 'Remove',
                    handler: function () {
                        var rows = $('#sectable').datagrid('getSelected');
                        if (rows) {
                            var str_ids = "";
                            //for(var i=0;i<rows.length;i++){
                            //    var data = rows[i];
                            ...
                            if (confirm("Are you sure want to delete ")) {
                                $.ajax({
                                    url: livesite + "Section/deleteSection",
                                    data: {
                                        ids: rows.id
                                    },
                                    success: function (response) {
                                        //var text = response.responseText;
                                        // process server response here edited by sinsiya on 13-03-2024
                                        var responseObj = JSON.parse(response);
            ...
            pageList: [2, 5, 10, 50, 100],
            columns: [[
                    {field: 'section_code', title: 'Code', width: "50%", sortable: true},
                    {field: 'section_name', title: 'Section', width: "50%", sortable: true},
                ]]
        });
        $('#banktable').datagrid({
...
//edited by sinsiya on 20-06-2024
                    {field: 'acct_no', title: 'Account Number', width: "25%", sortable: true},
                ]]
        });
    });</script>
...
<script type="text/javascript" charset="utf-8">
    $('#finyeartable').datagrid({
        ...
        columns: [[
//edited by sinsiya on 20-06-2024  
                {field: 'fin_year', title: 'Calendar Year', width: "11%", sortable: true},
                {field: 'Branches', title: 'Branch', width: "20%", sortable: true},
                {field: 'vattr1', title: 'Leave/Financial', width: "13%", sortable: true},
                {field: 'start_month', title: 'Start Date', width: "20%", sortable: true},
                {field: 'end_month', title: 'End Date', width: "20%", sortable: true},
    ...
    $('#designation').datagrid({
        ...
        columns: [[
                ...
                {field: 'desig_name', title: 'Designation', width: "50%", sortable: true},
