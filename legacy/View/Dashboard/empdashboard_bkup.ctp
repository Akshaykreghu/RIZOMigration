...
<section class="content">
    ...
    <div class="pad margin no-print">
      <div class="callout callout-success" style="margin-bottom: 0!important;">
        <h4><i class="fa fa-smile-o"></i> Happy Birthday</h4>
        <h5>Being an employee here for so long makes you very valuable!
            So today I wanted to say happy birthday to one of the most amazing employees of the company!.</h5>
      </div>
    </div>
    <?php
    }
    ...
    <div class="row">
        <div class="col-md-12">
            This Month Attendance Progress - <?php echo isset($percentage_total)?$percentage_total."%":0; ?>
                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table class="table no-margin" id="empleaverequests">
                                            ...
                                            <tbody>
                                                <?php foreach ($arr_empleaverequests as $key => $leaverequest) { ?>
                                                    <tr>
                                                        <td><?php echo $leaverequest[0]["emp_name"]; ?></td>
                                                        <td><?php echo $leaverequest["SalaryHeadItems"]["leave_type"]; ?> </td>
                                                        <td><?php echo $leaverequest["LeaveRequests"]["applied_date"]; ?></td>
                                                        <td><?php echo $leaverequest["LeaveRequests"]["FROMDATE"]; ?></td>
                                                        <td><?php echo $leaverequest["LeaveRequests"]["TODATE"]; ?></td>
        ...
        <div class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span class="label label-danger"><?php echo count($arr_employees_pics); ?> Members</span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
                    <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i>
                    </button>
      ...
      //      data: {
       ...
       $('.tabset0').pwstabs({
        ...
        $('#lastmonthattandence').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": livesite + "dashboard/listlastmonthattendance",
        });
        ...
        $('#leaverequests-month-filter').change( function() {
