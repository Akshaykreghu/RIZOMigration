                    ...
                    <div class="col-md-6">
                        ...
                        <span style="text-align:left;" class="col-md-6">
                            ...
                            if (isset($expense_type)) {
                                echo $expense_type['0']['expense_type']['expense_type_name'];
                            } else {
                                echo $arr_expense['0']['emp_expense']['expense_type'];
                            }
                            ?>
                        </span>
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top: -30px;">
                    ...
                    <div class="col-md-6">
                        ...
                        <label style="text-align:left;" class="col-md-5 control-label" >Project Name</label>
                        <label style="text-align:left;" class="col-md-1">:</label>
                        <!--<span style="text-align:left;" class="col-md-6"><?php echo $arr_expense['0']['emp_expense']['vendor']; ?></span>-->
                        <span style="text-align:left;" class="col-md-6">
                            <?php
                            if (isset($project_details)) {
                                echo $project_details['0']['site']['site_id'] . " - " . $project_details['0']['site']['site_name'];
                            } else {
                                echo $arr_expense['0']['emp_expense']['vendor'];
                            }
                            ?>
                        </span>
                    </div>
