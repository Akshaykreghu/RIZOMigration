...
<section class="content-header">
    <h1 style="text-align:left; font-size: 3em;">Credit Note</h1>
</section>
<!-- Main content -->
                    ...
                    <div class="box-body" id="maintabtest" style="padding:0;margin-top:20px;">
                        <div class="tabset-attendanceregister">
                                <div style="text-align: right" class="row form-inline">
                                    ...
                                    <select class="form-control" style="width: 180px;" id="project1" name="project1" class="form-control js-example-basic-single" onchange="filterfunction();">
                                    ...
                                    <div class="col-md-3">
                                    <label class="col-form-label"><b>Expense Type :</b></label>
                                    <select class="form-control" style="width: 180px;" id="exp_type" name="exp_type" class="form-control js-example-basic-single" onchange="filterfunction();">
                                    <option value="">All</option> 
                                    <?php  foreach ($exp_list as $array) { 
                                             foreach ($array as $arr) { ?>
                                            <option value="<?php echo $arr["expense_type_pkey"] ?>"><?php echo $arr["expense_type_name"] ?></option>
                                    <?php } }?>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                    <label class="col-form-label"><b>Expense Status :</b></label>
                                    <select class="form-control" style="width: 100px;" id="expense_status" name="expense_status" onchange="filterfunction(this);">
                                    ...
                                    <div class="col-md-3">
                                    <label class="col-form-label"><b>Payment Status :</b></label>
                                    <select class="form-control" style="width: 100px;" id="payment_status2" name="payment_status" onchange="filterfunction(this);">
...
//        $("#filterby_month").select2();
        ...
        $('#att_table_verified').datagrid({
            url: livesite + "ProjectExpenses/projectlist",
            pagination: true,
            singleSelect: true,
            rownumbers: true,
            queryParams: {
            ...
            toolbar: [{
                    ...
                    handler: function () {
                        ...
                        $('#newreqeuest').html('<div class="col-md-12" style="text-align:center; "><li class="fa fa-spinner fa-spin" style="font-size:30px;text-align: center;"></li></div>');
                        $('#newreqeuest').load(livesite+'ProjectExpenses/loadnewpurchase');
                    }
                },'-',{ 
                    iconCls: 'icon-edit',
                    text: 'View Details',
                    handler: function () {
                        ...
                        showLargeModalForm(livesite + 'ProjectExpenses/show_expense/' + row.emp_expenses_pkey);
                    }
                }
            ],
            fitColumns: true,
            ...
            columns: [[
                    ...
                    {field: 'project', title: 'Project Name/ID', width: "20%"},
