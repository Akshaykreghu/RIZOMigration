...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title"> Project Expenses</h4>  
        </div>
        <div class="modal-body">
            <!-- Form starts -->
            <form class="form-horizontal" id="emp_expance" action="<?php echo $this->webroot; ?>ProjectExpenses/employeeloansave" method="POST">
                <div class="modal-body">
                    <?php
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            ...
                            <div class="col-md-7">
                                ...
                                <select id="expense_type" name="expense_type" class="form-control" style="width: 230px" required="required">
                                    <option value="">[--Select--]</option>
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text"  class="form-control" value="" name="affected_month" id="affected_date" readonly="readonly" style="background:white;" placeholder="Select Date" required="required"><!--onchange="//findextingsalary();"-->
                            </div> 
                        </div>
                    </div>
                    <div class="form-group">
...
<!--                                <input type="text"  class="form-control" value="<?php // echo $data['remarks']               ?>" name="image" id="image">-->
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            <label for="in_date" class="col-sm-4 control-label">Project Name</label>
                            <div class="col-md-7">
                                <!--<input type="text"  class="form-control" value="<?php //echo $data['remarks']               ?>" name="vendor" id="vendor" placeholder="Enter Vendor Name">-->
                                <select id="vendor" name="vendor" class="form-control" style="width: 230px" required="required">
                                    <option value="">[--Select--]</option>
                                    <!-- HERE SAVES THE SITE PKEY INTO THE VENDOR FIELD OF EXPENSE TABLE -->
                    ...
                    if (isset($apr_employees)) {
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                                ...
                                <div class="col-md-7">
                                    <!--Employee Company ID added by ***ARUL P DAS on 20/12/2019-->
                                    <select id="apr_emp_id" class="form-control" name="authorized_by" required="required" style="width: 230px;">
                                        <option value="">[--Select--]</option>
                                        <?php
...
//salary  slip check    
    function findextingsalary() {
        ...
        // alert(emp_id);
        //alert(month);
        var url = '<?php echo $this->webroot; ?>ProjectExpenses/salarycheck';
//value passiing ajax   
        $.ajax({
            // alert('hi');
            url: url,
