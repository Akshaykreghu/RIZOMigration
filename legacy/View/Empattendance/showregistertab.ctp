        ...
        <table id="attendanceregistertable" class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'emp_name',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbsp;Employee name</th>
                    ...
                    <?php $j++; } ?>
                    <th data-options="field:'days_present',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbsp;Days present</th>
                    <th data-options="field:'days_leave',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbsp;Days on leave</th>
                    <!--th data-options="field:'days_holidays',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbsp;Holidays</th-->
                    <th data-options="field:'days_lop',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbsp;Loss of pays</th>
                </tr>
            </thead>
        </table>
        <?php }else{ ?>
            ...
            <thead>
                <tr>
                    ...
                    <?php $j = 1; foreach($arr_dates as $i) { ?>															
                        ...
                        <th data-options="field:'<?php echo 'FIELD' . $i; ?>',width:'5%',align:'center'" formatter="formatRegisterEntry"><?php echo $i; ?></th>
                    <?php $j++; } ?>
                    <th data-options="field:'days_present',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbspDays present</th>
                    <th data-options="field:'days_leave',width:'10%'" formatter="formatEmployeeName">&nbsp;&nbspDays on leave</th>
