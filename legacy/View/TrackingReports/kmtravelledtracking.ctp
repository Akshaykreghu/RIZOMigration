                    ...
                    <div class="box-body">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row" style="padding-right: 20px;padding-left: 11px;">
                                            <div class="col-md-12">
                                                <legend style="text-align: center; ">Mobile Tracking - Distance Travelled Report - <?php echo $report_month; ?></legend><?php ?>
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <b>Employee Name </b> 
                                                    </div>
...
'title'=>'Mobile Tracking - Distance Travelled  Report -'.$report_month));
?>
<?php $data = $arr_leavepolicydetails_for_template['data'];
            if(empty($data)){?>
        ...
        There is no data available</div>
           <?php } else{?>
<!--           <h4> Mobile Tracking - Distance Travelled  Report - <?php //echo $report_month; ?></h4>
