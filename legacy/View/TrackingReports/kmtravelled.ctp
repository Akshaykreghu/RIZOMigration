...
<div class="modal-body">
        <!--<legend style="text-align: center; ">Distance Travelled  - <?php // echo $report_month; ?></legend>-->
        <div class="row">
                    ...
                    <div class="box-body">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row" style="padding-right: 20px;padding-left: 11px;">
                                            <div class="col-md-12">
                                                <legend style="text-align: center; ">Customer Visits - Distance Travelled Report - <?php echo $report_month; ?></legend><?php ?>
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <b>Employee Name </b> 
                                                    </div>
                                                    ...
                                                    <table class="table no-margin" id="todayattandence">
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                <th>Sl.No</th>
                                                                <th>Date</th>
                                                                <th>Approximate Distance Travelled(KM)</th>
                                                                <!--<th>Location</th>-->
<!--                                                                <th>Check-In</th>
                                                                <th>Check-Out</th>
                                                                <th>Duration</th>-->
...
'title'=>'Customer Visits - Distance Travelled  Report -'.$report_month));
?>
<?php $data = $arr_leavepolicydetails_for_template['data'];
            if(empty($data)){?>
        ...
        There is no data available</div>
           <?php } else{?>
<!--           <h4>Customer Visits - Distance Travelled  Report - <?php //echo $report_month; ?></h4>-->
...
<table class="table" align="center" style="padding-top: 20px;">
    ...
    <thead>
        ...
        <tr>
                ...
                <th style="width:20%;">Approximate Distance Travelled(KM)</th>
