...
<section class="content-header">
    <h1 style="text-align:left; font-size: 3em;"> Site Master   </h1>
</section>
<!-- Main content -->
                ...
                <div class="box-body">
                    ...
                    -->                        <div class="row">
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-sm-4">
                                    <label class="col-sm-5 control-label" for="filterby_branch">Choose Contact</label>
                                    <div class="col-md-7">
                                        <select id="filterby_branch" name="filterby_branch" class="form-control js-example-basic-single" onchange="filterAttendanceupload(this);" >
                                            ...
                                            <?php foreach ($arr_employee as $key => $value) { ?>                              
                                                <option  value="<?php echo $value['Contacts']['contact_id']; ?>"><?php echo $value['Contacts']['first_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label class="col-sm-5 control-label" for="employee">Supervisor</label>                        
                                    <div class="col-md-7">
                                        <select id="supervisor" class="form-control js-example-basic-single" name="emp_fkey" onchange="filterAttendanceupload(this);"  >
                                ...
                                <div class="col-md-4">
                                    <label class="col-sm-5 control-label" for="employee">Technician</label>                        
                                    <div class="col-md-7">
...
//focus on text field
        ...
        window.open('<?php echo $this->webroot; ?>SiteWork/downloadempctcformat/', '_blank');
...
//          /  alert(formData);
        ...
        // Open the connection.
        var filterby_branch = $('#filterby_branch').val();
        xhr.open('POST', livesite + 'SiteWork/uploadandsaveempctc/1/' + filterby_branch + '/' +supervisor+ '/'+ emp_fkey, true);
        ...
        $("#filterby_branch").select2(
                {
                    ...
                    allowClear: true,
                    ajax: {
                        url: livesite + "SiteWork/jsons/" + branch,
                        dataType: 'json',
                        delay: 250,
    ...
    jQuery(document).ready(function () {
        ...
        $('#att_table').datagrid({
            ...
            toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showLargeModalForm(livesite + 'SiteWork/form')
                    }
                },
                {
                    iconCls: 'icon-edit',
                    ...
                    handler: function () {
                        ...
                        if (row) {
                            ...
                            showLargeModalForm(livesite + 'SiteWork/form/' + row.efsr_site_pkey)
                        } else
            ...
            columns: [[
                    ...
                    {field: 'first_name', title: 'Customer', width: "25%"},
                    {field: 'address', title: 'Addres', width: "25%"},
