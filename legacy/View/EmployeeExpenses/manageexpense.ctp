<?php if ($mode == 'edit') { ?>
    <form class="form-vertical" method="post" action="<?php echo $this->webroot; ?>EmployeeExpenses/grandexpense" id="expenseapproveform">
        <div class="modal-header" style="background:#004d77;color:white;">

            <h4 class="modal-title"><?php  echo isset($arr_expense['0']['emp_expense']['expense_status'])?$arr_expense['0']['emp_expense']['expense_status']:''; ?></h4>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <label style="text-align:left;" class="col-md-1">:</label>
                    <span style="padding-left: 15px;"><?php echo date('d-m-Y', strtotime($arr_expense['0']['emp_expense']['created_date'])); ?></span>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-top: -30px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <label style="text-align:left;" class="col-md-1">:</label>
                            <span style="text-align:left;" class="col-md-6"><?php echo isset($auth_person[0]["employee_info"]["EmpName"]) ? $auth_person[0]["employee_info"]["EmpName"] : ''; ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-top: -30px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <label style="text-align:left;" class="col-md-1">:</label>
                            <span style="text-align:left;" class="col-md-6"><?php echo isset($apr_person) ? $apr_person[0]["employee_info"]["EmpName"] : ''; ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12" style="margin-top: -30px;">
                        <br>
                        <div class="col-md-6">
                            <label style="text-align:left;" class="col-md-5 control-label" for="AUTHREMARKS">Remarks By Authorized Person</label>
                            <label style="text-align:left;" class="col-md-1">:</label>
                            <div class="col-md-5">
                                <textarea id="AUTHREMARKS" rows="2" cols="20" name="AUTHREMARKS" type="text" placeholder="Remarks" style=" width: 195px;" wrap="hard" class="form-control input-md" <?= ($cur_emp_key && $cur_emp_key == $apr) ? 'disabled' : '' ?> <?= (!$cur_emp_key && $auth == $apr) ? 'disabled' : '' ?>><?= ($arr_expense['0']['emp_expense']['remarks_auth']) ? $arr_expense['0']['emp_expense']['remarks_auth'] : '' ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <label style="text-align:left;" class="col-md-1">:</label>
                            <div class="col-md-5">
                                <textarea id="REMARKS" rows="2" cols="20" name="REMARKS" type="text" placeholder="Remarks" style=" width: 195px;" wrap="hard" class="form-control input-md" <?= ($cur_emp_key && $cur_emp_key == $auth && $auth != $apr) ? 'disabled' : '' ?>></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12" style="margin-top: -30px;margin-bottom: -18px;    text-align: right;">
                        ...
                        <!--                        <button type="button" id="btn-grandemployeeleave" class="btn btn-primary"  onclick="cancelmodal()"><?php echo "Cancel"; ?></button>-->
                        <?php
                         if($arr_expense['0']['emp_expense']['image']){ 
                        ?>
                        <button type="button" id="btn-grandemployeeleave" class="btn btn-info" onclick="showimage()"><?php echo "Show Image"; ?></button>
                         <?php } ?>
                        <button type="button" id="btn-approve" class="btn btn-success strict-field" onclick="grandexpense(this)"><?= ($cur_emp_key == $apr || $user_group == 1) ? 'Approve' : 'Authorize' ?></button>
...
<?php } else { ?>
    <form class="form-vertical" id="expenseapproveform">
        ...
        <div class="modal-body">
            <input id="expensepkey" name="expensepkey" type="hidden" value="<?php echo isset($arr_expense['0']['emp_expense']['emp_expenses_pkey'])?$arr_expense['0']['emp_expense']['emp_expenses_pkey']:''; ?>">
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-top: -30px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <label style="text-align:left;" class="col-md-5 control-label">Rejected By</label>
                            <?php } else { ?>
                                <label style="text-align:left;" class="col-md-5 control-label">Approved By</label>
                                <?php }?>
                                <label style="text-align:left;" class="col-md-1">:</label>
                            <span style="text-align:left;" class="col-md-6"><?php echo isset($apr_person) ? $apr_person[0]["employee_info"]["EmpName"] : 'Admin'; ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12" style="margin-top: -30px;margin-bottom: -18px;    text-align: right;">
                        ...
                        <?php
                        if (!$cur_emp_key) { if($arr_expense['0']['emp_expense']['expense_status'] == 'Approved' || $arr_expense['0']['emp_expense']['expense_status'] == 'Authorized'){
                        ?>
                            <button type="button" id="btn-grandemployeeleave" class="btn btn-primary" onclick="removeExpense()"><?php echo "Cancel"; ?></button>
                        <?php
                        }}
                        ?>
                        <?php
    ...
    <script>
        ...
        function removeExpense() {
            if (confirm("Really you want to cancel the expense?")) {
                $.ajax({
                    url: livesite + "EmployeeExpenses/cancalEmployee",
                    data: {
                        ids: '<?php echo $arr_expense['0']['emp_expense']['emp_expenses_pkey']; ?>'
                    },
                    success: function(response) {
                        //var text = response.responseText;
                        // process server response here
                        reloadTable('att_table_verified');
                        $('#largeModalForm').modal('hide'); 
                    }
                });
            }
