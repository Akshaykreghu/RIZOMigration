...
<?php if (isset($arr_reportcriterias)) { ?>
    ...
    <script>
        function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'attendanceReportsNew/loadcriteriaitems/' + index + '/' + criteria);
        }
        ...
        function downloadReport(mode) {
            ...
            if (criteria) {
                $('#form-showreport').attr('action', livesite + 'attendanceReportsNew/generatereport/' + type + '/' + mode);
        ...
        <?php if ($type == 'employee') { ?>
            ...
            allempfields.init();
            allempfields.clearAndLoad("<?php echo $this->webroot; ?>attendanceReportsNew/listemployeefields", "json");
        ...
        function viewReport() {
            ...
            if (selectany) {
                ...
                if (criteria) {
                    ...
                    var url = livesite + 'attendanceReportsNew/generatereport/' + type;
        ...
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'attendanceReportsNew/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
