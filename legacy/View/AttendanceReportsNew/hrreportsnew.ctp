...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18"> Attendance</h1>
    <!-- /* edited by bindu 20-11-2025 */ -->
                ...
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-md-3 col-lg-3"
                            style="font-size: medium;font-weight: 600;margin-bottom: -22px;margin-top: -2px;">
                            <span>Choose Report Type &nbsp; : </span></div>
                        <div class="col-md-6 col-lg-2" style="float: right;margin-right: 60%;margin-top: -2px;">
                            <select id="filterby_reporttype" style="width: 240px;" name="filterby_reporttype"
                                class="form-control" onchange="changeReportType(this);">
                                <?php
...
<script>
    jQuery(document).ready(function () {
        ...
        $('#div-reportcriterias').load(livesite + 'attendanceReportsNew/changereporttype/' + reporttype);
    });
