                ...
                <table class="table ">
                    <thead>
                        ...
                        <tbody>
                            ...
                            <td><?php echo date('Y-m', strtotime($arr_loan_master['0']['EmployeeLoan']['emi_start_month'])); ?></td>
                        </tbody>
                </table>
                <!-- <div class="col-md-12">
                            ...
                            <select name="specifications" id="from_month" class="form-control" onchange="checkmonth();">
                                <?php
                                    foreach ($loan_months as $key => $value) {
                                        ...
                                        echo "<option>".date('Y-m', strtotime($value['emp_loan_info']['loan_month']))."</option>";
                                    }
                                ?>
                            </select>
                    ...
                    *********ARUL P DAS on 06/11/2019********* -->
                        <tbody>
                            ...
                            <?php }else{ 
                                ...
                                <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo date('Y-m', strtotime($loan['EmployeeLoanInfo']['loan_month'])); ?></td>
