...
<?php if ($mode == '') { ?>
    <div class="modal-body" >
        <legend class="text-center"><b><?php echo "Rota Master_New - " .$mname."  "  .$year?></b></legend>
                                                ...
                                                foreach ($arr1 as $key => $date) {
                                                    ...
                                                    <td><?php
                                                        if ($date == 0) {
                                                           ...
                                                           // echo round($date); // Edited by Akshay on 2-4-2025
                                                            //edited by sinsiya on 15-09-2025
                                                            if($company_code === 'ABSG'){
                                                              echo $date;   
                                                            }else{
                                ...
                                <tr>
                                    ...
                                    foreach ($date_array as $key => $val) {
                                        ...
                                        if(strlen($val1[1]) < 2){
                                         ...
                                         $value = $val1[0].':'. round($val1[1]*60/100);
