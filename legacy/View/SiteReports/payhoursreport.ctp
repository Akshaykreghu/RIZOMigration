<?php if ($mode == '') { ?>
    <div class="modal-body" style="overflow-y: auto;">
        <h2 style="text-align:center;">Employee Pay Hours Report : <?php echo $month; ?></h2>
                            ...
                            if ($criterias == 'Units') {
                                ...
                                <div class="box-body">
                                    <fieldset>  
                                        <legend>Employee Pay Hours Details of  
                                            <?php
                                            echo isset($arr_daata[0]['contacts']['company_name']) ? $arr_daata[0]['contacts']['company_name'] : '';
                                            ?>
                                        </legend>
                                    </fieldset>
                                    <br>
                                    <fieldset>
                                        <table class="table table-bordered">
                                            ...
                                            <?php } ?>
                                            <?php if ($criterias == 'Units' || $criterias =='Contacts') { ?>
                                            </tbody>
                                        </table>
                                    </fieldset>
                                </div>
                    ...
                    <?php if ($criterias == 'EmployeeDetails') {
                        ...
                        foreach ($arr_leavepolicydetails_for_template as $value) {
                            ...
                            if ($criterias == 'Units') {
                                ?>
                                <div class="box-body">
                                     <h4>Employee Pay Hours Details of  
                                            <?php
                                            echo isset($arr_daata[0]['branches']['branch_name']) ? $arr_daata[0]['branches']['branch_name'] : '';
                                            ?>
                                        </h4>
