...
<?php if ($mode == '') { ?>
    <div class="modal-body">
        <legend style="text-align: center; ">Employee Attendance Register - <?php echo $report_month; ?></legend>
        <div class="row">
            <div class="col-md-12">
                <div class="box ">
                    <?php
                    ...
                    foreach ($arr_leavepolicydetails_for_template as $value) {
                        ...
                        <div class="box-body">
                            <fieldset>
                                ...
                                {
                                ?>
                                <legend>Attendance Register of  <?php echo isset($value['summary']['0']['Branch']['branch_name']) ? $value['summary']['0']['Branch']['branch_name'] : '    (No Datas Found Under This Branch)'; ?>  </legend>
                                <?php
                                }
                                else
                                {
                              $empstatus = (isset($value['summary']['0']['EmployeeDetails']['status'])) && $value['summary']['0']['EmployeeDetails']['status'] =="2" ? '  (Resigned)':'';
                                    ...
                                    <legend>Attendance Register of  <?php echo isset($value['summary']['0']['Info']['EmpName']) ? $value['summary']['0']['Info']['EmpName'].' '.$empstatus : '    (No Datas Found Under This Employees)'; ?>  </legend>
                                <?php
                                    }
                                ?>
                                <!--       <div class="row">
