    ...
    function filterRegister(obj)
{
    ...
    var site_fkey = $('#emp_fkey').val();
     $('#load').load(livesite+'EmployeeAttendanceregister/registerbook/'+month+'/'+site_fkey,function() { $('#loaders').hide(); });
                            }
        ...
        $('#loaders').hide();
            ...
            list: {
                onClickEvent: function () {
                    ...
                    var month = $('#filterby_month').val();
                  $('#load').load(livesite+'EmployeeAttendanceregister/registerbook/'+site_fkey+'/'+month);
