    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box ">
                ...
                <div class="box-body">
                    <div class="box-body">
                        <button class="btn btn-primary" onclick="showModalForm(livesite + 'DocumentManagers/templateform');">Add</button>
                        <hr>
                        <div>
...
<script>
    ...
    function setDefault(id, type) {
        ...
        $.ajax({
            type: "POST",
            url: livesite + "DocumentManagers/savedefault_template",
            data: {
                'id': id,
                'type': type
            },
    ...
    function refresh() {
        $('#loader').show();
        $("#container").load("<?= $this->request->base ?>/DocumentManagers/listitems", function() {
            $('#loader').hide();
        });
    }
    ...
    function loadItems(id) {
        $('#loader').show();
        $("#container").load("<?= $this->request->base ?>/DocumentManagers/template/" + id, function() {
            $('#loader').hide();
        });
    }
</script>