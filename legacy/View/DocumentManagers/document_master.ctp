...
<?php } else { ?>
    <section class="heading">
        <h1 class="text-primary-18"> My Documents</h1>
        <div class="text-primary-16 home" style="display:flex; align-items:center; gap:10px; cursor:pointer;">
            <i class="fa" style="font-size:16px;">&#xf104;</i>
            Back
        </div>
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        if (userGroup == 1 || isAddon) {
            $('#documents_manager').datagrid({
                url: livesite + "DocumentManagers/getDocumentsFromDatabase",
                pagination: true,
                singleSelect: true,
                rownumbers: true,
                ...
                toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showModalForm(livesite + 'DocumentManagers/uploadForm')
...

                {
                    ...
                    handler: function () {
                        ...
                        if (row) {
                            ...
                            showLargeModalForm(livesite + 'DocumentManagers/documentAllocate/' + document_pkey);
                    ...
                    handler: function () {
                        ...
                        if (rows) {
                            ...
                            if (confirm("Are you sure want to delete ")) {
                                $.ajax({
                                    url: livesite + "DocumentManagers/deleteDocumentFromGrid",
                                    data: {
                                        ids: document_id
                                    },
                                    success: function (response) {
    ...
    function loadPDFPreview(fileKey, fileType, fileName) {
        ...
        var url = '/DocumentManagers/documentPreview'; // Modify this according to your server endpoint
    ...
    $(".home").on("click", function () {
        ...
        if (userGroup == "1") {
            ...
            if (menuType === 'addon') {
                ...
                url = livesite + "Dashboard/empdashboard";
            }
        }
