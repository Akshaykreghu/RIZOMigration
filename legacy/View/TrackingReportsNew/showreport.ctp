...
<button type="button" onclick="handleExcelClick();" id="btn-submit2" class="btn btn-success">
    ...
    <script>
         function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'TrackingReportsNew/loadcriteriaitems/' + index + '/' + criteria);
        }
    ...
    //        return false;
            ...
            if (criteria) {
                $('#form-showreport').attr('action', livesite + 'TrackingReportsNew/generatereport/' + type + '/' + mode);
...
//            });
    ...
    //        return false;
            ...
            var url = livesite + 'TrackingReportsNew/generatereport/' + type;
    ...
    //        });
        ...
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'TrackingReportsNew/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
