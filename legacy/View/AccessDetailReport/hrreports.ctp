...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18"> Access Details </h1>
 <!-- /* edited by bindu 20-11-2025 */ -->
            ...
            <div class="box ">
                <div class="box-header with-border row">
                    ...
                    <div class="col-md-2" style="margin-top: 12px;">
                        ...
                        <select id="filterby_reporttype" name="filterby_reporttype" style="margin-left:-145px ; width:260px;" class="form-control" onchange="changeReportType(this);" >
                            <?php
...
<script>
    jQuery(document).ready(function () {
        ...
        $('#div-reportcriterias').load(livesite + 'AccessDetailReport/changereporttype/' + reporttype);
    });
