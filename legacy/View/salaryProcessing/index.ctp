...
<div class="payroll-view">
  <section class="content-header heading">
    <h1 class="text-primary-18"> Payroll</h1>
  </section>
...
<script>
  ...
  const pageKey = "payroll"; // use "employee" for employee page
const storageKey = `last_clicked_feature_${pageKey}`;

$.getJSON("SalaryProcessing/getPayrollFeatures", function(res) {
