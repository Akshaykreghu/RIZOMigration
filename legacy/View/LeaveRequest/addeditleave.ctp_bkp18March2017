        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <select <?php echo ($leaveentryId > 0)?'disabled="disabled"':'required=""'; ?> id="salary_head_item_fkey" name="salary_head_item_fkey" class="form-control" >
                ...
                <div class="col-md-6" id="div-leavestatus" <?php if ($leaveentryId == 0) {
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="col-md-8" style="padding-left: 0px;padding-right: 0px;">
                        ...
                        <div class="col-md-6">
                            <select <?php echo ($leaveentryId > 0)?'disabled="disabled"':'required=""'; ?> class="form-control input-md strict-field" id="FROMHALF" name="FROMHALF" >
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-8" style="padding-left: 0px;padding-right: 0px;">
                        ...
                        <div class="col-md-6">
                            <select <?php echo ($leaveentryId > 0)?'disabled="disabled"':'required=""'; ?> class="form-control input-md strict-field" id="TOHALF" name="TOHALF" >
            ...
            <div class="form-group">
                <div class="col-md-6">
                    <label style="text-align:left;" id="balance" class="col-md-4 control-label">Balance Leaves :</label>
                    <div class="col-md-8">
                        <label style="text-align:left;" id="Leavebalance" class="col-md-8 control-label"></label>
...
<!--                    <select id="ISAutherizedby" name="ISAutherizedby" class="form-control" required="">
             <option value="">--Select--</option>
                        <?php
                        //  foreach ($arr_reportingemployees as $key => $value) {
                        // $selected = ($arr_leave_details['ISAutherizedby'] == $value['emp_pkey']) ? 'selected="selected"' : '';
...
<!--                    <select id="APPROVEDBY" name="APPROVEDBY" class="form-control" >
    <option value="">--Select--</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <label style="text-align:left;" class="col-md-4 control-label" for="contact_No">Contact Number&nbsp;<span style="color:red;">*</span></label>
                    <div class="col-md-8">
                        <input id="contact_No" name="contact_No" value="<?php echo $arr_leave_details["contact_No"]; ?>" type="text" placeholder="Contact Number" class="form-control input-md strict-field" required="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-6">
                    <label style="text-align:left;" class="col-md-4 control-label" for="contact_person">Duties handed over to&nbsp;<span style="color:red;">*</span></label>
                    <div class="col-md-8">
