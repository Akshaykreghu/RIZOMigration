...
<?php } ?>
    ...
    <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>LeaveRequest/saveDocument" id="myleaverequestform1" enctype="multipart/form-data">
    <div class="modal-header" >
 
    </div>
        <legend>Add Document</legend>
    <input id="myLeaveAction" name="myLeaveAction" type="hidden"  value="Save" >
    <input id="LEAVEENTRYID" name="LEAVEENTRYID" type="hidden"  value="<?php echo isset($leaveentryId)?$leaveentryId:0; ?>" >
      <div class="modal-body">
            <!-- Form Name -->
        ...
        var    leaverequestoptions = {
                success: function (resp) {
                  ...
                  closeSmallModalForm();
                    ...
                    //edited by sinsiya on 14-05-2025
                     $.notify(message, {
                     type: success ? 'success' : 'danger',  // 'danger' will show red color
                     allow_dismiss: true
                     });      
                        // return;
                   // }
