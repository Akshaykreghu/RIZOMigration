        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <select <?php echo ($leaveentryId > 0) ? 'disabled="disabled"' : 'required=""'; ?> id="salary_head_item_fkey" name="salary_head_item_fkey" class="form-control" onchange="">
...
<select id="APPROVEDBY" class="form-control select2-searching input-md strict-field" name="APPROVEDBY" style="width: 250px;" required class="form-control input-md">
                        ...
                        <!-- <input type="text" id="APPROVED" class="form-control input-md strict-field" name="APPROVED" value="<?php //echo isset($arr_leave_details['APPROVEDBYNAME']) ? $arr_leave_details['APPROVEDBYNAME'] : '' ?>" placeholder="Search Your Employee Name" style="width: 250px;" required="" />
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <textarea id="Reason" name="Reason" type="text" placeholder="Reason" class="form-control input-md strict-field" required="" ><?php echo $arr_leave_details["Reason"]; ?></textarea>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6" >
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="col-md-8">
<!--                    <input type="text" id="Notified" class="form-control strict-field" value="" name="Notified" placeholder="Search Your Employee Name" style="width: 250px; "  />
                        <input type="hidden" id="Notifiedby" name="Notifiedby" value="" />-->
  ...
  <div class="modal-body">
       <div class="box-body">
                    ...
                    <div class="row" style="padding-left: 15px;margin-top: -15px;">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2" style="font-size: 16px;font-weight: 600;"><?php echo $arr_leave_details['leave_days']?>&nbsp;Day(s)</div></div>
                    ...
                    <div class="row" style="padding-top: 12px;padding-left: 30px;">
                        ...
                        <?php if (in_array($arr_leave_details['LEAVESTATUS'], array('Approved', 'Authorized'))) { ?>
                         <div class="col-md-3 col-sm-4 col-xs-4" id="showreason">
                             :<textarea id="Reason" name="Reason" type="text" placeholder="Reason" style="margin-left: 7px;margin-top: -15px;"class="form-control input-md " ><?php echo $arr_leave_details["Reason"]; ?></textarea>
                        </div>
        <?php }  else{?>
            <div class="col-md-3 col-sm-4 col-xs-4">
...
?>
    ...
    <div class="modal-footer">
        <div id="loader" class="col-md-8" style="display:none;">
            <span class="btn btn-success"><li class="fa fa-spinner fa-spin"></li>Loading Please Wait ....</span>
        </div>
        ...
        if(response.status == 1){
            $.notify(response.message,{
             ...
             //  closediv(response.taxHeadKeyValue);
                showLargeModalForm(livesite+'LeaveRequest/addeditleave/' + id);
...
//                alert($.trim($('#label-leavestatus').html()));
        ...
        function getLeaveBalance() {
            ...
            $.ajax({
                url: livesite + 'LeaveRequest/GetLeaveBalance/' + salary_head_item_fkey + '/' + end_date,
                type: 'POST',
                data: {
                        end_date: end_date,
                ...
                success: function (resp)
                {
                    ...
                    console.log(PlannedLeave);
                    if(!PlannedLeave){
                        PlannedLeave = '0';
                    }
                    $('#PlannedLeave').html( 'Need to apply before ' + PlannedLeave + ' days');
                    $('#PlannedLeave').show();
