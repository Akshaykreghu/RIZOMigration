...
if (isset($employee_attendance) && count($employee_attendance) > 0) {
    ...
    foreach ($date as $vals) {
        ...
        ?>
                    ...
                    <tr>
                        <td></td>
                        <!--edited by sinsiya on 17-06-2025-->
                        <td></td>
                        <td></td>
                        <td style="text-align: center ; ">Att In</td>
                            ...
                            foreach ($val as $value1) {
                                $in = isset($value1['emp_detail_timeattandance']['att_in_time'])?$value1['emp_detail_timeattandance']['att_in_time']:'';
                                ?>
                            <td><?php if($in != ''){echo date('d-m-Y H:i:s', strtotime($in)); }?></td>
            <?php
        }
        ?>
                    </tr>
                    <tr>
                        ...
                        foreach ($val as $out_time) {
                             $out = isset($out_time['emp_detail_timeattandance']['att_out_time'])?$out_time['emp_detail_timeattandance']['att_out_time']:'';
                             ?>
                            <td><?php  if($out != ''){echo date('d-m-Y H:i:s', strtotime($out)); } ?></td>
                            <?php
                        }
                        ?>
                    </tr>
