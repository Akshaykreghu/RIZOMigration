    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on('click', 'td.details-control', function() {
            ...
            if (row.child.isShown()) {
                ...
                showLargeModalForm1(livesite + 'OtAttendanceNew/subtable/' + emp_pkey + '/' + month)
            }
        });
        ...
        $('#button').click(function() {
            ...
            if (selected1.length === 0) {
                ...
                $.ajax({
                    url: livesite + 'OtAttendanceNew/counting/' + months + '/' + selected1,
                    success: function(response) {
                        ...
                        if (row > 0) {
                            ...
                            $.ajax({
                                url: livesite + 'OtAttendanceNew/approves/' + selected1 + '/' + month,
                                success: function(resp) {
                                    ...
                                    $('#load').load(livesite + 'OtAttendanceNew/Approved/' + month + '/' + empPkey + '/' + 1 + '/' + branch, function() { //Edited by Akshay on 25-7-2024
                                        $('#loader').hide();
        ...
        $('#example1 tbody').on('click', 'td.details-text', function() {
            ...
            showModalForm(livesite + 'OtAttendanceNew/form/' + emp + '/' + emp_pkey + '/' + month)
        });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if ((message || !message) && data.success === true) {
                            ...
                            $('#load').load(livesite + 'OtAttendanceNew/Approved/' + month + '/' + empPkey + '/' + 2 + '/' + branch, function() { //Edited by Akshay on 25-7-2024
                                $('#loader').hide();
        ...
        $('#remove-button1').click(function() {
            ...
            if (selectedRows.length === 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: livesite + 'OtAttendanceNew/removenew',
                    data: {
                        pkeys: pkeys,
                        month: month //Edited by Akshay on 2-4-2024
                    }, // Send pkeys array as POST data
                    success: function(response) {
                        ...
                        if ((message || !message) && data.success === true) {
                            ...
                            $('#load').load(livesite + 'OtAttendanceNew/Approved/' + month + '/' + empPkey + '/' + 3 + '/' + branch, function() { //Edited by Akshay on 25-7-2024
                                $('#loader').hide();
    ...
    function showProcessedOvertime() {
        ...
        if (selectedRows.length === 0) {
            ...
            $.ajax({
                ...
                url: livesite + "OtAttendanceNew/otprocess/", // replace with your controller action URL
                ...
                success: function(data) {
                    ...
                    $('#load').load(livesite + 'OtAttendanceNew/process/' + month + '/' + empPkey + '/' + 2 + '/' + branch, function() { //Edited by Akshay on 26-7-2024
                        $('#loader').hide();
