...
<section class="content-header">
    <h1 style="text-align:left; font-size: 3em;"> Equipment Master   </h1>
</section>
<!-- Main content -->
...
<!--                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-4">
                                    <label class="col-sm-5 control-label" for="filterby_branch">Survey Category </label>
                                    <div class="col-md-7">
                        ...
                        <div class="col-md-12" >
                            <form class="form-horizontal" method="post" action="" id="importemployeectcform" name="importemployeectcform">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <label class="col-sm-5 control-label" for="filterby_branch">Equipment Type</label>
                                        <div class="col-md-7">
                                            <select id="equipments_type" style="width: 100%; " name="equipments_type" class="emp_fkey form-control js-example-basic-single" onchange="filterAttendanceupload(this);" >
                                                <?php foreach ($arr_types as $value) {
                                                    ?>
                                                    <option value="<?php echo $value['equipment_type']['equipment_type_pkey']; ?>"><?php echo $value['equipment_type']['equipment_name']; ?></option>
                                                <?php }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <button type="button" id="btn-uploademployeectc" class="btn btn-success col-md-5" onclick="uploadEmployeeCTC();">Upload Equipment </button>
                                        <div class="col-md-7">
                                    ...
                                    <div class="col-md-7">
                                        <select id="filterby_branch" name="filterby_branch" class="form-control js-example-basic-single" onchange="filterAttendanceupload(this);" >
                                            <?php foreach ($all_item as $key => $value) { ?>                              
                                                <option  value="<?php echo $value['SiteWork']['efsr_site_pkey']; ?>"><?php echo $value['SiteWork']['site_name'].' - '.$value['SiteWork']['site_id'].' - '.$value['SiteWork']['sap_site_id']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
...
//focus on text field
        ...
        window.open('<?php echo $this->webroot; ?>FieldSurvey/downloadempctcformat/', '_blank');
...
//        filterEmployees();
    ...
    jQuery(document).ready(function () {
        ...
        $('#att_table').datagrid({
            url: livesite + "FieldSurvey/lists",
            pagination: true,
            singleSelect: true,
            rownumbers: true,
            queryParams: {
            ...
            toolbar: [{
                    ...
                    handler: function () {
                        ...
                        showModalForm(livesite + 'FieldSurvey/form')
                    }
                },{
                    iconCls: 'icon-edit',
                    text:'Edit',
                    ...
                    if (row){
                    showModalForm(livesite+'FieldSurvey/form?id=' +row.efsr_equipments_master_pkey)
            ...
            columns: [[
                    {field: 'equipments_name', title: 'Equipment Name', width: "25%"},
                    {field: 'equipments_type', title: 'Equipment Type', width: "25%"},
                    {field: 'manufacturer', title: 'Manufaturer', width: "25%"},
                    {field: 'model_no', title: 'Model Number', width: "25%"},
