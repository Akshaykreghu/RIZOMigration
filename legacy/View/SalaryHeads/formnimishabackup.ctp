...
<legend><?php if(isset($id)){ ?>Edit Salary Heads
<?php } else {
?>
Add Salary Heads
<?php }?>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="head_name">Salary Head Name</label>  
  <div class="col-md-5">
...
<div class="form-group">
  ...
  <div class="col-md-5">
     ...
     <option value="Addition" <?php if(isset($id)){ echo($desc ['operator'] == 'Addition') ? 'selected="selected"' : ''; }?>>Addition to CTC</option>
  <option value="Deduction" <?php if(isset($id)){ echo($desc ['operator'] == 'Deduction') ? 'selected="selected"' : ''; }?>>Deduction from CTC</option>
     </select>
      </div>
</div>
