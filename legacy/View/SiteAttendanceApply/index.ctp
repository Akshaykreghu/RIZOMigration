...
<script>
  ...
  function filterAttendanceupload(obj) {
    ...
    jQuery(document).ready(function () {
        ...
        $('#att_table').datagrid({
            url: livesite + "SiteAttendanceApply/lists",
            pagination: true,
            singleSelect: true,
            rownumbers: true,
            fitColumns: true,
            ...
            toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showLargeModalForm(livesite + 'SiteAttendanceApply/form')
                    }
                },
                {
                    iconCls: 'icon-edit',
                    ...
                    handler: function () {
                        ...
                        if (row) {
                            ...
                            showLargeModalForm(livesite + 'SiteAttendanceApply/form/' + row.site_pkey)  
                        } else
                ...
                ,
                {
                    ...
                    handler: function () {
                        ...
                        if (row) {
                            ...
                            var url = 'SiteAttendanceApply/site_allocate/' + site_pkey;
                            showModalForm(url);
