...
<div>
    <h3 style="font-weight: bold;text-align:center;margin-bottom:10px;font-size:20px;">Workflow - Self Appraisal <?php echo $year; ?></h3>
        ...
        <table class="table table-bordered" border="1" style="border:1px solid black;">
            <thead>
                <tr>
                    ...
                    <th width="auto">Self Appraisal Status</th>
                    <th width="auto">Self Appraisal Submitted Date and Time</th>
                ...
                <?php if (!empty($grouped_data)) {
                    ...
                    foreach ($grouped_data as $emp) { ?>
                        <tr>
                            ...
                            <td><?php echo $emp['self_appr_status']; ?></td>
                            <td><?php echo $emp['self_appr_date']; ?></td>
