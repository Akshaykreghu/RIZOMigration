...
<section class="content-header">
    <h1 style="text-align:left; font-size: 3em;"> Uniform Purchase</h1>
</section>
<!-- Main content -->
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        $('#att_table').datagrid({
            url: livesite + "uniform/lists_purchase",
            pagination: true,
            singleSelect: true,
            rownumbers: true,
            queryParams: {
            ...
            toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        showModalForm(livesite + 'uniform/form_purchase')
                    }
                },{
				iconCls: 'icon-edit',
				text:'Edit',
				handler: function(){
						...
						if (row){
								    showModalForm(livesite+'uniform/form_purchase/' + row.item_pkey);
						}else{
...
//                    	 }      
											if (confirm("Do you want to delete the selected employee(s)?")) {
													...
													$.ajax({
											 url:  livesite+"Uniform/deleteEmppurchase",
													data : {
													ids : str_ids
													},
            ...
            columns: [[
                    ...
                    {field: 'name', title: 'Item Name', width: "20%"},
                    {field: 'vendor', title: 'Vendor', width: "20%"},
                    {field: 'qty', title: 'Item Qty', width: "20%"},
                    {field: 'date_purchased', title: 'Date Purcahsed', width: "20%"},
                    {field: 'PO_number', title: 'PO Number', width: "20%"}
