      ...
      <div class="modal-body">
    			...
    			<div class="form-group">
    				...
    				<input id="HOLIDAYID" name="HOLIDAYID" type="hidden"  value="<?php echo $data["HOLIDAYID"]; ?>" >
                                 <input id="HOLIDAYTYPE" name="HOLIDAYTYPE" type="hidden"  value="<?php echo $types[1]['id']; ?>" >
...
//    
//  function checkIfHolidaydateExists(){ 
//      
//        var HOLIDAYDATE = $('#HOLIDAYDATE').val();
//        var HOLIDAY_GROUP_ID = $('#HOLIDAY_GROUP_ID').val();
//        $.ajax({
//            url: 'HolidayCalendar/checkholidaydateexists/'+HOLIDAY_GROUP_ID,
//            type: 'POST',
//            data: {
