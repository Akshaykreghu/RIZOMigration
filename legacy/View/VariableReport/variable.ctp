...
<?php if ($mode == '') { ?>
    ...
    <h2 align="center" style="font-size: 25px;"><b><?php echo "Variable Upload - " .$mname."  "  .$year?></b> </h2>
    ...
    ?>
                ...
                foreach ($arr_e as $employee =>$val)  {?>
                                            ...
                                            <td><?php echo $val['vu']['uploaded_amount']; ?></td>
                                             ...
                                             <td><?php echo $val['vu']['head_type']; ?></td>
                                             <td><?php echo $val['vu']['item_part']; ?></td>
                                             <td><?php echo $val['vu']['month_year']; ?></td>
                                             <td><?php echo $val['vu']['remarks']; ?></td>
                                             <td><?php  $uploaded = $val['vu']['created_by']; echo $uploaded; ?></td>
                                             <td><?php $uploaded_time = $val['vu']['creation_date']; echo $uploaded_time; ?></td>
                ...
                <tr> 
                                            <th colspan="8" style="text-align:center">Total</th>
                                             <th colspan="8" style="text-align:left;"><?php echo $tot; ?></th></tr>
 ...
 <?php
          ...
          <div class="box-body " style="overflow-y:auto; ">
                               <!--  <fieldset>
                                    <legend><?php echo $value['summary']['0']['employee_info']['EmpName']?></legend>
                                </fieldset>
                                <br> -->
                                <fieldset>
                  ...
                  //  if(empty($arr_daata))                        continue;
                                            ...
                                            ?>
                                            <?php  
                                             foreach ($arr_salary_for_template as $value) {  $arr_daata = $value['summary']; $employees = $value;
                                             if (count($value) >= 0) {
                ...
                foreach ($arr_daata as $employee =>$val)  { ?>
                                        ...
                                        <?php }?>
                                    <tr><th colspan="8" style="text-align:center">Total</th>
                                             <th colspan="8" style="text-align:left;"><?php echo $tot; ?></th> </tr><?php }
                                        else { ?>
                                        <tr>
                                            <td>No data under this criteria</td>
                                        </tr>  
                ...
                foreach ($arr_salary_for_template as $value) { 
                    if (count($value) !== 0) {
                        ...
                        ?>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr> <th colspan="15" style="text-align:center;"><?php echo $arr_comp_contact_info['CompanyContactInfo']['business_name'].' - ESI - '. $from;?></th> </tr>
                                    <tr> <th colspan="15" style="text-align:center;">Employer ESI No : <?php echo $eip;?></th> </tr>
                                    <tr>
