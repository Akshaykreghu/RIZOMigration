...
<!-- <div class="col-md-2">
    <a onclick="toggleItemsDisplay(<?php echo $index; ?>);"><i class="fa fa-minus"></i></a>
        ...
        <div class="col-md-10" style="float: inherit; margin-top: -1px; margin-bottom:-25px;margin-right:5px;padding-left: 85px;width:150%;">
...
$(document).ready(function(){
    ...
    $('#div-items-criteria<?php echo $index; ?> ul').datalist({
        ...
        url: livesite + 'VariableReport/listcriteriaitems/'+criteria,
        //checkbox: true,
        searchFilter:true,
        checkOnSelect: true,
        singleSelect: false,
