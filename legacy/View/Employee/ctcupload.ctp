...
<section class="content">
    <div class="col-md-12 heading" style="padding: -10px;">
        <!-- edited by athira on 03-07-2025 -->
        <!-- /* edited by bindu 20-08-25 */ -->
        <h1 class="text-primary-18">Employee Gross Salary Upload</h1>
        <?php
        ...
        <form class="form-horizontal" method="post" action="" id="importemployeectcform" name="importemployeectcform">
            ...
            <div class="form-group">
                ...
                <!-- <div class="col-md-5">
                    ...
                    <div class="col-md-1">:</div>
                    <div class="col-md-7">
                        <select id="approved_by" class="form-control js-example-basic-single" name="approved_by" onchange="filterAttendanceupload(this);">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5" id="date" style="display: none;">
                    ...
                    <div class="col-md-1">:</div>
                    <div class="col-md-7">
                        <input type="text" required="required" class="form-control " onblur="startdatcheck()" value="<?php echo isset($data['start_date_effective']) ? $data['start_date_effective'] : ""; ?>" name="start_date_effective" name="time" id="time" autocomplete="off">
                    </div>
...
<script>
    ...
    $('#time').datepicker({
        format: 'yyyy-mm', // Edited by Akshay on 20-12-2024
        autoclose: true,
        startView: "months",
        minViewMode: "months"
    })
    ...
    function uploadEmployeeCTC() {
        ...
        var approvedByValue = $('#approved_by').val();
        formData.append('approved_by', approvedByValue);
        // End
    ...
    jQuery(document).ready(function() {
        ...
        $('#att_table').datagrid({
            ...
            toolbar: [{
                ...
                // Edited by Akshay on 5-4-2025
                // {
                //     text: 'VDA Revision/Increment',
                //     iconCls: 'icon-add',
                //     handler: function() {
                //         showModalForm(livesite + 'Employee/vdaRevisionForm')
                //     }
                // },
                // End
                ...
                // Edited by Akshay on 7-4-2025
                {
                    ...
                    iconCls: 'icon-edit',
                    handler: function() {
                        showLargeModalForm(livesite + 'Employee/salaryIncrementForm')
                    }
                },
                // End
                ...
                //     iconCls: 'icon-edit',
                //     handler: function() {
                //         showModalForm(livesite + 'Employee/itemIncrementForm')
                //     }
                // },
                // End
            ],
        ...
        // Edited by Akshay on 6-5-2026
        // Defer datagrid data load to prevent blocking
        setTimeout(function() {
            $('#att_table').datagrid('options').url = livesite + "Employee/employeelist";
            $('#att_table').datagrid('load', {
                employee: employee
            });
        }, 100);
