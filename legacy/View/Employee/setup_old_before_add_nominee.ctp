    ...
    $('#hierarch').easyAutocomplete(usershierarchyoptions);
        ...
        $('#del1').click(function () {
            if (selected != '')
            {
                ...
                {
                    $.ajax({
                        url: livesite + 'Employee/deletehist/' + selected,
        ...
        $('#del').click(function () {
            ...
            if (selected != '')
            {
                ...
                {
                    $.ajax({
                        url: livesite + 'Employee/deletequal/' + selected,
                        success: function (resp) {
                ...
                <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>Employee/saveemployeesetupnew" id="empsetuppersonal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 disabled control-label" for="account_no">ID/AADHAR No</label>
                                <div class="col-md-8">
                                    <input id="id_card" name="id_card" value="<?php echo isset($arr_personalinfo["id_card"]) ? $arr_personalinfo["id_card"] : ''; ?>" type="text" placeholder="ID Card No" class="form-control disabled input-md" >
                                </div>
                            </div>
                        </div>
...
<!--    <th>LEAVEPOLICY_GROUP_NAME</th> -->
            ...
            <div role="tabpanel" class="tab-pane" id="div-emphistorical">
                <div class="modal-header">
...
<!--    <th>LEAVEPOLICY_GROUP_NAME</th> -->
            ...
            <div role="tabpanel" class="tab-pane" id="div-empsetupfamily">
                <div class="modal-header">
                ...
                <div>
                    <table class="table table-bordered display" id="familytable">
                        <thead>
                            <tr>
...
<!--<th>Age</th>-->
                        ...
                        <tbody>
                            <?php foreach ($Family as $val_members) {
                                ?>
                                <tr>
                                    <td><?php echo $val_members['Family']['name']; ?></td>
                                    <td><?php echo $val_members['Family']['relation']; ?></td>
                                    <td><?php echo $val_members['Family']['DOB']; ?></td>
                                    <td><?php echo $val_members['Family']['blood_group']; ?></td>
                                    <td><?php echo $val_members['Family']['gender']; ?></td>
                                    <td><?php echo $val_members['Family']['nationality']; ?></td>
            ...
            <div role="tabpanel" class="tab-pane" id="div-empsetuppassport">
                ...
                <div>
                    <table class="table table-bordered display" id="passporttable">
                        <thead>
                            <tr>
...
<!--<th>Age</th>-->
                        ...
                        <tbody>
                            <?php foreach ($passport as $val_members) {
                                ?>
                                <tr>
                                    <td><?php echo $val_members['passport']['name']; ?></td>
                                    <td><?php echo $val_members['passport']['document_type']; ?></td>
                                    <td><?php echo $val_members['passport']['document_number']; ?></td>
                                    <td><?php echo $val_members['passport']['relation']; ?></td>
                                    <td><?php echo $val_members['passport']['valid_from']; ?></td>
                                    <td><?php echo $val_members['passport']['valid_till']; ?></td>
                                    <td><?php echo $val_members['passport']['classification']; ?></td>
                                    <td><?php echo $val_members['passport']['nationality']; ?></td>
                ...
                <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>Employee/saveconfigs" id="empsetupconfig">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 control-label" for="annual_gross">Annual Gross Salary</label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <input type="text" placeholder="Search for you Employee" id="hierarch" name="hierarch1"  class="form-control strict-field" style="width:234px; ">
                                    <input type="hidden" id="hierarch1" name="hierarch"  class="form-control strict-field" style="width:234px; ">
                                </div>
                            </div>
                            <div class="col-md-6">
