...
{
    empPkey = $('#empsetuptaxation #emp_pkey').val();
...
container.load(url, function() {
 ...
 var table = $('#example').DataTable( {
        ...
        "paging": false,
            ...
            "autoWidth": false,
        "ajax": {
            "url": livesite+"Employee/listhistory/"+$('#empsetuptaxation #emp_pkey').val(),
            "type": "POST"
        },
        "columns": [
            { "data": "company" },
...
//}
	...
	$('#empsetuptaxform').find("button[type='submit']").html('Next').prop('disabled',false);
        ...
        var empsetupprofessionaloptions = {
            success : function(responseText, statusText, xhr, $form) {
                $('#empsetupprofessional').find("button[type='submit']").html('Next').prop('disabled',false);
                var response = JSON.parse(responseText);
                if (response.success) {
                    //alert(response.message);
        ...
        var empsetuptaxationoptions = {
            url:"sdsdsd",
            success : function(responseText, statusText, xhr, $form) {
                $('#empsetuptaxation').find("button[type='submit']").html('Save').attr('disabled',false);
                var response = JSON.parse(responseText);
                if (response.success) {
                    //alert(response.message);
                    $('#empsetup-save-response').removeClass('alert-danger').addClass('alert-success').html('<strong>Success!</strong> '+response.message).fadeIn().fadeOut( 3000 );
        ...
        $('#empsetuptaxation').submit(function() {
            if($('#empsetuptaxation #emp_pkey').val() == 0){
                ...
                $(this).find("button[type='submit']").html('<li class="fa fa-spinner fa-spin"></li> saving...').prop('disabled',true);
...
<div class="box box-body">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" id="history_details">
            <a href="#div-emphistorical" aria-controls="div-emphistorical" role="tab" data-toggle="tab">History</a>
        </li>
...
<input type="hidden" id="head" name="head" value="<?php echo $user_group ; ?>">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="div-empsetuppersonal">
                <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>Employee/saveemployeesetup" id="empsetuppersonal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 control-label" for="email">Email &nbsp;<span style="color:red;">*</span></label>
                                <div class="col-md-8">
                                    <input id="email" name="email" value="<?php echo isset($arr_personalinfo["email"]) ? $arr_personalinfo["email"] : ''; ?>" type="email" placeholder="Email" class="form-control input-md" required="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 disabled control-label" for="account_no">EPF No (UAN)</label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 disabled control-label" for="account_no">ID Card No</label>
                                <div class="col-md-8">
...
<div role="tabpanel" class="tab-pane" id="div-empqualification">
  ...
  <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="$('#largeModalForm').modal('hide');">Cancel</button>
                        <button type="button" id="btn-submit" onclick="showtabhistory();" class="btn btn-primary">Next</button>
                    </div>
...
<!--           <button type="button" class="btn btn-default" onclick="showhistory();">Add History Details</button><button type="button" id="del1" class="btn btn-default">Delete</button>-->
  ...
  <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="$('#largeModalForm').modal('hide');">Cancel</button>
                        <button onclick="showtabfamy();" type="button" id="btn-submit" class="btn btn-primary">Next</button>
                    </div>
    </div>
  ...
  <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="$('#largeModalForm').modal('hide');">Cancel</button>
                        <button type="button" id="btn-submit" onclick="showtabpass();" class="btn btn-primary">Next</button>
                    </div>
  ...
  <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="$('#largeModalForm').modal('hide');">Cancel</button>
                        <button type="button" id="btn-submit" onclick="showtabTax();" class="btn btn-primary">Next</button>
                    </div>
