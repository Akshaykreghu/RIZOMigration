...
<section class="content-header heading">
    ...
    <h1 class="text-primary-18">Increment History</h1>
    <!-- end -->
            ...
            <div class="box ">
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <select id="filterby_reporttype" name="filterby_reporttype" class="form-control" onchange="changeIncrementType(this);" >
                                <?php
...
jQuery(document).ready(function() {
    ...
    $('#div-reportcriterias').load(livesite+'Employee/changeIncrementType/'+reporttype);
});
function changeIncrementType(obj){
