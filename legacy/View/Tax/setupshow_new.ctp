                            ...
                            <tbody>
                                <?php if(count($taxcomponents)>=0){ $sum = 0; $total =0; $actual = 0; $project = 0;?>
                                    <?php foreach($taxcomponents as $val){ 
                                        ?>
                                            <tr> <?php $sum = $sum + $val['EmpTaxSalTransNew']['taxable_salary']; $total = $total +  $val['EmpTaxSalTransNew']['availed_salary']; //$actual = $actual +  $val['EmpTaxSalTrans']['actual_salary_recd']; $project = $project + $val['EmpTaxSalTrans']['projected_salary']; ?>
                                             <td><?php echo $val['TSC']['tax_salary_components_name']; ?></td>
                                            <td><?php echo $val['SHI']['item']; ?></td>
                                            <td><?php echo $val['EmpTaxSalTransNew']['availed_salary']; ?></td>
                                             <td><?php echo $val['EmpTaxSalTransNew']['upper_limit']; ?></td>
                                             <td><?php echo $val['EmpTaxSalTransNew']['taxable_salary']; ?></td>
                                            </tr>
