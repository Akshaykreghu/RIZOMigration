<?php if (isset($arr_reportcriterias)) { ?>
    <script>
        $(document).ready(function () {
            ...
            if (v === 'Reconciliation' || v === 'Reconc_section')
            {
                $('#date').show();
            }
            else
    ...
    //        return false;
            ...
            if (criteria) {
                $('#form-showreport').attr('action', livesite + 'ReconciliationReport/generatereport/' + type + '/' + mode);
    ...
    <?php if ($type == 'employee') { ?>
            ...
            allempfields.init();
            allempfields.clearAndLoad("<?php echo $this->webroot; ?>ReconciliationReport/listemployeefields", "json");
    ...
    <?php } ?>
        ...
        function viewReport() {
            ...
            if (criteria) {
                ...
                var url = livesite + 'ReconciliationReport/generatereport/' + type;
        ...
        function loadCriteriaItems(index) {
            ...
            $('#div-items-criteria' + index).load(livesite + 'ReconciliationReport/loadcriteriaitems/' + index + '/' + criteria);
        }
        function addOneReportCriteria(index) {
            ...
            $('#div-criteria' + newIndex).load(livesite + 'ReconciliationReport/addreportcriteria/' + type + '/' + newIndex + '/' + currentcriteriaschosen);
