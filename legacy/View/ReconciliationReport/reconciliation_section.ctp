...
<div class="modal-body" style="overflow-y:initial; padding-left:3%; padding-right:3%; padding-bottom:3%;" >
    <h3 align="center" ><u>Reconciliation Report</u></h3>
    <div class="row">
        <div class="col-md-12">
...
$brch =isset($value['summary']['0']['br']['branch_code'])?$value['summary']['0']['br']['branch_code'] : '' ;
 ...
 <div class="col-md-8 pull-left"><b>Period : <?php echo $period; ?><b></div>
 <div class="col-md-4 pull-right"><b>Branch : <?php echo $value['summary']['0']['br']['branch_name']; ?></b></div>
          <table class="table">
           <thead>
                                <tr>
                                <th>Section</th>
                                  <?php $countdiv = count($arr_div); 
                                  foreach ($arr_section as $section) { ?>
                                <th colspan="<?php echo $countdiv; ?>"><?php echo $section['section']['section_name']; ?></th>
<?php } ?>
                                </tr>
                            ...
                            <tbody>
                               ...
                               <?php  ?>
                                <?php foreach ($arr_section as $section) { 
                                    $section1 =$section['section']['section_name'];
                                    ...
                                    <?php 
                                     foreach ($value as $key => $values) {
                                       foreach($values as $row){  ?>
                                        <?php if($section['section']['section_name'] == $row['section']['section_name'] && $div['division']['div_name'] == $row['divn']['div_name'] && $val['salhead']['salary_head_item_pkey'] == $row['ectc']['salary_head_item_fkey']) {
                                ...
                                <tr>
                                            ...
                                            foreach ($arr_section as $section) { 
                                              ...
                                              <th><?php  foreach ($value as $key => $values) { 
                                                 foreach($values as $row){ ?>
                                        <?php if($section['section']['section_name'] == $row['section']['section_name'] && $div['division']['div_name'] == $row['divn']['div_name'] && $row['ectc']['head_operator'] == 'Addition' 
                                ...
                                <?php foreach ($arr_section as $section) { 
                                   $section1 =$section['section']['section_name'];
                                   foreach ($arr_div as $div) { $dedamt = 0;
                                   $div1 =$div['division']['div_name'];?>
                                <td>
                                    <?php 
                                     foreach ($value as $key => $values) {
                                        foreach($values as $row){ ?>
                                        <?php if($section['section']['section_name'] == $row['section']['section_name'] && $div['division']['div_name'] == $row['divn']['div_name'] && $val['0']['salary_head_item_pkey'] == $row['ectc']['salary_head_item_fkey']) {
                                            if($row['0']['salary_head_item_desc'] =='LWF'){
                                            $dedamt= isset($row['0']['totalamount'])?abs($row['0']['totalamount']):0;
                                            echo $dedamt;
                                            }else{
                                            $dedamt= isset($row['0']['totalamount'])?abs(round($row['0']['totalamount'])):0;  
                                            echo $dedamt;
                                            }
                                    $count1 += $row['0']['vcount'];
                                ...
                                <tr>
                                              ...
                                              <th><?php foreach ($value as $key => $values) {
                                               foreach($values as $row){ ?>
                                        <?php if($section['section']['section_name'] == $row['section']['section_name'] && $div['division']['div_name'] == $row['divn']['div_name'] && $row['ectc']['head_operator'] == 'Deduction') {
                               ...
                               <tr><th>NET SALARY</th>
                                        <?php $grand = 0;
                                            foreach ($arr_section as $section) { $subtot = 0;
                                            $section1 =$section['section']['section_name']; 
                                        ...
                                        <?php foreach ($arr_section as $section) { $section1 =$section['section']['section_name']; 
...
?>
<div class="modal-body" style="overflow-y:initial; padding-left:10%; padding-right:3%; padding-bottom:3%;" >
        ...
        <div class="col-md-12">
            ...
            <table style="border: 1px solid #fff;margin-top:10px;"><tr><th style="border: 1px solid #fff;width: 40%;text-align: left;">Period :  <b><?php echo $period; ?></b></th>
                    <?php if($cr != 'Section'){ ?>
                            ...
                            <?php }else{ ?>
                             <th style="border: 1px solid #fff;width: 60%;text-align: left;">Section : <b><?php echo isset($value['summary']['0']['section']['section_name'])?$value['summary']['0']['section']['section_name'] : '' ; ?></b></th>              
                            <?php } ?>         
    </tr></</table>  
                            ...
                            <tbody>
                                ...
                                <tr>
                                       ...
                                       <td><?php echo $adv; ?></td>
                                        ...
                                        <?php  } ?> 
                                        <tr><th>Salary Hold</th>
                                            <?php  $cntt=0; foreach ($arr_div as $div) { $hold = 0;
                                            if(!empty($data_hold)){
                                                foreach ($data_hold['0']['bank'] as $bk) {  
