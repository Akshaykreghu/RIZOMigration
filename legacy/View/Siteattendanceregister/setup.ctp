...
//            endDate: '2000-12-31',
        ...
        $('#emp_type').on('change',function(){
            ...
            if(type == 'DAILY WAGES'){
                ...
                $('#fieldGross').html("Monthly Salary (Annual/12)");
                $('#displaytoggle').show();
            }
        });
    ...
    <div class="box box-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" id="passport">
                <a href="#div-empsetuppassport" aria-controls="div-empsetuptaxation" role="tab" data-toggle="tab">Passport & Visa</a>
            </li>
            ...
            <div role="tabpanel" class="tab-pane active" id="div-empsetuppersonal">
                <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>Employee/saveemployeesetupnew" id="empsetuppersonal">
                    <div class="modal-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <select id="classification" name="classification" class="form-control" required="">
                                            ...
                                            <option value="Other" <?php echo($arr_personalinfo["classification"] == 'Other') ? 'selected="selected"' : ''; ?>>Other</option>
                                        </select>
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <select id="relationship" name="relation_guardian" class="form-control" >
                                        <option value="Father" <?php echo ($arr_personalinfo && $arr_personalinfo == 'Father') ? 'selected="selected"' : ''; ?> >Father</option>
                                        <option value="Husband" <?php echo ($arr_personalinfo && $arr_personalinfo == 'Father') ? 'selected="selected"' : ''; ?>>Husband</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 control-label" for="date_of_birth">Birth Date &nbsp;<span style="color:red;">*</span></label>
                                <div class="col-md-8">
                                    <input id="date_of_birth" name="date_of_birth" value="<?php echo isset($arr_personalinfo["date_of_birth"]) ? $arr_personalinfo["date_of_birth"] : ''; ?>" type="text" placeholder="(YYYY-MM-DD)" class="form-control input-md" required="required" >
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 disabled control-label" for="account_no">ID/AADHAR No &nbsp;<span style="color:red;">*</span></label>
                                <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <input id="pf" name="pf" value="<?php echo isset($arr_personalinfo["pf"]) ? $arr_personalinfo["pf"] : ''; ?>" type="text" placeholder="PF" class="form-control disabled input-md" >
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <select id="notice_days" name="notice_days" class="form-control" required="">
                                        <option value="">--Select--</option>
                                        <?php
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 control-label" for="emp_dept">Department &nbsp;<span style="color:red;">*</span></label>
                                <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <select id="emp_branch" required="required" name="emp_branch" class="form-control" >
                                        <option value="">--Select--</option>
                                        <?php
            ...
            <div role="tabpanel" class="tab-pane" id="div-empsetupconfig">
                <form class="form-horizontal" method="post" action="<?php echo $this->webroot; ?>Employee/saveconfigs" id="empsetupconfig">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 control-label" for="first_name">Shift Policy </label>
                                <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 control-label" for="middile_name">Holiday Policy</label>
                                <div class="col-md-8">
                                    <select id="holidays" name="holidays" class="form-control" required="">
                                        <option value="">--Select--</option>
                                        <?php 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12" id="displaytoggle" style="padding-left: 0px; ">
                                    <div class="col-md-6">Monthly Salary (Annual/12) </div>
                                    <div class="col-md-6">
                                        :    <span id="calculate_monthly_gross"><?php echo isset($arr_gross['0']["emp_ctc_transaction"]["emp_anual_ctc"]) ? $arr_gross['0']["emp_ctc_transaction"]["emp_anual_ctc"]/12 : 0; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <input type="text" placeholder="Search for you Employee" value="<?php echo isset($hierarchy_set['0']['emp_details']['first_name'])? $hierarchy_set['0']['emp_details']['first_name'].' '.$hierarchy_set['0']['emp_details']['last_name']: '' ; ?>" id="hierarch" name="hierarch1"  class="form-control strict-field" style="width:234px; ">
                            ...
                            <div class="col-md-6">
                                <label style="text-align:left;" class="col-md-4 control-label" for="middile_name">Salary Policy</label>
                                <div class="col-md-8">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" onclick="$('#largeModalForm').modal('hide');">I'll Do Later</button>
                            <button type="submit" id="btn-submit" class="btn btn-primary">Save & Next</button>
                        </div>
